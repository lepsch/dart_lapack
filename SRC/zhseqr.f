...
*  =====================================================================
      ...
      if ( INFO != 0 ) {
         ...
         if ( N.GT.NMIN ) {
            ...
            if ( INFO.GT.0 ) {
               ...
               if ( N.GE.NL ) {
                  ...
                  zlaqr0(WANTT, WANTZ, NL, ILO, KBOT, HL, NL, W, ILO, IHI, Z, LDZ, WORKL, NL, INFO )                   IF( WANTT .OR. INFO != 0 ) CALL ZLACPY( 'A', N, N, HL, NL, H, LDH );
               }
            }
         }
         ...
         IF( ( WANTT .OR. INFO != 0 ) .AND. N.GT.2 ) CALL ZLASET( 'L', N-2, N-2, ZERO, ZERO, H( 3, 1 ), LDH )
