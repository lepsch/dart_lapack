...
*  =====================================================================
      ...
      ELSE
         ...
         DO 10 I = I1, I2, I3
            ...
            CALL CLARFT( 'Forward', 'Columnwise', NQ-I+1, IB, A( I, I ), LDA, TAU( I ), WORK( IWT ), LDT )
            IF( LEFT ) THEN
            ...
            CALL CLARFB( SIDE, TRANS, 'Forward', 'Columnwise', MI, NI, IB, A( I, I ), LDA, WORK( IWT ), LDT, C( IC, JC ), LDC, WORK, LDWORK )
   10    CONTINUE
      END IF
      WORK( 1 ) = SROUNDUP_LWORK(LWKOPT)
      RETURN
