...
*  =====================================================================
      ...
      IF( N.GT.K ) THEN
         ...
         IF( LNOTIDENT ) THEN
            ...
            CALL DTRMM( 'L', 'L', 'T', 'U', K, N-K, ONE, A, LDA, WORK, LDWORK )
         END IF
         ...
         IF( M.GT.0 ) THEN
            CALL DGEMM( 'T', 'N', K, N-K, M, ONE, B, LDB, B( 1, K+1 ), LDB, ONE, WORK, LDWORK )
         END IF
         ...
         IF( M.GT.0 ) THEN
            CALL DGEMM( 'N', 'N', M, N-K, K, -ONE, B, LDB, WORK, LDWORK, ONE, B( 1, K+1 ), LDB )
         END IF
         ...
         IF( LNOTIDENT ) THEN
            ...
            CALL DTRMM( 'L', 'L', 'N', 'U', K, N-K, ONE, A, LDA, WORK, LDWORK )
         END IF
      ...
      IF( LNOTIDENT ) THEN
         ...
         CALL DTRMM( 'L', 'L', 'T', 'U', K, K, ONE, A, LDA, WORK, LDWORK )
      END IF
      ...
      IF( M.GT.0 ) THEN
         CALL DTRMM( 'R', 'U', 'N', 'N', M, K, -ONE, WORK, LDWORK, B, LDB )
      END IF
