      void cbbcsd(JOBU1, JOBU2, JOBV1T, JOBV2T, TRANS, M, P, Q, THETA, PHI, U1, LDU1, U2, LDU2, V1T, LDV1T, V2T, LDV2T, B11D, B11E, B12D, B12E, B21D, B21E, B22D, B22E, RWORK, LRWORK, INFO ) {
      ...
      for (I = 1; I <= Q; I++) {
         ...
         if ( MINI != I ) {
            ...
            if ( COLMAJOR ) {
               ...
               if( WANTV1T ) CALL CSWAP( Q, V1T(I,1), LDV1T, V1T(MINI,1), LDV1T );
               IF( WANTV2T ) CALL CSWAP( M-Q, V2T(I,1), LDV2T, V2T(MINI,1), LDV2T );
            } else {
               if (WANTU1) CALL CSWAP( P, U1(I,1), LDU1, U1(MINI,1), LDU1 );
               if( WANTU2 ) CALL CSWAP( M-P, U2(I,1), LDU2, U2(MINI,1), LDU2 );
