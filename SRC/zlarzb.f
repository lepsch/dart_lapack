      void zlarzb(SIDE, TRANS, DIRECT, STOREV, M, N, K, L, V, LDV, T, LDT, C, LDC, WORK, LDWORK ) {
...
// =====================================================================
      ...
      if ( LSAME( SIDE, 'L' ) ) {
         ...
         if (L > 0) CALL ZGEMM( 'Transpose', 'Conjugate transpose', N, K, L, ONE, C( M-L+1, 1 ), LDC, V, LDV, ONE, WORK, LDWORK );
         ...
         if (L > 0) CALL ZGEMM( 'Transpose', 'Transpose', L, N, K, -ONE, V, LDV, WORK, LDWORK, ONE, C( M-L+1, 1 ), LDC );
         ...
         if (L > 0) CALL ZGEMM( 'No transpose', 'Transpose', M, K, L, ONE, C( 1, N-L+1 ), LDC, V, LDV, ONE, WORK, LDWORK );
         ...
         if (L > 0) CALL ZGEMM( 'No transpose', 'No transpose', M, L, K, -ONE, WORK, LDWORK, V, LDV, ONE, C( 1, N-L+1 ), LDC );
         for (J = 1; J <= L; J++) { // 100
            zlacgv(K, V( 1, J ), 1 );
         } // 100
