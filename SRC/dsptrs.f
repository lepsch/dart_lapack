      void dsptrs(UPLO, N, NRHS, AP, IPIV, B, LDB, INFO ) {
...
// =====================================================================
      ...
      if ( UPPER ) {
         ...
         if ( IPIV( K ) > 0 ) {
            ...
            if (K < N) CALL DGER( N-K, NRHS, -ONE, AP( KC+1 ), 1, B( K, 1 ), LDB, B( K+1, 1 ), LDB );
         ...
         if ( IPIV( K ) > 0 ) {
            ...
            if (K < N) CALL DGEMV( 'Transpose', N-K, NRHS, -ONE, B( K+1, 1 ), LDB, AP( KC+1 ), 1, ONE, B( K, 1 ), LDB );
