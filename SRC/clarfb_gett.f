...
*  =====================================================================
      ...
      if ( N.GT.K ) {
         ...
         if ( LNOTIDENT ) {
            ...
            CALL CTRMM( 'L', 'L', 'C', 'U', K, N-K, CONE, A, LDA, WORK, LDWORK )
         }
         ...
         if ( M.GT.0 ) {
            CALL CGEMM( 'C', 'N', K, N-K, M, CONE, B, LDB, B( 1, K+1 ), LDB, CONE, WORK, LDWORK )
         }
         ...
         if ( M.GT.0 ) {
            CALL CGEMM( 'N', 'N', M, N-K, K, -CONE, B, LDB, WORK, LDWORK, CONE, B( 1, K+1 ), LDB )
         }
         ...
         if ( LNOTIDENT ) {
            ...
            CALL CTRMM( 'L', 'L', 'N', 'U', K, N-K, CONE, A, LDA, WORK, LDWORK )
         }
      ...
      if ( LNOTIDENT ) {
         ...
         CALL CTRMM( 'L', 'L', 'C', 'U', K, K, CONE, A, LDA, WORK, LDWORK )
      }
      ...
      if ( M.GT.0 ) {
         CALL CTRMM( 'R', 'U', 'N', 'N', M, K, -CONE, WORK, LDWORK, B, LDB )
      }
