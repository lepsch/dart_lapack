      ...
      if ( UPPER ) {
         ...
         if ( (MAX( ABSAKK, COLMAX ) == ZERO) ) {
            ...
            if ( KP != KK ) {
               ...
               if (KP.GT.1) CALL CSWAP( KP-1, A( 1, KK ), 1, A( 1, KP ), 1 )                IF( ( KK.GT.1 ) && ( KP.LT.(KK-1) ) ) CALL CSWAP( KK-KP-1, A( KP+1, KK ), 1, A( KP, KP+1 ), LDA );
               T = A( KK, KK )
               A( KK, KK ) = A( KP, KP )
               A( KP, KP ) = T
               if ( KSTEP == 2 ) {
         ...
         if ( ( MAX( ABSAKK, COLMAX ) == ZERO ) ) {
            ...
            if ( KP != KK ) {
               ...
               if (KP.LT.N) CALL CSWAP( N-KP, A( KP+1, KK ), 1, A( KP+1, KP ), 1 )                IF( ( KK.LT.N ) && ( KP.GT.(KK+1) ) ) CALL CSWAP( KP-KK-1, A( KK+1, KK ), 1, A( KP, KK+1 ), LDA );
               T = A( KK, KK )
               A( KK, KK ) = A( KP, KP )
               A( KP, KP ) = T
               if ( KSTEP == 2 ) {
