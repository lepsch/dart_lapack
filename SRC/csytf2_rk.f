      void csytf2_rk(UPLO, N, A, LDA, E, IPIV, INFO ) {
      ...
      if ( UPPER ) {
         ...
         if ( (max( ABSAKK, COLMAX ) == ZERO) ) {
            ...
            if ( KP != KK ) {
               ...
               IF( ( KK > 1 ) && ( KP < (KK-1) ) ) CALL CSWAP( KK-KP-1, A( KP+1, KK ), 1, A( KP, KP+1 ), LDA );
               T = A( KK, KK );
               A( KK, KK ) = A( KP, KP );
               A( KP, KP ) = T;
               if ( KSTEP == 2 ) {
         ...
         if ( ( max( ABSAKK, COLMAX ) == ZERO ) ) {
            ...
            if ( KP != KK ) {
               ...
               IF( ( KK < N ) && ( KP > (KK+1) ) ) CALL CSWAP( KP-KK-1, A( KK+1, KK ), 1, A( KP, KK+1 ), LDA );
               T = A( KK, KK );
               A( KK, KK ) = A( KP, KP );
               A( KP, KP ) = T;
               if ( KSTEP == 2 ) {
