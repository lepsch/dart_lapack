      void cgebd2(M, N, A, LDA, D, E, TAUQ, TAUP, WORK, INFO ) {
...
// =====================================================================
      ...
      if ( M >= N ) {
         ...
         for (I = 1; I <= N; I++) { // 10
            ...
            if (I < N) CALL CLARF( 'Left', M-I+1, N-I, A( I, I ), 1, CONJG( TAUQ( I ) ), A( I, I+1 ), LDA, WORK );
            A( I, I ) = D( I );
         ...
         for (I = 1; I <= M; I++) { // 20
            ...
            if (I < M) CALL CLARF( 'Right', M-I, N-I+1, A( I, I ), LDA, TAUP( I ), A( I+1, I ), LDA, WORK );
            clacgv(N-I+1, A( I, I ), LDA );
            A( I, I ) = D( I );
