...
*  =====================================================================
   ...
   30 CONTINUE
      if ( WANTP ) {
         ...
         dlacpy('Full', N1, N2, B( 1, I ), LDB, WORK( N1*N2+1 ), N1 )          CALL DTGSYL( 'N', IJB, N1, N2, A, LDA, A( I, I ), LDA, WORK, N1, B, LDB, B( I, I ), LDB, WORK( N1*N2+1 ), N1, DSCALE, DIF( 1 ), WORK( N1*N2*2+1 ), LWORK-2*N1*N2, IWORK, IERR );
