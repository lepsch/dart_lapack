...
*  =====================================================================
      ...
      IF( NB.GE.NBMIN .AND. NB.LT.JMAX .AND. JMAXB.GT.0 ) THEN
         ...
         DO WHILE( J.LE.JMAXB )
            ...
            CALL CLAQP3RK( M, N_SUB, NRHS, IOFFSET, JB, ABSTOL, RELTOL, KP1, MAXC2NRM, A( 1, J ), LDA, DONE, JBF, MAXC2NRMK, RELMAXC2NRMK, JPIV( J ), TAU( J ), RWORK( J ), RWORK( N+J ), WORK( 1 ), WORK( JB+1 ), N+NRHS-J+1, IWORK, IINFO )
     ...
     t // he blocks.
      ...
      IF( J.LE.JMAX ) THEN
         ...
         CALL CLAQP2RK( M, N_SUB, NRHS, IOFFSET, JMAX-J+1, ABSTOL, RELTOL, KP1, MAXC2NRM, A( 1, J ), LDA, KF, MAXC2NRMK, RELMAXC2NRMK, JPIV( J ), TAU( J ), RWORK( J ), RWORK( N+J ), WORK( 1 ), IINFO )
