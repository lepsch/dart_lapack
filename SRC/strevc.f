...
*  =====================================================================
               ...
               DO 60 J = KI - 1, 1, -1
                  ...
                  IF( J1.EQ.J2 ) THEN
                    ...
                    t // he right-hand side.
                     ...
                     IF( SCALE.NE.ONE ) CALL SSCAL( KI, SCALE, WORK( 1+N ), 1 )
                     WORK( J+N ) = X( 1, 1 )
                  ...
                  ELSE
                     ...
                     CALL SLALN2( .FALSE., 2, 1, SMIN, ONE, T( J-1, J-1 ), LDT, ONE, ONE, WORK( J-1+N ), N, WR, ZERO, X, 2, SCALE, XNORM, IERR )
                     ...
                     CALL SAXPY( J-2, -X( 1, 1 ), T( 1, J-1 ), 1, WORK( 1+N ), 1 )                      CALL SAXPY( J-2, -X( 2, 1 ), T( 1, J ), 1, WORK( 1+N ), 1 )
                  END IF
   60          CONTINUE
   ...
   80          CONTINUE
               ...
               DO 90 J = KI - 2, 1, -1
                  ...
                  IF( J1.EQ.J2 ) THEN
                     ...
                     CALL SLALN2( .FALSE., 1, 2, SMIN, ONE, T( J, J ), LDT, ONE, ONE, WORK( J+N ), N, WR, WI, X, 2, SCALE, XNORM, IERR )
                     ...
                     CALL SAXPY( J-1, -X( 1, 1 ), T( 1, J ), 1, WORK( 1+N ), 1 )                      CALL SAXPY( J-1, -X( 1, 2 ), T( 1, J ), 1, WORK( 1+N2 ), 1 )
                  ...
                  ELSE
                    ...
                    t // he right-hand side.
                     ...
                     CALL SAXPY( J-2, -X( 1, 1 ), T( 1, J-1 ), 1, WORK( 1+N ), 1 )                      CALL SAXPY( J-2, -X( 2, 1 ), T( 1, J ), 1, WORK( 1+N ), 1 )                      CALL SAXPY( J-2, -X( 1, 2 ), T( 1, J-1 ), 1, WORK( 1+N2 ), 1 )                      CALL SAXPY( J-2, -X( 2, 2 ), T( 1, J ), 1, WORK( 1+N2 ), 1 )
                  END IF
   90          CONTINUE
  ...
  110             CONTINUE
               ...
               ELSE
                  ...
                  IF( KI.GT.2 ) THEN
                     CALL SGEMV( 'N', N, KI-2, ONE, VR, LDVR, WORK( 1+N ), 1, WORK( KI-1+N ), VR( 1, KI-1 ), 1 )                      CALL SGEMV( 'N', N, KI-2, ONE, VR, LDVR, WORK( 1+N2 ), 1, WORK( KI+N2 ), VR( 1, KI ), 1 )
                  ELSE
               ...
               DO 170 J = KI + 1, N
                  ...
                  IF( J1.EQ.J2 ) THEN
                    ...
                    t // he right-hand side.
                     ...
                     IF( SCALE.NE.ONE ) CALL SSCAL( N-KI+1, SCALE, WORK( KI+N ), 1 )
                     WORK( J+N ) = X( 1, 1 )
                  ...
                  ELSE
                    ...
                    t // he right-hand side.
                     ...
                     CALL SLALN2( .TRUE., 2, 1, SMIN, ONE, T( J, J ), LDT, ONE, ONE, WORK( J+N ), N, WR, ZERO, X, 2, SCALE, XNORM, IERR )
  ...
  180             CONTINUE
               ...
               ELSE
                  ...
                  IF( KI.LT.N ) CALL SGEMV( 'N', N, N-KI, ONE, VL( 1, KI+1 ), LDVL, WORK( KI+1+N ), 1, WORK( KI+N ), VL( 1, KI ), 1 )
               ...
               DO 200 J = KI + 2, N
                  ...
                  ELSE
                    ...
                    t // he right-hand side elements.
                     ...
                     CALL SLALN2( .TRUE., 2, 2, SMIN, ONE, T( J, J ), LDT, ONE, ONE, WORK( J+N ), N, WR, -WI, X, 2, SCALE, XNORM, IERR )
  ...
  230             CONTINUE
               ELSE
                  IF( KI.LT.N-1 ) THEN
                     CALL SGEMV( 'N', N, N-KI-1, ONE, VL( 1, KI+2 ), LDVL, WORK( KI+2+N ), 1, WORK( KI+N ), VL( 1, KI ), 1 )                      CALL SGEMV( 'N', N, N-KI-1, ONE, VL( 1, KI+2 ), LDVL, WORK( KI+2+N2 ), 1, WORK( KI+1+N2 ), VL( 1, KI+1 ), 1 )
                  ELSE
