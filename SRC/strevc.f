            ...
            if ( IP.EQ.0 ) {
               ...
               DO 60 J = KI - 1, 1, -1
                  ...
                  if ( J1.EQ.J2 ) {
                     ...
                     saxpy(J-2, -X( 1, 1 ), T( 1, J-1 ), 1, WORK( 1+N ), 1 )                      CALL SAXPY( J-2, -X( 2, 1 ), T( 1, J ), 1, WORK( 1+N ), 1 );
                  }
               } // 60
               ...
               DO 90 J = KI - 2, 1, -1
                  ...
                  if ( J1.EQ.J2 ) {
                     ...
                     saxpy(J-1, -X( 1, 1 ), T( 1, J ), 1, WORK( 1+N ), 1 )                      CALL SAXPY( J-1, -X( 1, 2 ), T( 1, J ), 1, WORK( 1+N2 ), 1 );
                     ...
                     saxpy(J-2, -X( 1, 1 ), T( 1, J-1 ), 1, WORK( 1+N ), 1 )                      CALL SAXPY( J-2, -X( 2, 1 ), T( 1, J ), 1, WORK( 1+N ), 1 )                      CALL SAXPY( J-2, -X( 1, 2 ), T( 1, J-1 ), 1, WORK( 1+N2 ), 1 )                      CALL SAXPY( J-2, -X( 2, 2 ), T( 1, J ), 1, WORK( 1+N2 ), 1 );
                  }
               } // 90
               ...
               if ( .NOT.OVER ) {
                  ...
                  if ( KI.GT.2 ) {
                     sgemv('N', N, KI-2, ONE, VR, LDVR, WORK( 1+N ), 1, WORK( KI-1+N ), VR( 1, KI-1 ), 1 )                      CALL SGEMV( 'N', N, KI-2, ONE, VR, LDVR, WORK( 1+N2 ), 1, WORK( KI+N2 ), VR( 1, KI ), 1 );
                  } else {
         ...
         for (KI = 1; KI <= N; KI++) { // 260
            ...
            if ( IP.EQ.0 ) {
               ...
               if ( .NOT.OVER ) {
                  ...
                  if ( KI.LT.N-1 ) {
                     sgemv('N', N, N-KI-1, ONE, VL( 1, KI+2 ), LDVL, WORK( KI+2+N ), 1, WORK( KI+N ), VL( 1, KI ), 1 )                      CALL SGEMV( 'N', N, N-KI-1, ONE, VL( 1, KI+2 ), LDVL, WORK( KI+2+N2 ), 1, WORK( KI+1+N2 ), VL( 1, KI+1 ), 1 );
                  } else {
