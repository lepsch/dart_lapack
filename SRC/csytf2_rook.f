      ...
      if ( UPPER ) {
         ...
         if ( (MAX( ABSAKK, COLMAX ) == ZERO) ) {
            ...
            if ( ( KSTEP == 2 ) && ( P != K ) ) {
               ...
               if (P.GT.1) CALL CSWAP( P-1, A( 1, K ), 1, A( 1, P ), 1 )                IF( P < (K-1) ) CALL CSWAP( K-P-1, A( P+1, K ), 1, A( P, P+1 ), LDA );
               T = A( K, K )
               A( K, K ) = A( P, P )
               A( P, P ) = T
            }
            ...
            if ( KP != KK ) {
               ...
               if (KP.GT.1) CALL CSWAP( KP-1, A( 1, KK ), 1, A( 1, KP ), 1 )                IF( ( KK.GT.1 ) && ( KP < (KK-1) ) ) CALL CSWAP( KK-KP-1, A( KP+1, KK ), 1, A( KP, KP+1 ), LDA );
               T = A( KK, KK )
               A( KK, KK ) = A( KP, KP )
               A( KP, KP ) = T
               if ( KSTEP == 2 ) {
         ...
         if ( ( MAX( ABSAKK, COLMAX ) == ZERO ) ) {
            ...
            if ( ( KSTEP == 2 ) && ( P != K ) ) {
               ...
               if (P < N) CALL CSWAP( N-P, A( P+1, K ), 1, A( P+1, P ), 1 )                IF( P.GT.(K+1) ) CALL CSWAP( P-K-1, A( K+1, K ), 1, A( P, K+1 ), LDA );
               T = A( K, K )
               A( K, K ) = A( P, P )
               A( P, P ) = T
            }
            ...
            if ( KP != KK ) {
               ...
               if (KP < N) CALL CSWAP( N-KP, A( KP+1, KK ), 1, A( KP+1, KP ), 1 )                IF( ( KK < N ) && ( KP.GT.(KK+1) ) ) CALL CSWAP( KP-KK-1, A( KK+1, KK ), 1, A( KP, KK+1 ), LDA );
               T = A( KK, KK )
               A( KK, KK ) = A( KP, KP )
               A( KP, KP ) = T
               if ( KSTEP == 2 ) {
