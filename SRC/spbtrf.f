      void spbtrf(UPLO, N, KD, AB, LDAB, INFO ) {
            ...
            DO 70 I = 1, N, NB;
               ...
               if ( I+IB <= N ) {
                  ...
                  if ( I3 > 0 ) {
                     ...
                     if (I2 > 0) CALL SGEMM( 'Transpose', 'No Transpose', I2, I3, IB, -ONE, AB( KD+1-IB, I+IB ), LDAB-1, WORK, LDWORK, ONE, AB( 1+IB, I+KD ), LDAB-1 );
            ...
            DO 140 I = 1, N, NB;
               ...
               if ( I+IB <= N ) {
                  ...
                  if ( I3 > 0 ) {
                     ...
                     if (I2 > 0) CALL SGEMM( 'No transpose', 'Transpose', I3, I2, IB, -ONE, WORK, LDWORK, AB( 1+IB, I ), LDAB-1, ONE, AB( 1+KD-IB, I+IB ), LDAB-1 );
