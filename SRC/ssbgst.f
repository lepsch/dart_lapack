      ...
      if ( UPPER ) {
         ...
         if ( UPDATE ) {
            ...
            if ( WANTX ) {
               ...
               if (KBT > 0) CALL SGER( N-M, KBT, -ONE, X( M+1, I ), 1, BB( KB1-KBT, I ), 1, X( M+1, I-KBT ), LDX );
            }
         ...
         for (K = 1; K <= KB - 1; K++) { // 130
            ...
            if (NRT > 0) CALL SLARGV( NRT, AB( 1, J2T ), INCA, WORK( J2T-M ), KA1, WORK( N+J2T-M ), KA1 );
            if ( NR > 0 ) {
         ...
         if ( UPDATE ) {
            ...
            if ( WANTX ) {
               ...
               sscal(N-M, ONE / BII, X( M+1, I ), 1 );
               if (KBT > 0) CALL SGER( N-M, KBT, -ONE, X( M+1, I ), 1, BB( KBT+1, I-KBT ), LDBB-1, X( M+1, I-KBT ), LDX );
            }
         ...
         for (K = 1; K <= KB - 1; K++) { // 360
            ...
            if (NRT > 0) CALL SLARGV( NRT, AB( KA1, J2T-KA ), INCA, WORK( J2T-M ), KA1, WORK( N+J2T-M ), KA1 );
            if ( NR > 0 ) {
      ...
      if ( UPPER ) {
         ...
         if ( UPDATE ) {
            ...
            if ( WANTX ) {
               ...
               if (KBT > 0) CALL SGER( NX, KBT, -ONE, X( 1, I ), 1, BB( KB, I+1 ), LDBB-1, X( 1, I+1 ), LDX );
            }
         ...
         for (K = 1; K <= KB - 1; K++) { // 610
            ...
            if (NRT > 0) CALL SLARGV( NRT, AB( 1, J1+KA ), INCA, WORK( J1 ), KA1, WORK( N+J1 ), KA1 );
            if ( NR > 0 ) {
         ...
         if ( UPDATE ) {
            ...
            if ( WANTX ) {
               ...
               sscal(NX, ONE / BII, X( 1, I ), 1 );
               if (KBT > 0) CALL SGER( NX, KBT, -ONE, X( 1, I ), 1, BB( 2, I ), 1, X( 1, I+1 ), LDX );
            }
         ...
         for (K = 1; K <= KB - 1; K++) { // 840
            ...
            if (NRT > 0) CALL SLARGV( NRT, AB( KA1, J1 ), INCA, WORK( J1 ), KA1, WORK( N+J1 ), KA1 );
            if ( NR > 0 ) {
