...
// =====================================================================
      ...
      if ( LSAME( UPLO, 'U' ) ) {
         ...
         J = K + 1;
            ...
            JJ = J - 1;
            if (JP1 != JJ && KSTEP == 2) CALL ZSWAP( N-J+1, A( JP1, J ), LDA, A( JJ, J ), LDA );
         IF( J <= N ) GO TO 60;
         ...
         if (K > 1) CALL ZGEMV( 'No transpose', N-K+1, K-1, -CONE, A( K, 1 ), LDA, W( K, 1 ), LDW, CONE, W( K, K ), 1 );
         ...
         J = K - 1;
            ...
            JJ = J + 1;
            if (JP1 != JJ && KSTEP == 2) CALL ZSWAP( J, A( JP1, 1 ), LDA, A( JJ, 1 ), LDA );
         IF( J >= 1 ) GO TO 120;
