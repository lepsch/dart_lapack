...
*  =====================================================================
      ...
      IF( M.GT.N ) THEN
         CALL STRSM( 'R', 'U', 'N', 'N', M-N, N, ONE, A, LDA, A( N+1, 1 ), LDA )
      END IF
      ...
      DO JB = 1, N, NB
        ...
        t // riangular part of T(1:JNB,JB:JB+JNB-1). This multiplication
         ...
         // matrix X(JB):
             ...
             t // riangular, the routine STRSM will access all JNB**2
         ...
         CALL STRSM( 'R', 'L', 'T', 'U', JNB, JNB, ONE, A( JB, JB ), LDA, T( 1, JB ), LDT )
