      void cpbtrf(UPLO, N, KD, AB, LDAB, INFO ) {
            ...
            DO 70 I = 1, N, NB;
               ...
               if ( I+IB <= N ) {
                  ...
                  if ( I3 > 0 ) {
                     ...
                     if (I2 > 0) CALL CGEMM( 'Conjugate transpose', 'No transpose', I2, I3, IB, -CONE, AB( KD+1-IB, I+IB ), LDAB-1, WORK, LDWORK, CONE, AB( 1+IB, I+KD ), LDAB-1 );
            ...
            DO 140 I = 1, N, NB;
               ...
               if ( I+IB <= N ) {
                  ...
                  if ( I3 > 0 ) {
                     ...
                     if (I2 > 0) CALL CGEMM( 'No transpose', 'Conjugate transpose', I3, I2, IB, -CONE, WORK, LDWORK, AB( 1+IB, I ), LDAB-1, CONE, AB( 1+KD-IB, I+IB ), LDAB-1 );
