      void dlaqr0(WANTT, WANTZ, N, ILO, IHI, H, LDH, WR, WI, ILOZ, IHIZ, Z, LDZ, WORK, LWORK, INFO ) {
...
// ================================================================
      ...
      if ( N <= NTINY ) {
         ...
         LWKOPT = 1;
         if (LWORK != -1) CALL DLAHQR( WANTT, WANTZ, N, ILO, IHI, H, LDH, WR, WI, ILOZ, IHIZ, Z, LDZ, INFO );
      } else {
         ...
         dlaqr3(WANTT, WANTZ, N, ILO, IHI, NWR+1, H, LDH, ILOZ, IHIZ, Z, LDZ, LS, LD, WR, WI, H, LDH, N, H, LDH, N, H, LDH, WORK, -1 );
         ...
         for (IT = 1; IT <= ITMAX; IT++) { // 80
            ...
            dlaqr3(WANTT, WANTZ, N, KTOP, KBOT, NW, H, LDH, ILOZ, IHIZ, Z, LDZ, LS, LD, WR, WI, H( KV, 1 ), LDH, NHO, H( KV, KT ), LDH, NVE, H( KWV, 1 ), LDH, WORK, LWORK );
            ...
            if ( ( LD == 0 ) || ( ( 100*LD <= NW*NIBBLE ) && ( KBOT- KTOP+1 > min( NMIN, NWMAX ) ) ) ) {
               ...
               if ( MOD( NDFL, KEXSH ) == 0 ) {
                  ...
                  if ( KBOT-KS+1 <= NS / 2 ) {
                     ...
                     if ( NS > NMIN ) {
                        dlaqr4( false , false , NS, 1, NS, H( KT, 1 ), LDH, WR( KS ), WI( KS ), 1, 1, ZDUM, 1, WORK, LWORK, INF );
                     } else {
