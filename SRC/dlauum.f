      ...
      if ( NB.LE.1 .OR. NB.GE.N ) {
         ...
         if ( UPPER ) {
            ...
            DO 10 I = 1, N, NB
               ...
               if ( I+IB.LE.N ) {
                  dgemm('No transpose', 'Transpose', I-1, IB, N-I-IB+1, ONE, A( 1, I+IB ), LDA, A( I, I+IB ), LDA, ONE, A( 1, I ), LDA )                   CALL DSYRK( 'Upper', 'No transpose', IB, N-I-IB+1, ONE, A( I, I+IB ), LDA, ONE, A( I, I ), LDA );
               }
            } // 10
         } else {
