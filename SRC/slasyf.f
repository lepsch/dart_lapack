...
*  =====================================================================
      ...
      if ( LSAME( UPLO, 'U' ) ) {
         ...
         J = K + 1
            ...
            J = J + 1
            if (JP != JJ .AND. J.LE.N) CALL SSWAP( N-J+1, A( JP, J ), LDA, A( JJ, J ), LDA )          IF( J.LT.N ) GO TO 60;
         ...
         J = K - 1
            ...
            // of the rows to swap back doesn't include diagonal element)
            J = J - 1
            if (JP != JJ .AND. J.GE.1) CALL SSWAP( J, A( JP, 1 ), LDA, A( JJ, 1 ), LDA )          IF( J.GT.1 ) GO TO 120;
