      void dlarrv(N, VL, VU, D, L, PIVMIN, ISPLIT, M, DOL, DOU, MINRGP, RTOL1, RTOL2, W, WERR, WGAP, IBLOCK, INDEXW, GERS, Z, LDZ, ISUPPZ, WORK, IWORK, INFO ) {
         ...
         if ( IDONE < IM ) {
            ...
            for (I = 1; I <= OLDNCL; I++) { // 150
               ...
               if ( NDEPTH > 0 ) {
                  ...
                  dcopy(IN-1, Z( IBEGIN, J+1 ), 1, L( IBEGIN ), 1 );
                  SIGMA = Z( IEND, J+1 );

                  // Set the corresponding entries in Z to zero
                  dlaset('Full', IN, 2, ZERO, ZERO, Z( IBEGIN, J), LDZ );
               }
