...
*  =====================================================================
      ...
      if ( LSAME( UPLO, 'U' ) ) {
         ...
         if ( MAX( ABSAKK, COLMAX ) == ZERO ) {
            ...
            if ( .NOT.( ABSAKK < ALPHA*COLMAX ) ) {
               ...
               // Loop until pivot found
                  ...
                  if (K < N) CALL CGEMV( 'No transpose', K, N-K, -CONE, A( 1, K+1 ), LDA, W( IMAX, KW+1 ), LDW, CONE, W( 1, KW-1 ), 1 );
         ...
         J = K + 1
            ...
            JJ = J - 1
            if (JP1 != JJ && KSTEP == 2) CALL CSWAP( N-J+1, A( JP1, J ), LDA, A( JJ, J ), LDA )          IF( J.LE.N ) GO TO 60;
         ...
         J = K - 1
            ...
            JJ = J + 1
            if (JP1 != JJ && KSTEP == 2) CALL CSWAP( J, A( JP1, 1 ), LDA, A( JJ, 1 ), LDA )          IF( J.GE.1 ) GO TO 120;
