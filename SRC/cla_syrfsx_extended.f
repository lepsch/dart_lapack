...
*
*     .. Local Scalars ..
      INTEGER            UPLO2, CNT, I, J, X_STATE, Z_STATE, Y_PREC_STATE       REAL               YK, DYK, YMIN, NORMY, NORMX, NORMDX, DXRAT, DZRAT, PREVNORMDX, PREV_DZ_Z, DXRATMAX, DZRATMAX, DX_X, DZ_Z, FINAL_DX_X, FINAL_DZ_Z, EPS, HUGEVAL, INCR_THRESH
...
*
            ...
            ELSE IF ( Y_PREC_STATE .EQ. EXTRA_RESIDUAL ) THEN
               CALL BLAS_CSYMV_X( UPLO2, N, CMPLX(-1.0), A, LDA, Y( 1, J ), 1, CMPLX(1.0), RES, 1, PREC_TYPE )
            ELSE
               CALL BLAS_CSYMV2_X(UPLO2, N, CMPLX(-1.0), A, LDA, Y(1, J), Y_TAIL, 1, CMPLX(1.0), RES, 1, PREC_TYPE)
            END IF
