      void sorbdb(TRANS, SIGNS, M, P, Q, X11, LDX11, X12, LDX12, X21, LDX21, X22, LDX22, THETA, PHI, TAUP1, TAUP2, TAUQ1, TAUQ2, WORK, LWORK, INFO ) {
...
// ====================================================================
      ...
      if ( COLMAJOR ) {
         ...
         for (I = Q + 1; I <= P; I++) {
            ...
            if (M-P-Q >= 1) CALL SLARF( 'R', M-P-Q, M-Q-I+1, X12(I,I), LDX12, TAUQ2(I), X22(Q+1,I), LDX22, WORK );
         ...
         for (I = Q + 1; I <= P; I++) {
            ...
            if (M-P-Q >= 1) CALL SLARF( 'L', M-Q-I+1, M-P-Q, X12(I,I), 1, TAUQ2(I), X22(I,Q+1), LDX22, WORK );
