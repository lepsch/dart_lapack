...
*  =====================================================================
      ...
      C3 = SUBNAM( 4: 6 )
      C4 = C3( 2: 3 )
      TWOSTAGE = LEN( SUBNAM ).GE.11 .AND. SUBNAM( 11: 11 ) == '2'
      ...
      // M*N
         ...
         } else if ( SNAME .AND. C3 == 'TRD' ) {
            NB = 32
         } else if ( SNAME .AND. C3 == 'GST' ) {
            NB = 64
         }
      } else if ( CNAME .AND. C2 == 'HE' ) {
         if ( C3 == 'TRF' ) {
            if ( TWOSTAGE ) {
               NB = 192
            } else {
