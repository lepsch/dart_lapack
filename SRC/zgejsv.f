...
* #:(          This is a rather pathological case: no scaled condition
            ...
            for (q = 1; q <= N; q++) { // 1972
               ...
               IF ( (XSC .LT. (ONE-TEMP1)) || (XSC .GT. (ONE+TEMP1)) ) CALL ZDSCAL( N, XSC, V(1,q), 1 )
            } // 1972
            ...
            for (p = 1; p <= NR; p++) { // 1973
               XSC = ONE / DZNRM2( M, U(1,p), 1 )
               IF ( (XSC .LT. (ONE-TEMP1)) || (XSC .GT. (ONE+TEMP1)) ) CALL ZDSCAL( M, XSC, U(1,p), 1 )
            } // 1973
      ...
      // $                                        ABS(CWORK(N+(p-1)*N+q)) )
            ...
            for (p = 1; p <= N; p++) { // 6971
               ...
               IF ( (XSC .LT. (ONE-TEMP1)) || (XSC .GT. (ONE+TEMP1)) ) CALL ZDSCAL( N, XSC, V(1,p), 1 )
            } // 6971
