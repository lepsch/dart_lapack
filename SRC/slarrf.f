...
*  =====================================================================
      ...
      const              ONE = 1.0E0, TWO = 2.0E0, QUART = 0.25E0, MAXGROWTH1 = 8.E0, MAXGROWTH2 = 8.E0 ;
      // ..
      // .. Local Scalars ..
      ...
      if ((CLWDTH.LT.MINGAP/REAL(128)) .AND. (MIN(MAX1,MAX2).LT.FAIL2) .AND.(.NOT.SAWNAN1).AND.(.NOT.SAWNAN2)) {
         DORRR1 = .TRUE.
      } else {
         DORRR1 = .FALSE.
      ENDIF
