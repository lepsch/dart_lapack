...
*  =====================================================================
      ...
      if ( LSAME( UPLO, 'U' ) ) {
         ...
         J = K + 1
            ...
            J = J + 1
            if (JP2 != JJ .AND. J.LE.N) CALL SSWAP( N-J+1, A( JP2, J ), LDA, A( JJ, J ), LDA );
            JJ = J - 1
            if (JP1 != JJ .AND. KSTEP == 2) CALL SSWAP( N-J+1, A( JP1, J ), LDA, A( JJ, J ), LDA )          IF( J.LE.N ) GO TO 60;
         ...
         J = K - 1
            ...
            J = J - 1
            if (JP2 != JJ .AND. J.GE.1) CALL SSWAP( J, A( JP2, 1 ), LDA, A( JJ, 1 ), LDA );
            JJ = J + 1
            if (JP1 != JJ .AND. KSTEP == 2) CALL SSWAP( J, A( JP1, 1 ), LDA, A( JJ, 1 ), LDA )          IF( J.GE.1 ) GO TO 120;
