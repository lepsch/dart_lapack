...
*  =====================================================================
      ...
      if ( N.EQ.1 ) {
         ...
         dlarfg(M, A(1,1), A( MIN( 2, M ), 1 ), 1, T(1,1) );
         ...
         dgemm('T', 'N', N1, N2, M-N1, ONE, A( J1, 1 ), LDA, A( J1, J1 ), LDA, ONE, T( 1, J1 ), LDT);

         dtrmm('L', 'U', 'T', 'N', N1, N2, ONE, T, LDT, T( 1, J1 ), LDT );

         dgemm('N', 'N', M-N1, N2, N1, -ONE, A( J1, 1 ), LDA, T( 1, J1 ), LDT, ONE, A( J1, J1 ), LDA );
         ...
         dgemm('T', 'N', N1, N2, M-N, ONE, A( I1, 1 ), LDA, A( I1, J1 ), LDA, ONE, T( 1, J1 ), LDT );
