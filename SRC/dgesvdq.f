      void dgesvdq(JOBA, JOBP, JOBR, JOBU, JOBV, M, N, A, LDA, S, U, LDU, V, LDV, NUMRANK, IWORK, LIWORK, WORK, LWORK, RWORK, LRWORK, INFO ) {
      // .. Scalar Arguments ..
      IMPLICIT    NONE;
...
// .......................................................................""""""""
         ...
         if ( !WNTUF) CALL DORMQR( 'L', 'N', M, N1, N, A, LDA, WORK, U, LDU, WORK(N+1), LWORK-N, IERR );
         if (ROWPRM && !WNTUF) CALL DLASWP( N1, U, LDU, 1, M-1, IWORK(N+1), -1 );
