...
// =====================================================================
      ...
      if ( N <= 0 ) {
         ...
         ANORM = ABS( D( N ) );
         for (I = 1; I <= N - 1; I++) { // 10
            if( ANORM < ABS( DL( I ) ) || SISNAN( ABS( DL( I ) ) ) ) ANORM = ABS(DL(I));
            if( ANORM < ABS( D( I ) ) || SISNAN( ABS( D( I ) ) ) ) ANORM = ABS(D(I));
            IF( ANORM < ABS( DU( I ) ) || SISNAN (ABS( DU( I ) ) ) ) ANORM = ABS(DU(I));
         } // 10
