 ...
 10      CONTINUE
         ...
         // K is the column to be factorized
          ...
          // > for the rest of the columns, K is J+1, skipping only the
            ...
            CALL SGEMV( 'No transpose', MJ, J-K1, -ONE, H( J, K1 ), LDH, A( 1, J ), 1, ONE, H( J, J ), 1 )
         END IF
         ...
         IF( J.LT.M ) THEN
            ...
            IF( (I2.NE.2) .AND. (PIV.NE.0) ) THEN
               ...
               IF( I1.GT.(K1-1) ) THEN
                  ...
                  CALL SSWAP( I1-K1+1, A( 1, I1 ), 1, A( 1, I2 ), 1 )
               END IF
            ELSE
               IPIV( J+1 ) = J+1
            ENDIF
            ...
            IF( J.LT.NB ) THEN
               ...
               CALL SCOPY( M-J, A( K+1, J+1 ), LDA, H( J+1, J+1 ), 1 )
            END IF
 ...
 30      CONTINUE
         ...
         // K is the column to be factorized
          ...
          // > for the rest of the columns, K is J+1, skipping only the
            ...
            CALL SGEMV( 'No transpose', MJ, J-K1, -ONE, H( J, K1 ), LDH, A( J, 1 ), LDA, ONE, H( J, J ), 1 )
         END IF
         ...
         IF( J.LT.M ) THEN
            ...
            IF( J.LT.NB ) THEN
               ...
               CALL SCOPY( M-J, A( J+1, K+1 ), 1, H( J+1, J+1 ), 1 )
            END IF
