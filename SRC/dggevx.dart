...
void dggevx(String BALANC, String JOBVL, JOBVR, String SENSE, int N, A, int LDA, B, int LDB, ALPHAR, ALPHAI, BETA, VL, int LDVL, VR, int LDVR, int ILO, int IHI, LSCALE, RSCALE, double ABNRM, double BBNRM, RCONDE, RCONDV, WORK, int LWORK, IWORK, BWORK, int INFO ,) {
