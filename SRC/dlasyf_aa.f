      void dlasyf_aa(UPLO, J1, M, NB, A, LDA, IPIV, H, LDH, WORK ) {
      ...
      if ( LSAME( UPLO, 'U' ) ) {
         ...
         if ( J < M ) {
            ...
            if ( (I2 != 2) && (PIV != 0) ) {
               ...
               if (I2 < M) CALL DSWAP( M-I2, A( J1+I1-1, I2+1 ), LDA, A( J1+I2-1, I2+1 ), LDA );
         ...
         if ( J < M ) {
            ...
            if ( (I2 != 2) && (PIV != 0) ) {
               ...
               if (I2 < M) CALL DSWAP( M-I2, A( I2+1, J1+I1-1 ), 1, A( I2+1, J1+I2-1 ), 1 );
