      void dgbtrf(M, N, KL, KU, AB, LDAB, IPIV, INFO ) {
         ...
         DO 180 J = 1, min( M, N ), NB;
            ...
            for (JJ = J; JJ <= J + JB - 1; JJ++) { // 80
               ...
               if ( AB( KV+JP, JJ ) != ZERO ) {
                  ...
                  JM = min( JU, J+JB-1 );
                  if (JM > JJ) CALL DGER( KM, JM-JJ, -ONE, AB( KV+2, JJ ), 1, AB( KV, JJ+1 ), LDAB-1, AB( KV+1, JJ+1 ), LDAB-1 );
               } else {
               ...
               NW = min( JJ-J+1, I3 );
               if (NW > 0) CALL DCOPY( NW, AB( KV+KL+1-JJ+J, JJ ), 1, WORK31( 1, JJ-J+1 ), 1 );
            } // 80
            if ( J+JB <= N ) {
            ...
            DO 170 JJ = J + JB - 1, J, -1;
               ...
               NW = min( I3, JJ-J+1 );
               if (NW > 0) CALL DCOPY( NW, WORK31( 1, JJ-J+1 ), 1, AB( KV+KL+1-JJ+J, JJ ), 1 );
            } // 170
         } // 180
      }
