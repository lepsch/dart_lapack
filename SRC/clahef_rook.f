...
*  =====================================================================
      ...
      if ( LSAME( UPLO, 'U' ) ) {
         ...
         J = K + 1
            ...
            JJ = JJ + 1
            if (KSTEP == 2 .AND. JP1.NE.JJ .AND. J.LE.N) CALL CSWAP( N-J+1, A( JP1, J ), LDA, A( JJ, J ), LDA )          IF( J.LT.N ) GO TO 60;
         ...
         J = K - 1
            ...
            JJ = JJ -1
            if (KSTEP == 2 .AND. JP1.NE.JJ .AND. J.GE.1) CALL CSWAP( J, A( JP1, 1 ), LDA, A( JJ, 1 ), LDA )          IF( J.GT.1 ) GO TO 120;
