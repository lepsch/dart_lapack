      void ssptrf(UPLO, N, AP, IPIV, INFO ) {
...
// =====================================================================
      ...
      REAL               ABSAKK, ALPHA, COLMAX, D11, D12, D21, D22, R1, ROWMAX, T, WK, WKM1, WKP1;
      // ..
      // .. External Functions ..
      //- bool               LSAME;
      //- int                ISAMAX;
      ...
      if ( UPPER ) {
         ...
         if ( max( ABSAKK, COLMAX ) == ZERO ) {
            ...
            if ( ABSAKK >= ALPHA*COLMAX ) {
               ...
               if ( ABSAKK >= ALPHA*COLMAX*( COLMAX / ROWMAX ) ) {
                  ...
                  KP = K;
               } else if ( ( AP( KPC+IMAX-1 ) ).abs() >= ALPHA*ROWMAX ) {
         ...
         if ( max( ABSAKK, COLMAX ) == ZERO ) {
            ...
            if ( KP != KK ) {
               ...
               if (KP < N) sswap( N-KP, AP( KNC+KP-KK+1 ), 1, AP( KPC+1 ), 1 );
               KX = KNC + KP - KK;
            ...
            if ( KSTEP == 1 ) {
               ...
               if ( K < N ) {
                  ...
                  R1 = ONE / AP( KC );
                  sspr(UPLO, N-K, -R1, AP( KC+1 ), 1, AP( KC+N-K+1 ) );
