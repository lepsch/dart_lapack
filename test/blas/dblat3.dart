...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  // final NIN = Nin(stdin);
  final NIN =
      Nin(File('/Users/lepsch/_/lapack/test/blas/dblat3.in').openRead());
...
class _DblatNout extends Nout implements _Dblat2NoutCast {
  late _MainNout main;
...
sealed class _DblatNoutBase implements Nout, _Dblat2NoutCast {
...
void _dchk4(
  ...
  if (FATAL.value) {
    ...
    // }
    NOUT.print9996(SNAME);
    NOUT.print9994(NC, SNAME, UPLO, TRANS, N, K, ALPHA, LDA, BETA, LDC);
    return;
  }
...
void _dchk5(
  ...
  if (FATAL.value) {
    ...
    // }
    NOUT.print9996(SNAME);
    NOUT.print9994(NC, SNAME, UPLO, TRANS, N, K, ALPHA, LDA, LDB, BETA, LDC);
    return;
  }
