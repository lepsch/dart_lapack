      void clattb(IMAT, UPLO, TRANS, DIAG, final Array<int> ISEED, N, KD, final Matrix<double> AB, final int LDAB, B, final Array<double> _WORK, final Array<double> RWORK, final Box<int> INFO ) {
