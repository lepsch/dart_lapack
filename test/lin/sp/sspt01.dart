      void sspt01(final int UPLO, final int N, final int A, final int AFAC, final Array<int> IPIV, final Matrix<double> C, final int LDC, final Array<double> RWORK, final int RESID) {
