...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void cdrvsy_rk(final int DOTYPE, final int NN, final int NVAL, final int NRHS, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int E, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      // EXTERNAL ALADHD, ALAERH, ALASVM, XLAENV, CERRVX, CGET04, CLACPY, CLARHS, CLATB4, CLATMS, CLATSY, CSYSV_RK, CSYT01_3, CSYT02, CSYTRF_RK, CSYTRI_3
      // ..
      // .. Scalars in Common ..
      bool               LERR, OK;
            ...
            for (IUPLO = 1; IUPLO <= 2; IUPLO++) { // 160
               ...
               for (IFACT = 1; IFACT <= NFACT; IFACT++) { // 150
                  ...
                  if ( ZEROT ) {
                     ...
                     csytrf_rk(UPLO, N, AFAC, LDA, E, IWORK, WORK, LWORK, INFO );
