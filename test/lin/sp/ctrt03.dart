      void ctrt03(UPLO, TRANS, DIAG, N, NRHS, final Matrix<double> A, final int LDA, SCALE, CNORM, TSCAL, final Matrix<double> X, final int LDX, final Matrix<double> B, final int LDB, WORK, RESID ) {
