      void spst01(UPLO, N, final Matrix<double> A, final int LDA, final Matrix<double> AFAC, final int LDAFAC, final Matrix<double> PERM, final int LDPERM, PIV, RWORK, RESID, RANK ) {
