      void sgbt01(final int M, final int N, final int KL, final int KU, final Matrix<double> A_, final int LDA, final Matrix<double> AFAC_, final int LDAFAC, final Array<int> IPIV_, final Array<double> _WORK_, final int RESID,) {
  final A = A_.dim();
