      void clattr(IMAT, UPLO, TRANS, DIAG, final Array<int> ISEED, N, final Matrix<double> A, final int LDA, B, final Array<double> _WORK, final Array<double> RWORK, final Box<int> INFO ) {
