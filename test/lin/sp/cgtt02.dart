      void cgtt02(final int TRANS, final int N, final int NRHS, final int DL, final int D, final int DU, final Matrix<double> X_, final int LDX, final Matrix<double> B_, final int LDB, final int RESID,) {
  final X = X_.dim();
  final B = B_.dim();
