      void sqrt15(final int SCALE, final int RKSEL, final int M, final int N, final int NRHS, final Matrix<double> A_, final int LDA, final Matrix<double> B_, final int LDB, final int S, final int RANK, final int NORMA, final int NORMB, final Array<int> ISEED_, final Array<double> WORK_, final int LWORK,) {
  final A = A_.dim();
  final B = B_.dim();
