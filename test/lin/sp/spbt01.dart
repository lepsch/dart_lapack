      void spbt01(final int UPLO, final int N, final int KD, final Matrix<double> A_, final int LDA, final Matrix<double> AFAC_, final int LDAFAC, final Array<double> RWORK_, final int RESID,) {
  final A = A_.dim();
