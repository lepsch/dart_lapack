      void slarhs(PATH, XTYPE, UPLO, TRANS, M, N, KL, KU, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> X, final int LDX, final Matrix<double> B, final int LDB, ISEED, Box<int> INFO ) {
