      void ctrt01(final int UPLO, final int DIAG, final int N, final Matrix<double> A, final int LDA, final Matrix<double> AINV, final int LDAINV, final int RCOND, final Array<double> RWORK, final int RESID) {
