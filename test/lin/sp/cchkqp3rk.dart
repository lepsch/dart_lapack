      void cchkqp3rk(DOTYPE, NM, MVAL, NN, NVAL, NNS, NSVAL, NNB, NBVAL, NXVAL, THRESH, A, COPYA, B, COPYB, S, TAU, final Array<double> _WORK, final Array<double> RWORK, final Array<int> IWORK, final int NOUT) {
// -- LAPACK test routine --
