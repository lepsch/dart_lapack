...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void cchkqp3rk(final int DOTYPE, final int NM, final int MVAL, final int NN, final int NVAL, final int NNS, final int NSVAL, final int NNB, final int NBVAL, final int NXVAL, final int THRESH, final int A, final int COPYA, final int B, final int COPYB, final int S, final int TAU, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
// -- LAPACK test routine --
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  final IWORK = IWORK_.dim();
      ...
      // EXTERNAL ALAERH, ALAHD, ALASUM, SLAORD, ICOPY, CAXPY, XLAENV, CGEQP3RK, CLACPY, CLASET, CLATB4, CLATMS, CUNMQR, CSWAP
      // ..
      // .. Intrinsic Functions ..
            ...
            // 19. Random, CNDNUM = 2, scaled near overflow                            CNDNUM = 2                      LARGE = 1.0/( 0.25 * ( SAFMIN / EPS ) )  3 ( geometric distribution of singular values )
               ...
               for (INB = 1; INB <= NNB; INB++) {
                 ...
                 srnamc.SRNAMT = 'CGEQP3RK';
                  ...
                  if (INFO < 0) alaerh( PATH, 'CGEQP3RK', INFO, 0, ' ', M, N, NX, -1, NB, IMAT, NFAIL, NERRS, NOUT );
                  ...
                  // 2-norm(svd(R) - svd(A)) / ( max(M,N) * 2-norm(svd(A)) * EPS )
                     ...
                     for (T = 1; T <= 1; T++) {
                        if ( RESULT( T ) >= THRESH ) {
                           ...
                           WRITE( NOUT, FMT = 9999 ) 'CGEQP3RK', M, N, NRHS, KMAX, ABSTOL, RELTOL, NB, NX, IMAT, T, RESULT( T );
                           NFAIL = NFAIL + 1;
                        }
                     }
                     NRUN = NRUN + 1;
                  ...
                  RESULT[2] = CQPT01( M, N, KFACT, COPYA, A, LDA, TAU, IWORK( N+1 ), WORK, LWORK );
                  ...
                  RESULT[3] = CQRT11( M, KFACT, A, LDA, TAU, WORK, LWORK );
