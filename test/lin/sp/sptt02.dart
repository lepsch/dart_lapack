      void sptt02(final int N, final int NRHS, final int D, final int E, final Matrix<double> X_, final int LDX, final Matrix<double> B_, final int LDB, final int RESID,) {
  final X = X_.dim();
  final B = B_.dim();
