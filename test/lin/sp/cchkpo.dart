...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void cchkpo(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final int NOUT,) {
...
// +    TEST 2
                 ...
                 srnamc.SRNAMT = 'CPOTRI';
                  ...
                  if (INFO != 0) alaerh( PATH, 'CPOTRI', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 3
                  ...
                  // Check error code from CPOTRS.
                     ...
                     if (INFO != 0) alaerh( PATH, 'CPOTRS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TESTS 5, 6, and 7
                  ...
                  // Check error code from CPORFS.
                     ...
                     if (INFO != 0) alaerh( PATH, 'CPORFS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 8
                 ...
                 srnamc.SRNAMT = 'CPOCON';
                  ...
                  if (INFO != 0) alaerh( PATH, 'CPOCON', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
