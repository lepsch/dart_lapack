      void ssyt01_aa(UPLO, N, final Matrix<double> A, final int LDA, final Matrix<double> AFAC, final int LDAFAC, IPIV, final Matrix<double> C, final int LDC, RWORK, RESID ) {
