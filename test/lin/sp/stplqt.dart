...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void stplqt(final int M, final int N, final int L, final int MB, final Matrix<double> A_, final int LDA, final Matrix<double> B_, final int LDB, final Matrix<double> T_, final int LDT, final Array<double> WORK_, final Box<int> INFO,) {
  final A = A_.having();
  final B = B_.having();
  final T = T_.having();
