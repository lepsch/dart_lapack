      void sgtt02(final int TRANS, final int N, final int NRHS, final int DL, final int D, final int DU, final Matrix<double> X, final int LDX, final Matrix<double> B, final int LDB, final int RESID) {
