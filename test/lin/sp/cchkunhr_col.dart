      void cchkunhr_col(final int THRESH, final int TSTERR, final int NM, final int MVAL, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NOUT,) {
// -- LAPACK test routine --
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      if (TSTERR) cerrunhr_col( PATH, NOUT );
      INFOT = 0;
 ...
 9999 FORMAT( 'CUNGTSQR and CUNHR_COL: M=${.i5}, N=${.i5}, MB1=${.i5}, NB1=${.i5}, NB2=${.i5} test(${.i2})=${.g12_5};
 9998 FORMAT( 'CUNGTSQR_ROW and CUNHR_COL: M=${.i5}, N=${.i5}, MB1=${.i5}, NB1=${.i5}, NB2=${.i5} test(${.i2})=${.g12_5};
      }
