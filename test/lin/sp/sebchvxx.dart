...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void sebchvxx(final int THRESH, final int PATH,) {
      // .. Scalar Arguments ..
      double               THRESH;
      String             PATH;
...
// $$$         WRITE(*,*)
 ...
 9999 FORMAT( ' S${.a2}SVXX: N =${.i2}, RHS = ${.i2}, NWISE GUAR. = ${}, CWISE GUAR. = ${} test(',I1,') =${.g12_5};
 ...
 8000 FORMAT( ' S${.a2}SVXX: N =${.i2}, INFO = ${.i3}, ORCOND = ${.g12_5}, real RCOND = ${.g12_5};
      }
