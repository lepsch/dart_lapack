      void cdrvpp(final int DOTYPE, final int NN, final int NVAL, final int NRHS, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int ASAV, final int B, final int BSAV, final int X, final int XACT, final int S, final Array<double> _WORK_, final Array<double> RWORK_, final int NOUT,) {
               ...
               for (IEQUED = 1; IEQUED <= 2; IEQUED++) { // 110
                  ...
                  for (IFACT = 1; IFACT <= NFACT; IFACT++) { // 100
                    ...
                    srnamc.SRNAMT = 'CLARHS';
                     ...
                     if ( !PREFAC && NPP > 0) claset( 'Full', NPP, 1, CMPLX( ZERO ), CMPLX( ZERO ), AFAC, NPP );
