      void cchkpt(final int DOTYPE, final int NN, final int NVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int A, final int D, final int E, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final int NOUT,) {
...
// +    TEST 2
               ...
               // Check error code from CPTTRS.
                  ...
                  if (INFO != 0) alaerh( PATH, 'CPTTRS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TESTS 4, 5, and 6
               ...
               // Check error code from CPTRFS.
                  ...
                  if (INFO != 0) alaerh( PATH, 'CPTRFS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 7
           ...
           srnamc.SRNAMT = 'CPTCON';
            ...
            if (INFO != 0) alaerh( PATH, 'CPTCON', INFO, 0, ' ', N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
