      void cchksy_rook(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      // EXTERNAL ALAERH, ALAHD, ALASUM, CERRSY, CGESVD, CGET04, CLACPY, CLARHS, CLATB4, CLATMS, CLATSY, CSYT02, CSYT03, CSYCON_ROOK, CSYT01_ROOK, CSYTRF_ROOK, CSYTRI_ROOK, CSYTRS_ROOK, XLAENV
      // ..
      // .. Intrinsic Functions ..
            ...
            for (IUPLO = 1; IUPLO <= 2; IUPLO++) { // 250
               ...
               for (INB = 1; INB <= NNB; INB++) { // 240
                 ...
                 srnamc.SRNAMT = 'CSYTRF_ROOK';
                  ...
                  if (INFO != K) alaerh( PATH, 'CSYTRF_ROOK', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 1
                  ...
                  csyt01_rook(UPLO, N, A, LDA, AFAC, LDA, IWORK, AINV, LDA, RWORK, RESULT( 1 ) );
                  NT = 1;
...
// +    TEST 2
                  ...
                  if ( INB == 1 && !TRFCON ) {
                    ...
                    srnamc.SRNAMT = 'CSYTRI_ROOK';
                     ...
                     if (INFO != 0) alaerh( PATH, 'CSYTRI_ROOK', INFO, -1, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 5 ( Using TRS_ROOK)
                  // Solve and compute residual for  A * X = B.
                    ...
                    srnamc.SRNAMT = 'CSYTRS_ROOK';
                     ...
                     if (INFO != 0) alaerh( PATH, 'CSYTRS_ROOK', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 7
                 ...
                 srnamc.SRNAMT = 'CSYCON_ROOK';
                  ...
                  if (INFO != 0) alaerh( PATH, 'CSYCON_ROOK', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
