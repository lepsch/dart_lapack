      void cdrvhe_aa_2stage(final int DOTYPE, final int NN, final int NVAL, final int NRHS, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK, final Array<double> RWORK, final Array<int> IWORK, final int NOUT,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      // EXTERNAL ALADHD, ALAERH, ALASVM, XLAENV, CERRVX, CGET04, CLACPY, CLARHS, CLATB4, CLATMS, CHESV_AA_2STAGE, CPOT02, CHETRF_AA_2STAGE
      // ..
      // .. Scalars in Common ..
      bool               LERR, OK;
               ...
               for (IFACT = 1; IFACT <= NFACT; IFACT++) { // 150
                 ...
                 srnamc.SRNAMT = 'CLARHS';
                  ...
                  if ( IFACT == 2 ) {
                    ...
                    srnamc.SRNAMT = 'CHESV_AA_2STAGE ';
                     LWORK = min( max( 1, N*NB ), 3*NMAX*NMAX);
                     chesv_aa_2stage(UPLO, N, NRHS, AFAC, LDA, AINV, max( 1, (3*NB+1)*N ), IWORK, IWORK( 1+N ), X, LDA, WORK, LWORK, INFO );
                     ...
                     cpot02(UPLO, N, NRHS, A, LDA, X, LDA, WORK, LDA, RWORK, RESULT( 1 ) );
...
// $                                  RESULT( 2 ) )
                     ...
                     for (K = 1; K <= NT; K++) { // 110
                        if ( RESULT( K ) >= THRESH ) {
                           ...
                           WRITE( NOUT, FMT = 9999 )'CHESV_AA ', UPLO, N, IMAT, K, RESULT( K );
                           NFAIL = NFAIL + 1;
                        }
                     } // 110
                     NRUN = NRUN + NT;
