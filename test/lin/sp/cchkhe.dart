...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void cchkhe(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      // EXTERNAL ALAERH, ALAHD, ALASUM, CERRHE, CGET04, CHECON, CHERFS, CHET01, CHETRF, CHETRI2, CHETRS, CLACPY, CLAIPD, CLARHS, CLATB4, CLATMS, CPOT02, CPOT03, CPOT05, XLAENV
      // ..
      // .. Intrinsic Functions ..
      // INTRINSIC MAX, MIN
      // ..
              ...
              srnamc.SRNAMT = 'CLATMS';
               ...
               for (INB = 1; INB <= NNB; INB++) { // 150
                 ...
                 srnamc.SRNAMT = 'CHETRF';
                  ...
                  if (INFO != K) alaerh( PATH, 'CHETRF', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 2
                  ...
                  if ( INB == 1 && !TRFCON ) {
                    ...
                    srnamc.SRNAMT = 'CHETRI2';
                     ...
                     if (INFO != 0) alaerh( PATH, 'CHETRI2', INFO, -1, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 3 (Using TRS)
                  // Solve and compute residual for  A * X = B.
                    ...
                    srnamc.SRNAMT = 'CHETRS';
                     ...
                     if (INFO != 0) alaerh( PATH, 'CHETRS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 4 (Using TRS2)
                  // Solve and compute residual for  A * X = B.
                    ...
                    srnamc.SRNAMT = 'CHETRS2';
                     chetrs2(UPLO, N, NRHS, AFAC, LDA, IWORK, X, LDA, WORK, INFO );

                     // Check error code from CHETRS2 and handle error.

                     if (INFO != 0) alaerh( PATH, 'CHETRS2', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TESTS 6, 7, and 8
                  // Use iterative refinement to improve the solution.
                    ...
                    srnamc.SRNAMT = 'CHERFS';
                     ...
                     if (INFO != 0) alaerh( PATH, 'CHERFS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 9
                 ...
                 srnamc.SRNAMT = 'CHECON';
                  ...
                  if (INFO != 0) alaerh( PATH, 'CHECON', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
                  ...
                  if ( RESULT( 9 ) >= THRESH ) {
                     if (NFAIL == 0 && NERRS == 0) alahd( NOUT, PATH );
                     WRITE( NOUT, FMT = 9997 )UPLO, N, IMAT, 8, RESULT( 9 );
                     NFAIL = NFAIL + 1;
                  }
                  NRUN = NRUN + 1;
               } // 150
