...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      double sqrt14(final int TRANS, final int M, final int N, final int NRHS, final Matrix<double> A_, final int LDA, final Matrix<double> X_, final int LDX, final Array<double> WORK_, final int LWORK,) {
  final A = A_.dim();
  final X = X_.dim();
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      if (ANRM != ZERO) slascl( 'G', 0, 0, ANRM, ONE, M, N, WORK, LDWORK, INFO );
      ...
      if ( TPSD ) {
         ...
         if (XNRM != ZERO) slascl( 'G', 0, 0, XNRM, ONE, NRHS, N, WORK( M+1 ), LDWORK, INFO );
