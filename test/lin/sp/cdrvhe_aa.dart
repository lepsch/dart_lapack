...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void cdrvhe_aa(final int DOTYPE, final int NN, final int NVAL, final int NRHS, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      // EXTERNAL ALADHD, ALAERH, ALASVM, XLAENV, CERRVX, CGET04, CLACPY, CLARHS, CLATB4, CLATMS, CHESV_AA, CHET01_AA, CPOT02, CHETRF_AA
      // ..
      // .. Scalars in Common ..
      bool               LERR, OK;
                 ...
                 srnamc.SRNAMT = 'CLARHS';
                  ...
                  if ( IFACT == 2 ) {
                    ...
                    srnamc.SRNAMT = 'CHESV_AA ';
                     ...
                     chet01_aa(UPLO, N, A, LDA, AFAC, LDA, IWORK, AINV, LDA, RWORK, RESULT( 1 ) );
