      void slattp(final int IMAT, final int UPLO, final int TRANS, final int DIAG, final Array<int> ISEED_, final int N, final int A, final int B, final Array<double> _WORK_, final Box<int> INFO,) {
