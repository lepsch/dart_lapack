...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void schksy(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
              ...
              srnamc.SRNAMT = 'SLATMS';
               ...
               for (INB = 1; INB <= NNB; INB++) { // 150
                 ...
                 srnamc.SRNAMT = 'SSYTRF';
                  ...
                  if (INFO != K) alaerh( PATH, 'SSYTRF', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 2
                  ...
                  if ( INB == 1 && !TRFCON ) {
                    ...
                    srnamc.SRNAMT = 'SSYTRI2';
                     ...
                     if (INFO != 0) alaerh( PATH, 'SSYTRI2', INFO, -1, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 3 (Using DSYTRS)
                  // Solve and compute residual for  A * X = B.
                    ...
                    srnamc.SRNAMT = 'SSYTRS';
                     ...
                     if (INFO != 0) alaerh( PATH, 'SSYTRS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 4 (Using DSYTRS2)
                  // Solve and compute residual for  A * X = B.
                    ...
                    srnamc.SRNAMT = 'DSYTRS2';
                     ...
                     if (INFO != 0) alaerh( PATH, 'SSYTRS2', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TESTS 6, 7, and 8
                  // Use iterative refinement to improve the solution.
                    ...
                    srnamc.SRNAMT = 'SSYRFS';
                     ...
                     if (INFO != 0) alaerh( PATH, 'SSYRFS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 9
                 ...
                 srnamc.SRNAMT = 'SSYCON';
                  ...
                  if (INFO != 0) alaerh( PATH, 'SSYCON', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
