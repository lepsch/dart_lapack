...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void schksy_rk(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int E, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
              ...
              srnamc.SRNAMT = 'SLATMS';
               ...
               for (INB = 1; INB <= NNB; INB++) { // 240
                 ...
                 srnamc.SRNAMT = 'SSYTRF_RK';
                  ...
                  if (INFO != K) alaerh( PATH, 'SSYTRF_RK', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 2
                  ...
                  if ( INB == 1 && !TRFCON ) {
                    ...
                    srnamc.SRNAMT = 'SSYTRI_3';
                     ...
                     if (INFO != 0) alaerh( PATH, 'SSYTRI_3', INFO, -1, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 5 ( Using TRS_3)
                  // Solve and compute residual for  A * X = B.
                    ...
                    srnamc.SRNAMT = 'SSYTRS_3';
                     ...
                     if (INFO != 0) alaerh( PATH, 'SSYTRS_3', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 7
                 ...
                 srnamc.SRNAMT = 'SSYCON_3';
                  ...
                  if (INFO != 0) alaerh( PATH, 'SSYCON_3', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
