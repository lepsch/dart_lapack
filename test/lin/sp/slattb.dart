      void slattb(IMAT, UPLO, TRANS, DIAG, final Array<int> ISEED, N, KD, final Matrix<double> AB, final int LDAB, B, final Array<double> _WORK, final Box<int> INFO ) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      // triangular system they may cause overflow in the solution vector.
         ...
         TSCAL = BIGNUM*( double( KD ) / REAL( KD+1 ) );
         if ( UPPER ) {
            for (J = 1; J <= N; J++) { // 400
               LENJ = min( J, KD+1 );
               slarnv(2, ISEED, LENJ, AB( KD+2-LENJ, J ) );
