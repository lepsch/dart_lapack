      double cqrt17(TRANS, IRESID, M, N, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> X, final int LDX, final Matrix<double> B, final int LDB, C, final Array<double> WORK, final int LWORK) {
