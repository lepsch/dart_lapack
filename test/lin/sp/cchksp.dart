...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void cchksp(final int DOTYPE, final int NN, final int NVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
         ...
         for (IMAT = 1; IMAT <= NIMAT; IMAT++) { // 160
            ...
            for (IUPLO = 1; IUPLO <= 2; IUPLO++) { // 150
              ...
              srnamc.SRNAMT = 'CSPTRF';
               ...
               if (INFO != K) alaerh( PATH, 'CSPTRF', INFO, K, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
               if ( INFO != 0 ) {
                  TRFCON = true;
               } else {
                  TRFCON = false;
...
// +    TEST 2
               ...
               // Check error code from CSPTRI.
                  ...
                  if (INFO != 0) alaerh( PATH, 'CSPTRI', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 3
               ...
               // Check error code from CSPTRS.
                  ...
                  if (INFO != 0) alaerh( PATH, 'CSPTRS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TESTS 5, 6, and 7
               ...
               // Check error code from CSPRFS.
                  ...
                  if (INFO != 0) alaerh( PATH, 'CSPRFS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 8
              ...
              srnamc.SRNAMT = 'CSPCON';
               ...
               if (INFO != 0) alaerh( PATH, 'CSPCON', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
