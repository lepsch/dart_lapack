      void cdrvsy_aa_2stage(final int DOTYPE, final int NN, final int NVAL, final int NRHS, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK, final Array<double> RWORK, final Array<int> IWORK, final int NOUT,) {
                 ...
                 srnamc.SRNAMT = 'CLARHS';
                  ...
                  if ( IFACT == 2 ) {
                    ...
                    srnamc.SRNAMT = 'CSYSV_AA_2STAGE ';
                     ...
                     if ( INFO != K ) {
                        alaerh(PATH, 'CSYSV_AA', INFO, K, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
                        GO TO 120;
                     } else if ( INFO != 0 ) {
                        GO TO 120;
                     }
      ...
      //                 NT = 2
                     ...
                     for (K = 1; K <= NT; K++) { // 110
                        if ( RESULT( K ) >= THRESH ) {
                           ...
                           WRITE( NOUT, FMT = 9999 )'CSYSV_AA_2STAGE ', UPLO, N, IMAT, K, RESULT( K );
                           NFAIL = NFAIL + 1;
                        }
                     } // 110
                     NRUN = NRUN + NT;
