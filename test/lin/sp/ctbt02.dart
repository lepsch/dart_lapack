      void ctbt02(UPLO, TRANS, DIAG, N, KD, NRHS, final Matrix<double> AB, final int LDAB, final Matrix<double> X, final int LDX, final Matrix<double> B, final int LDB, WORK, RWORK, RESID ) {
