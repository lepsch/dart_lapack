      void sdrvpp(DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX, A, AFAC, ASAV, B, BSAV, X, XACT, S, final Array<double> _WORK, final Array<double> RWORK, final Array<int> IWORK, final int NOUT) {
               ...
               for (IEQUED = 1; IEQUED <= 2; IEQUED++) { // 110
                  ...
                  for (IFACT = 1; IFACT <= NFACT; IFACT++) { // 100
                    ...
                    srnamc.SRNAMT = 'SLARHS';
                       ...
                       srnamc.SRNAMT = 'SPPSV ';
                        ...
                        for (K = 1; K <= NT; K++) { // 60
                           if ( RESULT( K ) >= THRESH ) {
                              ...
                              WRITE( NOUT, FMT = 9999 )'SPPSV ', UPLO, N, IMAT, K, RESULT( K );
                              NFAIL = NFAIL + 1;
                           }
                        } // 60
                        NRUN = NRUN + NT;
                     ...
                     if ( !PREFAC && NPP > 0) slaset( 'Full', NPP, 1, ZERO, ZERO, AFAC, NPP );
