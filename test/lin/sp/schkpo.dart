...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void schkpo(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
...
// +    TEST 2
                 ...
                 srnamc.SRNAMT = 'SPOTRI';
                  ...
                  if (INFO != 0) alaerh( PATH, 'SPOTRI', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 3
                  ...
                  // Check error code from SPOTRS.
                     ...
                     if (INFO != 0) alaerh( PATH, 'SPOTRS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TESTS 5, 6, and 7
                  ...
                  // Check error code from SPORFS.
                     ...
                     if (INFO != 0) alaerh( PATH, 'SPORFS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 8
                 ...
                 srnamc.SRNAMT = 'SPOCON';
                  ...
                  if (INFO != 0) alaerh( PATH, 'SPOCON', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
