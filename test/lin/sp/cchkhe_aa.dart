      void cchkhe_aa(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      // EXTERNAL ALAERH, ALAHD, ALASUM, XLAENV, CERRHE, CHET01_AA, CHETRF_AA, CHETRS_AA, CLACPY, CLAIPD, CLARHS, CLATB4, CLATMS, CPOT02
      // ..
      // .. Intrinsic Functions ..
      // INTRINSIC MAX, MIN
      // ..
