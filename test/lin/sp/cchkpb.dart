      void cchkpb(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final int NOUT,) {
...
// +    TEST 2
                     ...
                     // Check error code from CPBTRS.
                        ...
                        if (INFO != 0) alaerh( PATH, 'CPBTRS', INFO, 0, UPLO, N, N, KD, KD, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TESTS 4, 5, and 6
                     ...
                     // Check error code from CPBRFS.
                        ...
                        if (INFO != 0) alaerh( PATH, 'CPBRFS', INFO, 0, UPLO, N, N, KD, KD, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 7
                    ...
                    srnamc.SRNAMT = 'CPBCON';
                     ...
                     if (INFO != 0) alaerh( PATH, 'CPBCON', INFO, 0, UPLO, N, N, KD, KD, -1, IMAT, NFAIL, NERRS, NOUT );
