...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void claptm(final int UPLO, final int N, final int NRHS, final int ALPHA, final int D, final int E, final Matrix<double> X_, final int LDX, final int BETA, final int B, final int LDB,) {
  final X = X_.dim();
