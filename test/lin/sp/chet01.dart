      void chet01(UPLO, N, final Matrix<double> A, final int LDA, final Matrix<double> AFAC, final int LDAFAC, IPIV, final Matrix<double> C, final int LDC, final Array<double> RWORK, RESID ) {
