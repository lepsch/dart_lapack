      void zchkpo(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final int NOUT,) {
...
// +    TEST 2
                 ...
                 srnamc.SRNAMT = 'ZPOTRI';
                  ...
                  if (INFO != 0) alaerh( PATH, 'ZPOTRI', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 3
                  ...
                  // Check error code from ZPOTRS.
                     ...
                     if (INFO != 0) alaerh( PATH, 'ZPOTRS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TESTS 5, 6, and 7
                  ...
                  // Check error code from ZPORFS.
                     ...
                     if (INFO != 0) alaerh( PATH, 'ZPORFS', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
