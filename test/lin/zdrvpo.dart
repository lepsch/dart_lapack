          ...
          for (var IFACT = 1; IFACT <= NFACT; IFACT++) {
            ...
            for (var K = K1; K <= 6; K++) {
              if (RESULT[K] >= THRESH) {
                ...
                if (PREFAC) {
                  NOUT.println(
                      ' ZPOSVX, FACT=\'${FACT.a1}\', UPLO=\'${UPLO.a1}\', N=${N.i5}, EQUED=\'${EQUED.value.a1}\', type ${IMAT.i1}, test(${K.i1}) =${RESULT[K].g12_5}');
                } else {
                  NOUT.println(
                      ' ZPOSVX, FACT=\'${FACT.a1}\', UPLO=\'${UPLO.a1}\', N=${N.i5}, type ${IMAT.i1}, test(${K.i1})=${RESULT[K].g12_5}');
                }
                NFAIL++;
              }
            }
