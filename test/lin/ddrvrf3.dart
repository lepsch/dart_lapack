import 'common.dart';
      ...
      void ddrvrf3(final int NOUT, final int NN, final int NVAL, final int THRESH, final Matrix<double> A, final int LDA, final int ARF, final int B1, final int B2, final int D_WORK_DLANGE, final int D_WORK_DGEQRF, final int TAU) {
