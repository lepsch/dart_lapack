...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  if (lsamen(2, C2, 'GE')) {
    ...
    test('DGETRF', () {
      ...
      chkxer('DGETRF', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DGETF2', () {
      ...
      chkxer('DGETF2', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DGETRI', () {
      ...
      chkxer('DGETRI', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 3;
    ...
    test('DGETRS', () {
      ...
      chkxer('DGETRS', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DGERFS', () {
      ...
      dgerfs('/', 0, 0, A, 1, AF, 1, IP, B.asMatrix(), 1, X.asMatrix(), 1, R1,
          R2, W, IW, INFO);
      chkxer('DGERFS', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DGECON', () {
      ...
      chkxer('DGECON', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DGEEQU', () {
      ...
      chkxer('DGEEQU', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DGBTRF', () {
      ...
      chkxer('DGBTRF', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DGBTF2', () {
      ...
      chkxer('DGBTF2', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DGBTRS', () {
      ...
      chkxer('DGBTRS', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DGBRFS', () {
      ...
      dgbrfs('/', 0, 0, 0, 0, A, 1, AF, 1, IP, B.asMatrix(), 1, X.asMatrix(), 1,
          R1, R2, W, IW, INFO);
      chkxer('DGBRFS', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DGBCON', () {
      ...
      chkxer('DGBCON', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DGBEQU', () {
      ...
      chkxer('DGBEQU', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
