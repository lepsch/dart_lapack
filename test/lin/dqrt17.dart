      double dqrt17(final int TRANS, final int IRESID, final int M, final int N, final int NRHS, final Matrix<double> A_, final int LDA, final Matrix<double> X_, final int LDX, final Matrix<double> B_, final int LDB, final int C, final Array<double> WORK_, final int LWORK,) {
  final A = A_.dim();
  final X = X_.dim();
  final B = B_.dim();
