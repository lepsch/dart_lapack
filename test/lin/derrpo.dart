...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  if (lsamen(2, C2, 'PO')) {
    ...
    test('DPOTRF', () {
      ...
      infoc.INFOT = 1;
      dpotrf('/', 0, A, 1, INFO);
      chkxer('DPOTRF', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
      dpotrf('U', -1, A, 1, INFO);
      chkxer('DPOTRF', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 4;
    ...
    test('DPOTF2', () {
      ...
      infoc.INFOT = 1;
      dpotf2('/', 0, A, 1, INFO);
      chkxer('DPOTF2', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
      dpotf2('U', -1, A, 1, INFO);
      chkxer('DPOTF2', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 4;
    ...
    test('DPOTRI', () {
      ...
      infoc.INFOT = 1;
      dpotri('/', 0, A, 1, INFO);
      chkxer('DPOTRI', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
      dpotri('U', -1, A, 1, INFO);
      chkxer('DPOTRI', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 4;
    ...
    test('DPOTRS', () {
      ...
      chkxer('DPOTRS', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPORFS', () {
      ...
      dporfs('/', 0, 0, A, 1, AF, 1, B.asMatrix(), 1, X.asMatrix(), 1, R1, R2,
          W, IW, INFO);
      chkxer('DPORFS', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPOCON', () {
      ...
      chkxer('DPOCON', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPOEQU', () {
      ...
      chkxer('DPOEQU', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 3;
    ...
    test('DPPTRF', () {
      ...
      chkxer('DPPTRF', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPPTRI', () {
      ...
      chkxer('DPPTRI', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPPTRS', () {
      ...
      chkxer('DPPTRS', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPPRFS', () {
      ...
      chkxer('DPPRFS', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPPCON', () {
      ...
      chkxer('DPPCON', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPPEQU', () {
      ...
      chkxer('DPPEQU', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPBTRF', () {
      ...
      infoc.INFOT = 1;
      dpbtrf('/', 0, 0, A, 1, INFO);
      chkxer('DPBTRF', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPBTF2', () {
      ...
      infoc.INFOT = 1;
      dpbtf2('/', 0, 0, A, 1, INFO);
      chkxer('DPBTF2', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPBTRS', () {
      ...
      chkxer('DPBTRS', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPBRFS', () {
      ...
      dpbrfs('/', 0, 0, 0, A, 1, AF, 1, B.asMatrix(), 1, X.asMatrix(), 1, R1,
          R2, W, IW, INFO);
      chkxer('DPBRFS', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPBCON', () {
      ...
      chkxer('DPBCON', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
    ...
    test('DPBEQU', () {
      ...
      chkxer('DPBEQU', infoc.INFOT, NOUT, LERR, OK);
      infoc.INFOT = 2;
