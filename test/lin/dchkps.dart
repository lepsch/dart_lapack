import 'common.dart';
      ...
      void dchkps(DOTYPE, NN, NVAL, NNB, NBVAL, NRANK, RANKVAL, THRESH, TSTERR, NMAX, A, AFAC, PERM, PIV, final Array<double> _WORK, final Array<double> RWORK, final int NOUT) {
