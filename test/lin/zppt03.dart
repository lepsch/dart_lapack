      void zppt03(final int UPLO, final int N, final int A, final int AINV, final Matrix<double> WORK, final int LDWORK, final Array<double> RWORK, final int RCOND, final int RESID) {
