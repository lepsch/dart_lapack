...
import 'package:dart_lapack/src/zgesvxx.dart';
...
void zdrvge(
  ...
  const NTYPES = 11, NTESTS = 7, NTRAN = 3;
  final ISEED = Array<int>(4);
  final RDUM = Array<double>(1),
        ...
        for (var IFACT = 1; IFACT <= NFACT; IFACT++) {
          ...
          for (var ITRAN = 1; ITRAN <= NTRAN; ITRAN++) {
...

            {
              ...
              if (!PREFAC) {
                zlaset('Full', N, N, Complex.zero, Complex.zero,
                    AFAC.asMatrix(), LDA);
              }
              ...
              if (INFO.value != IZERO) {
                alaerh(PATH, 'ZGESVX', INFO.value, IZERO, FACT + TRANS, N, N,
              ...
              if (INFO.value != 0) {
                ...
                RPVGRW =
                    zlantr('M', 'U', 'N', N, N, AFAC.asMatrix(), LDA, RDUM);
                if (RPVGRW == ZERO) {
                  RPVGRW = ONE;
                } else {
              ...
              if (INFO.value == 0) {
                ...
                zlacpy('Full', N, NRHS, BSAV.asMatrix(), LDA, WORK.asMatrix(),
                    LDA);
                zget02(TRANS, N, N, NRHS, ASAV.asMatrix(), LDA, X.asMatrix(),
              ...
              if (!TRFCON) {
                for (var K = K1; K <= NTESTS; K++) {
                  if (RESULT[K] >= THRESH) {
                    if (NFAIL == 0 && NERRS.value == 0) aladhd(NOUT, PATH);
                    if (PREFAC) {
                      NOUT.print9997('ZGESVX', FACT, TRANS, N, EQUED.value,
                          IMAT, K, RESULT[K]);
                    } else {
                      NOUT.print9998(
                ...
                if (RESULT[1] >= THRESH && !PREFAC) {
                  ...
                  if (PREFAC) {
                    ...
                    NOUT.print9998(
                        'ZGESVX', FACT, TRANS, N, IMAT, 1, RESULT[1]);
                  }
                  NFAIL++;
                  NRUN++;
                }
                if (RESULT[6] >= THRESH) {
                  ...
                  if (PREFAC) {
                    ...
                    NOUT.print9998(
                        'ZGESVX', FACT, TRANS, N, IMAT, 6, RESULT[6]);
                  }
                  NFAIL++;
                  NRUN++;
                }
                if (RESULT[7] >= THRESH) {
                  ...
                  if (PREFAC) {
                    ...
                    NOUT.print9998(
                        'ZGESVX', FACT, TRANS, N, IMAT, 7, RESULT[7]);
                  }
                  NFAIL++;
                  NRUN++;
                }
...

            {
              ...
              if (INFO.value != IZERO) {
                alaerh(PATH, 'ZGESVXX', INFO.value, IZERO, FACT + TRANS, N, N,
                    -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT);
                continue;
              }
              ...
              if (INFO.value > 0 && INFO.value < N + 1) {
                ...
                RPVGRW =
                    zla_gerpvgrw(N, N, A.asMatrix(), LDA, AFAC.asMatrix(), LDA);
              }
              ...
              if (!TRFCON) {
                for (var K = K1; K <= NTESTS; K++) {
                  if (RESULT[K] >= THRESH) {
                    if (NFAIL == 0 && NERRS.value == 0) aladhd(NOUT, PATH);
                    if (PREFAC) {
                      NOUT.print9997('ZGESVXX', FACT, TRANS, N, EQUED.value,
                          IMAT, K, RESULT[K]);
                    } else {
                      NOUT.print9998(
                          'ZGESVXX', FACT, TRANS, N, IMAT, K, RESULT[K]);
                    }
                    NFAIL++;
                  }
                }
                ...
                if (RESULT[1] >= THRESH && !PREFAC) {
                  if (NFAIL == 0 && NERRS.value == 0) aladhd(NOUT, PATH);
                  if (PREFAC) {
                    NOUT.print9997('ZGESVXX', FACT, TRANS, N, EQUED.value, IMAT,
                        1, RESULT[1]);
                  } else {
                    NOUT.print9998(
                        'ZGESVXX', FACT, TRANS, N, IMAT, 1, RESULT[1]);
                  }
                  NFAIL++;
                  NRUN++;
                }
                if (RESULT[6] >= THRESH) {
                  ...
                  if (PREFAC) {
                    ...
                    NOUT.print9998(
                        'ZGESVXX', FACT, TRANS, N, IMAT, 6, RESULT[6]);
                  }
                  NFAIL++;
                  NRUN++;
                }
                if (RESULT[7] >= THRESH) {
                  ...
                  if (PREFAC) {
                    ...
                    NOUT.print9998(
                        'ZGESVXX', FACT, TRANS, N, IMAT, 7, RESULT[7]);
                  }
                  NFAIL++;
                  NRUN++;
                }
