        ...
        for (var IKU = 1; IKU <= NKU; IKU++) {
          ...
          for (var IMAT = 1; IMAT <= NIMAT; IMAT++) {
            ...
            for (var INB = 1; INB <= NNB; INB++) {
              ...
              if (INFO.value != IZERO) {
                alaerh(PATH, 'DGBTRF', INFO.value, IZERO, ' ', M, N, KL, KU, NB,
                    IMAT, NFAIL, NERRS, NOUT);
              }
              ...
              for (var IRHS = 1; IRHS <= NNS; IRHS++) {
                ...
                for (var ITRAN = 1; ITRAN <= NTRAN; ITRAN++) {
                  ...
                  srnamc.SRNAMT = 'DGBTRS';
                  dgbtrs(TRANS, N, KL, KU, NRHS, AFAC.asMatrix(), LDAFAC, IWORK,
                      X.asMatrix(), LDB, INFO);
                  ...
                  dlacpy(
                      'Full', N, NRHS, B.asMatrix(), LDB, WORK.asMatrix(), LDB);
                  dgbt02(
                      TRANS,
                      M,
                      N,
              ...
              for (var ITRAN = 1; ITRAN <= 2; ITRAN++) {
                ...
                if (INFO.value != 0) {
                  alaerh(PATH, 'DGBCON', INFO.value, 0, NORM, N, N, KL, KU, -1,
                      IMAT, NFAIL, NERRS, NOUT);
                }
