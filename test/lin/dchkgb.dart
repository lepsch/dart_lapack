import 'common.dart';
      ...
      void dchkgb(DOTYPE, NM, MVAL, NN, NVAL, NNB, NBVAL, NNS, NSVAL, THRESH, TSTERR, A, LA, AFAC, LAFAC, B, X, XACT, WORK, final Array<double> RWORK, final Array<int> IWORK, NOUT ) {
