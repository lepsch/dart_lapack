import 'common.dart';
      ...
      void dchkgb(final int DOTYPE, final int NM, final int MVAL, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int A, final int LA, final int AFAC, final int LAFAC, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
               ...
               for (IKU = 1; IKU <= NKU; IKU++) { // 130
                  ...
                  for (IMAT = 1; IMAT <= NIMAT; IMAT++) { // 120
                     ...
                     for (INB = 1; INB <= NNB; INB++) { // 110
                        ...
                        if (INFO != IZERO) alaerh( PATH, 'DGBTRF', INFO, IZERO, ' ', M, N, KL, KU, NB, IMAT, NFAIL, NERRS, NOUT );
                        TRFCON = false;
...
// +    TEST 2:
                              ...
                              if (INFO != 0) alaerh( PATH, 'DGBTRS', INFO, 0, TRANS, N, N, KL, KU, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TESTS 4, 5, 6:
                              ...
                              if (INFO != 0) alaerh( PATH, 'DGBRFS', INFO, 0, TRANS, N, N, KL, KU, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 7:
                        ...
                        for (ITRAN = 1; ITRAN <= 2; ITRAN++) { // 100
                           ...
                           if (INFO != 0) alaerh( PATH, 'DGBCON', INFO, 0, NORM, N, N, KL, KU, -1, IMAT, NFAIL, NERRS, NOUT );
