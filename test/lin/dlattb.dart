      void dlattb(final int IMAT, final int UPLO, final int TRANS, final int DIAG, final Array<int> ISEED, final int N, final int KD, final Matrix<double> AB, final int LDAB, final int B, final Array<double> _WORK, final Box<int> INFO,) {
