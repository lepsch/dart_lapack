import 'common.dart';
      ...
      void dchktb(DOTYPE, NN, NVAL, NNS, NSVAL, THRESH, TSTERR, NMAX, AB, AINV, B, X, XACT, WORK, RWORK, IWORK, NOUT ) {
...
// +    TEST 8
 ...
 9998 FORMAT( 1X, A, '( ''${.a1}''${.a1}''${.a1}'',${.i5},${.i5},  ... ), type ${.i2}, test(${.i2})=${.g12_5};
 9997 FORMAT( 1X, A, '( ''${.a1}''${.a1}''${.a1}''${.a1}'',${.i5},${.i5}, ...  ),  type ${.i2}, test(${.i1})=${.g12_5};
      return;
      }
