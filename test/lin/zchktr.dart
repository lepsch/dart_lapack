      void zchktr(final Array<bool> DOTYPE_, final int NN, final Array<int> NVAL_, final int NNB, final Array<int> NBVAL_, final int NNS, final Array<int> NSVAL_, final double THRESH, final bool TSTERR, final int NMAX, final int A, final int AINV, final int B, final Array<double> X_, final Array<double> XACT_, final Array<double> WORK_, final Array<double> RWORK_, final Nout NOUT,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      String             PATH;
      int                I, IDIAG, IMAT, IN, INB, INFO, IRHS, ITRAN, IUPLO, K, LDA, N, NB, NRHS;
      double             AINVNM, ANORM, BIGNUM, DUMMY, RCOND, RCONDC, RCONDI, RCONDO, RES, SCALE, DLAMCH;
      String             TRANSS( NTRAN ), UPLOS( 2 );
      final                ISEED=Array<int>( 4 );
      final             RESULT=Array<double>( NTESTS ), RWORK2( 2*NMAX ), SCALE3( 2 );
      // ..
      // .. External Functions ..
      //- bool               lsame;
      //- double             ZLANTR;
...
// +    TEST 1
                 ...
                 srnamc.SRNAMT = 'ZTRTRI';
                  ...
                  if ( RESULT[1] >= THRESH ) {
                     ...
                     NOUT.println( 9999 )UPLO, DIAG, N, NB, IMAT, 1, RESULT( 1 );
                     NFAIL++;
                  }
                  NRUN++;
...
// +    TEST 7
                  ...
                  for (ITRAN = 1; ITRAN <= 2; ITRAN++) { // 50
                    ...
                    srnamc.SRNAMT = 'ZTRCON';
                     ...
                     if ( RESULT[7] >= THRESH ) {
                        if (NFAIL == 0 && NERRS.value == 0) alahd( NOUT, PATH );
                        NOUT.println( 9997 )NORM, UPLO, N, IMAT, 7, RESULT( 7 );
                        NFAIL++;
                     }
                     NRUN++;
                  } // 50
...
// +    TEST 10
                 ...
                 srnamc.SRNAMT = 'ZLATRS3';
                  ...
                  if ( RESULT[8] >= THRESH ) {
                     if (NFAIL == 0 && NERRS.value == 0) alahd( NOUT, PATH );
                     NOUT.println( 9996 )'ZLATRS', UPLO, TRANS, DIAG, 'N', N, IMAT, 8, RESULT( 8 );
                     NFAIL++;
                  }
                  if ( RESULT[9] >= THRESH ) {
                     if (NFAIL == 0 && NERRS.value == 0) alahd( NOUT, PATH );
                     NOUT.println( 9996 )'ZLATRS', UPLO, TRANS, DIAG, 'Y', N, IMAT, 9, RESULT( 9 );
                     NFAIL++;
                  }
                  if ( RESULT[10] >= THRESH ) {
                     if (NFAIL == 0 && NERRS.value == 0) alahd( NOUT, PATH );
                     NOUT.println( 9996 )'ZLATRS3', UPLO, TRANS, DIAG, 'N', N, IMAT, 10, RESULT( 10 );
                     NFAIL++;
                  }
                  NRUN +=  3;
               } // 90
 ...
 9999 FORMAT( ' UPLO=\'${.a1}\', DIAG=\'${.a1}\', N=${N.i5}, NB=${.i4}, type ${IMAT.i2}, test(${.i2})= ${.g12_5};
 9998 FORMAT( ' UPLO=\'${.a1}\', TRANS=\'${TRANS.a1}\', DIAG=\'${.a1}\', N=${N.i5}, NB=${.i4}, type ${IMAT.i2}, test(${.i2})= ${.g12_5};
 9997 FORMAT( ' NORM=\'${.a1}\', UPLO =\'${.a1}\', N=${N.i5},${' ' * 11} type ${IMAT.i2}, test(${.i2})=${.g12_5};
