      void zchkhe_rook(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      double             ALPHA, ANORM, CNDNUM, CONST, SING_MAX, SING_MIN, RCOND, RCONDC, DTEMP;
      String             UPLOS( 2 );
      ...
      // ..
      // .. External Functions ..
      //- double             ZLANGE, ZLANHE, DGET06;
      // EXTERNAL ZLANGE, ZLANHE, DGET06
      // ..
      // .. External Subroutines ..
      // EXTERNAL ALAERH, ALAHD, ALASUM, ZERRHE, ZGESVD, ZGET04, ZLACPY, ZLARHS, ZLATB4, ZLATMS, ZPOT02, ZPOT03, ZHECON_ROOK, ZHET01_ROOK, ZHETRF_ROOK, ZHETRI_ROOK, ZHETRS_ROOK, XLAENV
      // ..
      // .. Intrinsic Functions ..
            ...
            for (IUPLO = 1; IUPLO <= 2; IUPLO++) { // 250
               ...
               for (INB = 1; INB <= NNB; INB++) { // 240
                 ...
                 srnamc.SRNAMT = 'ZHETRF_ROOK';
                  zhetrf_rook(UPLO, N, AFAC, LDA, IWORK, AINV, LWORK, INFO );
                  ...
                  if (INFO != K) alaerh( PATH, 'ZHETRF_ROOK', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 2
                  ...
                  if ( INB == 1 && !TRFCON ) {
                    ...
                    srnamc.SRNAMT = 'ZHETRI_ROOK';
                     ...
                     if (INFO != 0) alaerh( PATH, 'ZHETRI_ROOK', INFO, -1, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 5 ( Using TRS_ROOK)
                  // Solve and compute residual for  A * X = B.
                    ...
                    srnamc.SRNAMT = 'ZHETRS_ROOK';
                     zhetrs_rook(UPLO, N, NRHS, AFAC, LDA, IWORK, X, LDA, INFO );

                     // Check error code from ZHETRS_ROOK and handle error.

                     if (INFO != 0) alaerh( PATH, 'ZHETRS_ROOK', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );

                     zlacpy('Full', N, NRHS, B, LDA, WORK, LDA );

                     // Compute the residual for the solution

                     zpot02(UPLO, N, NRHS, A, LDA, X, LDA, WORK, LDA, RWORK, RESULT( 5 ) );
...
// +    TEST 7
                 ...
                 srnamc.SRNAMT = 'ZHECON_ROOK';
                  zhecon_rook(UPLO, N, AFAC, LDA, IWORK, ANORM, RCOND, WORK, INFO );

                  // Check error code from ZHECON_ROOK and handle error.

                  if (INFO != 0) alaerh( PATH, 'ZHECON_ROOK', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
