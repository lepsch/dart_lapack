...
void derrtr(final String PATH, final Nout NUNIT) {
// -- LAPACK test routine --
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  if (lsamen(2, C2, 'TR')) {
    ...
    infoc.INFOT = 1;
    dtrrfs('/', 'N', 'N', 0, 0, A, 1, B.asMatrix(), 1, X.asMatrix(), 1, R1, R2,
        W, IW, INFO);
    chkxer('DTRRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 2;
    dtrrfs('U', '/', 'N', 0, 0, A, 1, B.asMatrix(), 1, X.asMatrix(), 1, R1, R2,
        W, IW, INFO);
    chkxer('DTRRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 3;
    dtrrfs('U', 'N', '/', 0, 0, A, 1, B.asMatrix(), 1, X.asMatrix(), 1, R1, R2,
    ...
    chkxer('DTRRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 4;
    dtrrfs('U', 'N', 'N', -1, 0, A, 1, B.asMatrix(), 1, X.asMatrix(), 1, R1, R2,
        W, IW, INFO);
    chkxer('DTRRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 5;
    dtrrfs('U', 'N', 'N', 0, -1, A, 1, B.asMatrix(), 1, X.asMatrix(), 1, R1, R2,
        W, IW, INFO);
    chkxer('DTRRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 7;
    dtrrfs('U', 'N', 'N', 2, 1, A, 1, B.asMatrix(), 2, X.asMatrix(), 2, R1, R2,
        W, IW, INFO);
    chkxer('DTRRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 9;
    dtrrfs('U', 'N', 'N', 2, 1, A, 2, B.asMatrix(), 1, X.asMatrix(), 2, R1, R2,
        W, IW, INFO);
    chkxer('DTRRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 11;
    dtrrfs('U', 'N', 'N', 2, 1, A, 2, B.asMatrix(), 2, X.asMatrix(), 1, R1, R2,
        W, IW, INFO);
    chkxer('DTRRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    ...
    infoc.INFOT = 1;
    dlatrs3('/', 'N', 'N', 'N', 0, 0, A, 1, X.asMatrix(), 1, SCALES, W, W(2), 1,
        INFO);
    chkxer('DLATRS3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 2;
    dlatrs3('U', '/', 'N', 'N', 0, 0, A, 1, X.asMatrix(), 1, SCALES, W, W(2), 1,
        INFO);
    chkxer('DLATRS3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 3;
    dlatrs3('U', 'N', '/', 'N', 0, 0, A, 1, X.asMatrix(), 1, SCALES, W, W(2), 1,
    ...
    chkxer('DLATRS3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 8;
    dlatrs3('U', 'N', 'N', 'N', 2, 0, A, 1, X.asMatrix(), 1, SCALES, W, W(2), 1,
        INFO);
    chkxer('DLATRS3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 10;
    dlatrs3('U', 'N', 'N', 'N', 2, 0, A, 2, X.asMatrix(), 1, SCALES, W, W(2), 1,
        INFO);
    chkxer('DLATRS3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 14;
    dlatrs3('U', 'N', 'N', 'N', 1, 0, A, 1, X.asMatrix(), 1, SCALES, W, W(2), 0,
        INFO);
    chkxer('DLATRS3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    ...
    chkxer('DTPRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 4;
    dtprfs('U', 'N', 'N', -1, 0, A.asArray(), B.asMatrix(), 1, X.asMatrix(), 1,
        R1, R2, W, IW, INFO);
    chkxer('DTPRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 5;
    dtprfs('U', 'N', 'N', 0, -1, A.asArray(), B.asMatrix(), 1, X.asMatrix(), 1,
        R1, R2, W, IW, INFO);
    chkxer('DTPRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 8;
    ...
    chkxer('DTBRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 4;
    dtbrfs('U', 'N', 'N', -1, 0, 0, A, 1, B.asMatrix(), 1, X.asMatrix(), 1, R1,
        R2, W, IW, INFO);
    chkxer('DTBRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 5;
    dtbrfs('U', 'N', 'N', 0, -1, 0, A, 1, B.asMatrix(), 1, X.asMatrix(), 1, R1,
        R2, W, IW, INFO);
    chkxer('DTBRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 6;
    dtbrfs('U', 'N', 'N', 0, 0, -1, A, 1, B.asMatrix(), 1, X.asMatrix(), 1, R1,
        R2, W, IW, INFO);
    chkxer('DTBRFS', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 8;
