      void zget07(final int TRANS, final int N, final int NRHS, final Matrix<double> A_, final int LDA, final Matrix<double> B_, final int LDB, final Matrix<double> X_, final int LDX, final Matrix<double> XACT_, final int LDXACT, final int FERR, final int CHKFERR, final int BERR, final int RESLTS,) {
  final A = A_.dim();
  final B = B_.dim();
  final X = X_.dim();
