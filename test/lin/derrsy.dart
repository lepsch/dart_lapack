import 'common.dart';
      void derrsy(PATH, final int NUNIT) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      if ( lsamen( 2, C2, 'SY' ) ) {
         ...
         chkxer('DSYTRF_AA', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK );
         infoc.INFOT = 2;
         ...
         chkxer('DSYTRS_AA', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK );
         infoc.INFOT = 2;
         ...
         chkxer('DSYTRF_AA_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK );
         infoc.INFOT = 2;
         ...
         chkxer('DSYTRS_AA_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK );
         infoc.INFOT = 2;
         ...
         chkxer('DSYTRS_AA_STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK );
