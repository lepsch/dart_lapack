    ...
    for (final IMAT in 1.through(NIMAT)) {
      ...
      test('DCHKSP (IN=$IN IMAT=$IMAT)', () {
        ...
        for (var IUPLO = 1; IUPLO <= 2; IUPLO++) {
          ...
          dspt01(
              UPLO, N, A, AFAC, IWORK, AINV.asMatrix(), LDA, RWORK, RESULT(1));
          ...
          if (!TRFCON) {
            ...
            test.expect(INFO.value, 0);
            if (INFO.value != 0) {
              alaerh(PATH, 'DSPTRI', INFO.value, 0, UPLO, N, N, -1, -1, -1,
                  IMAT, NFAIL, NERRS, NOUT);
            }

            dppt03(UPLO, N, A, AINV, WORK.asMatrix(), LDA, RWORK, RCONDC,
                RESULT(2));
            NT = 2;
          } else {
            NT = 1;
