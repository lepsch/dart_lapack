...
import 'package:lapack/src/zsysv_aa_2stage.dart';
      ...
      for (var IUPLO = 1; IUPLO <= 2; IUPLO++) {
        ...
        for (var IFACT = 1; IFACT <= NFACT; IFACT++) {
          ...
          if (IFACT == 2) {
            ...
            if (INFO.value != K) {
              alaerh(PATH, 'ZSYSV_AA_2STAGE', INFO.value, K, UPLO, N, N, -1, -1,
              ...
              for (var K = 1; K <= NT; K++) {
                if (RESULT[K] >= THRESH) {
                  ...
                  NOUT.println(
                      ' ZSYSV_AA_2STAGE, UPLO=\'${UPLO.a1}\', N =${N.i5}, type ${IMAT.i2}, test ${K.i2}, ratio =${RESULT[K].g12_5}');
                  NFAIL++;
                }
              }
              NRUN += NT;
