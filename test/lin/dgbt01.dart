      void dgbt01(final int M, final int N, final int KL, final int KU, final Matrix<double> A_, final int LDA, final Matrix<double> AFAC_, final int LDAFAC, final Array<int> IPIV_, final Array<double> _WORK_, final int RESID,) {
  final A = A_.having();
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      for (J = 1; J <= N; J++) { // 40
         ...
         if ( LENJ > 0 ) {
            ...
            JUA = min( JU, KU );
            if (JUA+JL+1 > 0) daxpy( JUA+JL+1, -ONE, A( KU+1-JUA, J ), 1, WORK( JU+1-JUA ), 1 );
