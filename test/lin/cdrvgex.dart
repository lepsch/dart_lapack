      void cdrvge(DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX, A, AFAC, ASAV, B, BSAV, X, XACT, S, final Array<double> _WORK, final Array<double> RWORK, final Array<int> IWORK, final int NOUT) {
                    ...
                    srnamc.SRNAMT = 'CLARHS';
                     ...
                     if ( NOFACT && ITRAN == 1 ) {
                       ...
                       srnamc.SRNAMT = 'CGESV ';
                        ...
                        if (INFO != IZERO) alaerh( PATH, 'CGESV ', INFO, IZERO, ' ', N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
                     ...
                     if ( !PREFAC) claset( 'Full', N, N, CMPLX( ZERO ), CMPLX( ZERO ), AFAC, LDA );
