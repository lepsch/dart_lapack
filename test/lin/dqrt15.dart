      void dqrt15(SCALE, RKSEL, M, N, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, S, RANK, NORMA, NORMB, final Array<int> ISEED, final Array<double> WORK, final int LWORK) {
