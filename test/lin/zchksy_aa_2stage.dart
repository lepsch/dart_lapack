...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  final PATH = '${'Zomplex precision'[0]}S2';
    ...
    for (var IMAT = 1; IMAT <= NIMAT; IMAT++) {
      ...
      for (var IUPLO = 1; IUPLO <= 2; IUPLO++) {
        ...
        for (var INB = 1; INB <= NNB; INB++) {
          ...
          if (INFO.value != K) {
            alaerh(PATH, 'ZSYTRF_AA_2STAGE', INFO.value, K, UPLO, N, N, -1, -1,
          ...
          for (var IRHS = 1; IRHS <= NNS; IRHS++) {
            ...
            // final LWORK = max(1, 3 * N - 2);
            zsytrs_aa_2stage(UPLO, N, NRHS, AFAC.asMatrix(), LDA, AINV,
                (3 * NB + 1) * N, IWORK, IWORK(1 + N), X.asMatrix(), LDA, INFO);

            // Check error code from ZSYTRS and handle error.

            if (INFO.value != 0) {
              if (IZERO == 0) {
                alaerh(PATH, 'ZSYTRS_AA_2STAGE', INFO.value, 0, UPLO, N, N, -1,
