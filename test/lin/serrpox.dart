      void serrpo(final int PATH, final int NUNIT) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      if ( lsamen( 2, C2, 'PO' ) ) {
        ...
        srnamc.SRNAMT = 'SPORFS';
         ...
         N_ERR_BNDS = 3;
         NPARAMS = 0;
        srnamc.SRNAMT = 'SPORFSX';
         INFOT = 1;
         sporfsx('/', EQ, 0, 0, A, 1, AF, 1, S, B, 1, X, 1, RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS, PARAMS, W, IW, INFO );
         chkxer('SPORFSX', INFOT, NOUT, LERR, OK );
         INFOT = 2;
         sporfsx('U', "/", -1, 0, A, 1, AF, 1, S, B, 1, X, 1, RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS, PARAMS, W, IW, INFO );
         chkxer('SPORFSX', INFOT, NOUT, LERR, OK );
         EQ = 'N';
         INFOT = 3;
         sporfsx('U', EQ, -1, 0, A, 1, AF, 1, S, B, 1, X, 1, RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS, PARAMS, W, IW, INFO );
         chkxer('SPORFSX', INFOT, NOUT, LERR, OK );
         INFOT = 4;
         sporfsx('U', EQ, 0, -1, A, 1, AF, 1, S, B, 1, X, 1, RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS, PARAMS, W, IW, INFO );
         chkxer('SPORFSX', INFOT, NOUT, LERR, OK );
         INFOT = 6;
         sporfsx('U', EQ, 2, 1, A, 1, AF, 2, S, B, 2, X, 2, RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS, PARAMS, W, IW, INFO );
         chkxer('SPORFSX', INFOT, NOUT, LERR, OK );
         INFOT = 8;
         sporfsx('U', EQ, 2, 1, A, 2, AF, 1, S, B, 2, X, 2, RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS, PARAMS, W, IW, INFO );
         chkxer('SPORFSX', INFOT, NOUT, LERR, OK );
         INFOT = 11;
         sporfsx('U', EQ, 2, 1, A, 2, AF, 2, S, B, 1, X, 2, RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS, PARAMS, W, IW, INFO );
         chkxer('SPORFSX', INFOT, NOUT, LERR, OK );
         INFOT = 13;
         sporfsx('U', EQ, 2, 1, A, 2, AF, 2, S, B, 2, X, 1, RCOND, BERR, N_ERR_BNDS, ERR_BNDS_N, ERR_BNDS_C, NPARAMS, PARAMS, W, IW, INFO );
         chkxer('SPORFSX', INFOT, NOUT, LERR, OK );
        ...
        srnamc.SRNAMT = 'SPOEQUB';
         INFOT = 1;
         spoequb(-1, A, 1, R1, RCOND, ANRM, INFO );
         chkxer('SPOEQUB', INFOT, NOUT, LERR, OK );
         INFOT = 3;
         spoequb(2, A, 1, R1, RCOND, ANRM, INFO );
         chkxer('SPOEQUB', INFOT, NOUT, LERR, OK );
