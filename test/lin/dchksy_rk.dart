import 'common.dart';
      ...
      void dchksy_rk(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int E, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
         ...
         for (IMAT = 1; IMAT <= NIMAT; IMAT++) { // 260
            ...
            for (IUPLO = 1; IUPLO <= 2; IUPLO++) { // 250
               ...
               for (INB = 1; INB <= NNB; INB++) { // 240
                  ...
                  if (INFO != K) alaerh( PATH, 'DSYTRF_RK', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 2
                  ...
                  if ( INB == 1 && !TRFCON ) {
                     ...
                     if (INFO != 0) alaerh( PATH, 'DSYTRI_3', INFO, -1, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 5 ( Using TRS_3)
                  // Solve and compute residual for  A * X = B.
                     ...
                     if (INFO != 0) alaerh( PATH, 'DSYTRS_3', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 7
                  ...
                  if (INFO != 0) alaerh( PATH, 'DSYCON_3', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
