      void zdrvpo(final int DOTYPE, final int NN, final int NVAL, final int NRHS, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int ASAV, final int B, final int BSAV, final int X, final int XACT, final int S, final Array<double> _WORK_, final Array<double> RWORK_, final int NOUT,) {
               ...
               for (IEQUED = 1; IEQUED <= 2; IEQUED++) { // 100
                  ...
                  for (IFACT = 1; IFACT <= NFACT; IFACT++) { // 90
                    ...
                    srnamc.SRNAMT = 'ZPOSVXX';
                     N_ERR_BNDS = 3;
                     zposvxx(FACT, UPLO, N, NRHS, A, LDA, AFAC, LDA, EQUED, S, B, LDA, X, LDA, RCOND, RPVGRW_SVXX, BERR, N_ERR_BNDS, ERRBNDS_N, ERRBNDS_C, 0, ZERO, WORK, RWORK( 2*NRHS+1 ), INFO );
