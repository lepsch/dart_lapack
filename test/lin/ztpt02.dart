      void ztpt02(UPLO, TRANS, DIAG, N, NRHS, AP, final Matrix<double> X, final int LDX, final Matrix<double> B, final int LDB, final Array<double> _WORK, final Array<double> RWORK, RESID ) {
