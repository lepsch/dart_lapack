      void dlattp(final int IMAT, final int UPLO, final int TRANS, final int DIAG, final Array<int> ISEED, final int N, final int A, final int B, final Array<double> _WORK, final Box<int> INFO ) {
