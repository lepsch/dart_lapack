      double zqrt14(final int TRANS, final int M, final int N, final int NRHS, final Matrix<double> A_, final int LDA, final Matrix<double> X_, final int LDX, final Array<double> WORK_, final int LWORK,) {
  final A = A_.dim();
  final X = X_.dim();
