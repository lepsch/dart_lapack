...
// =====================================================================
 ...
 9962 FORMAT('${' ' * 3}${.i2}: norm( L * U - A )  / ( N * norm(A) * EPS )' );
 9961 FORMAT('${' ' * 3}${.i2}: norm( I - A*AINV ) / ( N * norm(A) * norm(AINV) * EPS )' );
 9960 FORMAT('${' ' * 3}${.i2}: norm( B - A * X )  / ( norm(A) * norm(X) * EPS )' );
 6660 FORMAT('${' ' * 3}${.i2}: diagonal is not non-negative');
 9959 FORMAT('${' ' * 3}${.i2}: norm( X - XACT )   / ( norm(XACT) * CNDNUM * EPS )' );
 9958 FORMAT('${' ' * 3}${.i2}: norm( X - XACT )   / ( norm(XACT) * CNDNUM * EPS ), refined' );
