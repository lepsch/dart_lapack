...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      String             PATH;
      int                I, I1, I2, IFACT, IMAT, IN, INFO, IOFF, IUPLO, IZERO, J, K, K1, KL, KU, LDA, LWORK, MODE, N, NIMAT, NT, N_ERR_BNDS;
               ...
               for (IFACT = 1; IFACT <= NFACT; IFACT++) { // 150
                 ...
                 srnamc.SRNAMT = 'ZHESVXX';
                  ...
                  for (K = K1; K <= 6; K++) { // 85
                     if ( RESULT[K] >= THRESH ) {
                        if (NFAIL == 0 && NERRS.value == 0) aladhd( NOUT, PATH );
                        NOUT.println( 9998 )'ZHESVXX', FACT, UPLO, N, IMAT, K, RESULT[K];
                        NFAIL++;
                     }
                  } // 85
                  NRUN +=  7 - K1;
