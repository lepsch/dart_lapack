               ...
               for (IFACT = 1; IFACT <= NFACT; IFACT++) { // 150
                    ...
                    srnamc.SRNAMT = 'ZSPSV ';
                     ...
                     for (K = 1; K <= NT; K++) { // 110
                        if ( RESULT[K] >= THRESH ) {
                           ...
                           NOUT.println( 9999 )'ZSPSV ', UPLO, N, IMAT, K, RESULT[K];
                           NFAIL++;
                        }
                     } // 110
                     NRUN +=  NT;
                 ...
                 srnamc.SRNAMT = 'ZSPSVX';
                  ...
                  for (K = K1; K <= 6; K++) { // 140
                     if ( RESULT[K] >= THRESH ) {
                        if (NFAIL == 0 && NERRS.value == 0) aladhd( NOUT, PATH );
                        NOUT.println( 9998 )'ZSPSVX', FACT, UPLO, N, IMAT, K, RESULT[K];
                        NFAIL++;
                     }
                  } // 140
                  NRUN +=  7 - K1;
