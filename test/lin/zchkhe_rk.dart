    ...
    for (var IMAT = 1; IMAT <= NIMAT; IMAT++) {
      ...
      for (var IUPLO = 1; IUPLO <= 2; IUPLO++) {
        ...
        for (var INB = 1; INB <= NNB; INB++) {
          ...
          if (INFO.value != K) {
            alaerh(PATH, 'ZHETRF_RK', INFO.value, K, UPLO, N, N, -1, -1, NB,
          ...
          zhet01_3(UPLO, N, A.asMatrix(), LDA, AFAC.asMatrix(), LDA, E, IWORK,
          ...
          if (INB == 1 && !TRFCON) {
            ...
            if (INFO.value != 0) {
              alaerh(PATH, 'ZHETRI_3', INFO.value, -1, UPLO, N, N, -1, -1, -1,
                  IMAT, NFAIL, NERRS, NOUT);
            }
          ...
          if (INB <= 1) {
            ...
            if (TRFCON) {
              ...
              for (var IRHS = 1; IRHS <= NNS; IRHS++) {
                ...
                zhetrs_3(UPLO, N, NRHS, AFAC.asMatrix(), LDA, E, IWORK,
                    X.asMatrix(), LDA, INFO);

                // Check error code from ZHETRS_3 and handle error.

                if (INFO.value != 0) {
                  alaerh(PATH, 'ZHETRS_3', INFO.value, 0, UPLO, N, N, -1, -1,
            ...
            zhecon_3(UPLO, N, AFAC.asMatrix(), LDA, E, IWORK, ANORM, RCOND,
                WORK, INFO);

            // Check error code from ZHECON_3 and handle error.

            if (INFO.value != 0) {
              alaerh(PATH, 'ZHECON_3', INFO.value, 0, UPLO, N, N, -1, -1, -1,
                  IMAT, NFAIL, NERRS, NOUT);
            }
            ...
            if (RESULT[7] >= THRESH) {
              if (NFAIL == 0 && NERRS.value == 0) alahd(NOUT, PATH);
              NOUT.println(
                  ' UPLO = \'${UPLO.a1}\', N =${N.i5},${' ' * 10} type ${IMAT.i2}, test ${7.i2}, ratio =${RESULT[7].g12_5}');
              NFAIL++;
            }
            NRUN++;
          }
