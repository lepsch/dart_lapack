      void zchkhe_rk(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int E, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
            ...
            for (IUPLO = 1; IUPLO <= 2; IUPLO++) { // 250
               ...
               for (INB = 1; INB <= NNB; INB++) { // 240
                 ...
                 srnamc.SRNAMT = 'ZHETRF_RK';
                  ...
                  if (INFO != K) alaerh( PATH, 'ZHETRF_RK', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 1
                  ...
                  zhet01_3(UPLO, N, A, LDA, AFAC, LDA, E, IWORK, AINV, LDA, RWORK, RESULT( 1 ) );
                  NT = 1;
...
// +    TEST 2
                  ...
                  if ( INB == 1 && !TRFCON ) {
                    ...
                    srnamc.SRNAMT = 'ZHETRI_3';
                     ...
                     LWORK = (N+NB+1)*(NB+3);
                     zhetri_3(UPLO, N, AINV, LDA, E, IWORK, WORK, LWORK, INFO );

                     // Check error code from ZHETRI_3 and handle error.

                     if (INFO != 0) alaerh( PATH, 'ZHETRI_3', INFO, -1, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 5 ( Using TRS_3)
                  // Solve and compute residual for  A * X = B.
                    ...
                    srnamc.SRNAMT = 'ZHETRS_3';
                     ...
                     if (INFO != 0) alaerh( PATH, 'ZHETRS_3', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 7
                 ...
                 srnamc.SRNAMT = 'ZHECON_3';
                  ...
                  if (INFO != 0) alaerh( PATH, 'ZHECON_3', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
