import 'common.dart';
      ...
      void ddrvsy_rook(final int DOTYPE, final int NN, final int NVAL, final int NRHS, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      // EXTERNAL ALADHD, ALAERH, ALASVM, DERRVX, DGET04, DLACPY, DLARHS, DLASET, DLATB4, DLATMS, DPOT02, DPOT05, DSYSV_ROOK, DSYT01_ROOK, DSYTRF_ROOK, DSYTRI_ROOK, XLAENV
      // ..
      // .. Scalars in Common ..
            ...
            for (IUPLO = 1; IUPLO <= 2; IUPLO++) { // 160
               ...
               for (IFACT = 1; IFACT <= NFACT; IFACT++) { // 150
                  ...
                  if ( ZEROT ) {
                     ...
                     dsytrf_rook(UPLO, N, AFAC, LDA, IWORK, WORK, LWORK, INFO );
                  ...
                  if ( IFACT == 2 ) {
                     ...
                     dsysv_rook(UPLO, N, NRHS, AFAC, LDA, IWORK, X, LDA, WORK, LWORK, INFO );
                  ...
                  // Check solution from generated exact solution.
                     ...
                     for (K = 1; K <= NT; K++) { // 110
                        if ( RESULT( K ) >= THRESH ) {
                           ...
                           WRITE( NOUT, FMT = 9999 )'DSYSV_ROOK', UPLO, N, IMAT, K, RESULT( K );
                           NFAIL = NFAIL + 1;
                        }
                     } // 110
                     NRUN = NRUN + NT;
