      void zlqt01(final int M, final int N, final Array<double> A_, final Array<double> AF_, final Array<double> Q_, final Array<double> L_, final int LDA, final Array<double> TAU_, final Array<double> WORK_, final int LWORK, final Array<double> RWORK_, final int RESULT,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
     ...
     srnamc.SRNAMT = 'ZUNGLQ';
      ...
      zgemm('No transpose', 'Conjugate transpose', M, N, N, DCMPLX( -ONE ), A, LDA, Q, LDA, Complex.one, L, LDA );
