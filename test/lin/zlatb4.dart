      void zlatb4(final int PATH, final int IMAT, final int M, final int N, final int TYPE, final int KL, final int KU, final int ANORM, final int MODE, final int CNDNUM, final int DIST,) {
