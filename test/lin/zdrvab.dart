      void zdrvab(DOTYPE, NM, MVAL, NNS, NSVAL, THRESH, NMAX, A, AFAC, B, X, final Array<double> _WORK, final Array<double> RWORK, SWORK, final Array<int> IWORK, final int NOUT) {
