      void zchkps(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NRANK, final int RANKVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int PERM, final int PIV, final Array<double> _WORK, final Array<double> RWORK, final int NOUT) {
