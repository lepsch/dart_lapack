      void sdrvrf1(final int NOUT, final int NN, final int NVAL, final int THRESH, final Matrix<double> A_, final int LDA, final int ARF, final Array<double> WORK_,) {
  final A = A_.dim();
...
// =====================================================================
 ...
 9999 FORMAT('  *** Error(s) or Failure(s) while testing SLANSF ***');
