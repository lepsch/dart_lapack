...
extension on Nout {
  void print9996(String s, String fact, String tras, int n, int kl, int ku,
      int type, int test, double error) {
    println(
        ' $s( \'${fact.a1}\',\'${tras.a1}\',${n.i5},${kl.i5},${ku.i5},...), type ${type.i1}, test(${test.i1})=${error.g12_5}');
  }

  void print9995(String s, String fact, String tras, int n, int kl, int ku,
      String equed, int type, int test, double error) {
    println(
        ' $s( \'${fact.a1}\',\'${tras.a1}\',${n.i5},${kl.i5},${ku.i5},...), EQUED=\'${equed.a1}\', type ${type.i1}, test(${test.i1})=${error.g12_5}');
  }
}
