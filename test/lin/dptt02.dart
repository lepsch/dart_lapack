      void dptt02(final int N, final int NRHS, final int D, final int E, final Matrix<double> X, final int LDX, final Matrix<double> B, final int LDB, final int RESID) {
