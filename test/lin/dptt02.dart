      void dptt02(final int N, final int NRHS, final int D, final int E, final Matrix<double> X_, final int LDX, final Matrix<double> B_, final int LDB, final int RESID,) {
  final X = X_.having();
  final B = B_.having();
