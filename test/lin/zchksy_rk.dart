    ...
    for (var IMAT = 1; IMAT <= NIMAT; IMAT++) {
      ...
      for (var IUPLO = 1; IUPLO <= 2; IUPLO++) {
        ...
        for (var INB = 1; INB <= NNB; INB++) {
          ...
          zsytrf_rk(UPLO, N, AFAC.asMatrix(), LDA, E, IWORK, AINV, LWORK, INFO);
          ...
          if (INFO.value != K) {
            alaerh(PATH, 'ZSYTRF_RK', INFO.value, K, UPLO, N, N, -1, -1, NB,
          ...
          zsyt01_3(UPLO, N, A.asMatrix(), LDA, AFAC.asMatrix(), LDA, E, IWORK,
          ...
          if (INB == 1 && !TRFCON) {
            ...
            if (INFO.value != 0) {
              alaerh(PATH, 'ZSYTRI_3', INFO.value, -1, UPLO, N, N, -1, -1, -1,
                  IMAT, NFAIL, NERRS, NOUT);
            }
          ...
          if (TRFCON) {
            ...
            for (var IRHS = 1; IRHS <= NNS; IRHS++) {
              ...
              zsytrs_3(UPLO, N, NRHS, AFAC.asMatrix(), LDA, E, IWORK,
                  X.asMatrix(), LDA, INFO);

              // Check error code from ZSYTRS_3 and handle error.

              if (INFO.value != 0) {
                alaerh(PATH, 'ZSYTRS_3', INFO.value, 0, UPLO, N, N, -1, -1,
          ...
          zsycon_3(UPLO, N, AFAC.asMatrix(), LDA, E, IWORK, ANORM, RCOND, WORK,
              INFO);

          // Check error code from ZSYCON_3 and handle error.

          if (INFO.value != 0) {
            alaerh(PATH, 'ZSYCON_3', INFO.value, 0, UPLO, N, N, -1, -1, -1,
                IMAT, NFAIL, NERRS, NOUT);
          }
