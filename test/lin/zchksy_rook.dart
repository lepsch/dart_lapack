      void zchksy_rook(final int DOTYPE, final int NN, final int NVAL, final int NNB, final int NBVAL, final int NNS, final int NSVAL, final int THRESH, final int TSTERR, final int NMAX, final int A, final int AFAC, final int AINV, final int B, final int X, final int XACT, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final int NOUT,) {
            ...
            for (IUPLO = 1; IUPLO <= 2; IUPLO++) { // 250
               ...
               for (INB = 1; INB <= NNB; INB++) { // 240
                 ...
                 srnamc.SRNAMT = 'ZSYTRF_ROOK';
                  ...
                  if (INFO != K) alaerh( PATH, 'ZSYTRF_ROOK', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 1
                  ...
                  zsyt01_rook(UPLO, N, A, LDA, AFAC, LDA, IWORK, AINV, LDA, RWORK, RESULT( 1 ) );
                  NT = 1;
...
// +    TEST 2
                  ...
                  if ( INB == 1 && !TRFCON ) {
                    ...
                    srnamc.SRNAMT = 'ZSYTRI_ROOK';
                     ...
                     if (INFO != 0) alaerh( PATH, 'ZSYTRI_ROOK', INFO, -1, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 5 ( Using TRS_ROOK)
                  // Solve and compute residual for  A * X = B.
                    ...
                    srnamc.SRNAMT = 'ZSYTRS_ROOK';
                     ...
                     if (INFO != 0) alaerh( PATH, 'ZSYTRS_ROOK', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 7
                 ...
                 srnamc.SRNAMT = 'ZSYCON_ROOK';
                  ...
                  if (INFO != 0) alaerh( PATH, 'ZSYCON_ROOK', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
