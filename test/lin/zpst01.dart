      void zpst01(final int UPLO, final int N, final Matrix<double> A_, final int LDA, final Matrix<double> AFAC_, final int LDAFAC, final Matrix<double> PERM_, final int LDPERM, final int PIV, final Array<double> RWORK_, final int RESID, final int RANK,) {
  final A = A_.having();
