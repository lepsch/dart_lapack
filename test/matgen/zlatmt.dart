      void zlatmt(final int M, final int N, final int DIST, final Array<int> ISEED_, final int SYM, final int D, final int MODE, final int COND, final int DMAX, final int RANK, final int KL, final int KU, final int PACK, final Matrix<double> A_, final int LDA, final Array<double> _WORK_, final Box<int> INFO,) {
