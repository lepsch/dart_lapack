      void zlatmt(M, N, DIST, final Array<int> ISEED, SYM, D, MODE, COND, DMAX, RANK, KL, KU, PACK, final Matrix<double> A, final int LDA, final Array<double> _WORK, final Box<int> INFO ) {
