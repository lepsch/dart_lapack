      void slarot(final int LROWS, final int LLEFT, final int LRIGHT, final int NL, final int C, final int S, final Matrix<double> A_, final int LDA, final int XLEFT, final int XRIGHT,) {
  final A = A_.dim();
