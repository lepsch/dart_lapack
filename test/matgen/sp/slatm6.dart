      void slatm6(TYPE, N, final Matrix<double> A, final int LDA, B, final Matrix<double> X, final int LDX, final Matrix<double> Y, final int LDY, ALPHA, BETA, WX, WY, S, final int DIF) {
