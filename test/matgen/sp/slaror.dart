...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void slaror(final int SIDE, final int INIT, final int M, final int N, final Matrix<double> A_, final int LDA, final Array<int> ISEED_, final int X, final Box<int> INFO,) {
  final A = A_.dim();
