      void slaror(final int SIDE, final int INIT, final int M, final int N, final Matrix<double> A, final int LDA, final Array<int> ISEED, final int X, final Box<int> INFO ) {
