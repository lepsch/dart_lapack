      void clatme(N, DIST, final Array<int> ISEED, D, MODE, COND, DMAX, RSIGN, UPPER, SIM, DS, MODES, CONDS, KL, KU, ANORM, final Matrix<double> A, final int LDA, WORK, final Box<int> INFO ) {
