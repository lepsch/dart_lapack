      void clatmr(M, N, DIST, final Array<int> ISEED, SYM, D, MODE, COND, DMAX, RSIGN, GRADE, DL, MODEL, CONDL, DR, MODER, CONDR, PIVTNG, IPIVOT, KL, KU, SPARSE, ANORM, PACK, final Matrix<double> A, final int LDA, IWORK, final Box<int> INFO ) {
