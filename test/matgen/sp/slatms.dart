      void slatms(M, N, DIST, final Array<int> ISEED, SYM, D, MODE, COND, DMAX, KL, KU, PACK, final Matrix<double> A, final int LDA, final Array<double> _WORK, final Box<int> INFO ) {
