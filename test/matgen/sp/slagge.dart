      void slagge(final int M, final int N, final int KL, final int KU, final int D, final Matrix<double> A, final int LDA, final Array<int> ISEED, final Array<double> _WORK, final Box<int> INFO,) {
