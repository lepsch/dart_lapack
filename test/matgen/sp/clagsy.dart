      void clagsy(final int N, final int K, final int D, final Matrix<double> A_, final int LDA, final Array<int> ISEED_, final Array<double> _WORK_, final Box<int> INFO,) {
  final A = A_.dim();
