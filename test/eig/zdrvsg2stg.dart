...
import 'package:dart_lapack/src/zhbgv.dart';
import 'package:dart_lapack/src/zhbgvd.dart';
import 'package:dart_lapack/src/zhbgvx.dart';
import 'package:dart_lapack/src/zhegv.dart';
import 'package:dart_lapack/src/zhegv_2stage.dart';
import 'package:dart_lapack/src/zhegvd.dart';
import 'package:dart_lapack/src/zhegvx.dart';
import 'package:dart_lapack/src/zhpgv.dart';
import 'package:dart_lapack/src/zhpgvd.dart';
import 'package:dart_lapack/src/zhpgvx.dart';
      ...
      for (IBTYPE = 1; IBTYPE <= 3; IBTYPE++) {
        ...
        for (IBUPLO = 1; IBUPLO <= 2; IBUPLO++) {
          ...
          while (true) {
            ...
            zhegv_2stage(IBTYPE, 'N', UPLO, N, Z, LDZ, BB, LDB, D2, WORK, NWORK,
                RWORK, IINFO);
            if (IINFO.value != 0) {
              _print9999(NOUNIT, 'ZHEGV_2STAGE(V,$UPLO)', IINFO.value, N, JTYPE,
                  IOLDSD);
              INFO.value = (IINFO.value).abs();
              if (IINFO.value < 0) {
                return;
          ...
          while (true) {
            ...
            zhpgvx(IBTYPE, 'V', 'A', UPLO, N, AP, BP, VL, VU, IL, IU, ABSTOL, M,
                D, Z, LDZ, WORK, RWORK, IWORK(N + 1), IWORK, INFO);
            if (IINFO.value != 0) {
              _print9999(
