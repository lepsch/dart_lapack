      void zhbt21(final int UPLO, final int N, final int KA, final int KS, final Matrix<double> A, final int LDA, final int D, final int E, final Matrix<double> U, final int LDU, final Array<double> _WORK, final Array<double> RWORK, final int RESULT,) {
