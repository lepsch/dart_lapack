      void zbdt05(final int M, final int N, final Matrix<double> A_, final int LDA, final int S, final int NS, final Matrix<double> U_, final int LDU, final Matrix<double> VT_, final int LDVT, final Array<double> _WORK_, final int RESID,) {
  final A = A_.dim();
  final U = U_.dim();
  final VT = VT_.dim();
