...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
 ...
 9992 FORMAT( ' Matrix order=${.i2}, type=${.i2}, a=', D10.3, ', order(A_11)=${.i2}, result ${.i2} is ' F8.2 );
 9991 FORMAT( ' Matrix order=${.i2}, type=${.i2}, a=', D10.3, ', order(A_11)=${.i2}, result ${.i2} is ' D10.3 );
