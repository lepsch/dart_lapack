...
import 'common.dart';
      ...
      void zdrgsx(NSIZE, NCMAX, THRESH, NIN, NOUT, final Matrix<double> A, final int LDA, B, AI, BI, Z, Q, ALPHA, BETA, final Matrix<double> C, final int LDC, S, WORK, LWORK, RWORK, IWORK, LIWORK, BWORK, Box<int> INFO ) {
