...
import 'common.dart';
      ...
      void zget24(COMP, JTYPE, THRESH, ISEED, NOUNIT, N, final Matrix<double> A, final int LDA, H, HT, W, WT, WTMP, final Matrix<double> VS, final int LDVS, VS1, RCDEIN, RCDVIN, NSLCT, ISLCT, ISRT, RESULT, WORK, LWORK, RWORK, BWORK, Box<int> INFO ) {
