      void zchkhb(NSIZES, NN, NWDTHS, KK, NTYPES, final Array<bool> DOTYPE, final Array<int> ISEED, THRESH, NOUNIT, final Matrix<double> A, final int LDA, SD, SE, final Matrix<double> U, final int LDU, final Array<double> WORK, final int LWORK, RWORK, RESULT, Box<int> INFO ) {
