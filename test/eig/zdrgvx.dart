      void zdrgvx(NSIZE, THRESH, NIN, NOUT, final Matrix<double> A, final int LDA, B, AI, BI, ALPHA, BETA, VL, VR, ILO, IHI, LSCALE, RSCALE, S, DTRU, DIF, DIFTRU, final Array<double> WORK, final int LWORK, RWORK, final Array<int> IWORK, final int LIWORK, RESULT, BWORK, final Box<int> INFO ) {
