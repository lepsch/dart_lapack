      void zglmts(final int N, final int M, final int P, final int A, final int AF, final int LDA, final int B, final int BF, final int LDB, final int D, final int DF, final int X, final int U, final Array<double> WORK_, final int LWORK, final Array<double> RWORK_, final int RESULT,) {
