      void zhpt21(final int ITYPE, final int UPLO, final int N, final int KBAND, final int AP, final int D, final int E, final Matrix<double> U_, final int LDU, final int VP, final int TAU, final Array<double> _WORK_, final Array<double> RWORK_, final int RESULT,) {
  final U = U_.dim();
