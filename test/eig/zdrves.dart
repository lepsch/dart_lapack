...
import 'common.dart';
      ...
      void zdrves(NSIZES, NN, NTYPES, final Array<bool> DOTYPE, final Array<int> ISEED, THRESH, NOUNIT, final Matrix<double> A, final int LDA, H, HT, W, WT, final Matrix<double> VS, final int LDVS, RESULT, WORK, NWORK, RWORK, IWORK, BWORK, final Box<int> INFO ) {
