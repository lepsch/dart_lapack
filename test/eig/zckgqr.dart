      void zckgqr(NM, MVAL, NP, PVAL, NN, NVAL, NMATS, final Array<int> ISEED, THRESH, NMAX, A, AF, AQ, AR, TAUA, B, BF, BZ, BT, BWK, TAUB, WORK, final Array<double> RWORK, NIN, NOUT, final Box<int> INFO ) {
