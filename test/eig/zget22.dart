      void zget22(TRANSA, TRANSE, TRANSW, N, final Matrix<double> A, final int LDA, final Matrix<double> E, final int LDE, W, final Array<double> _WORK, final Array<double> RWORK, final int RESULT) {
