      void zckcsd(NM, MVAL, PVAL, QVAL, NMATS, final Array<int> ISEED, THRESH, MMAX, X, XF, U1, U2, V1T, V2T, THETA, final Array<int> IWORK, final Array<double> _WORK, final Array<double> RWORK, NIN, NOUT, final Box<int> INFO ) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
 ...
 9998 FORMAT( ' M=${.i4} P=${.i4}, Q=${.i4}, type ${.i2}, test ${.i2}, ratio=${.g13_6};
      ...
      void zlacsg(M, P, Q, THETA, final Array<int> ISEED, final Matrix<double> X, final int LDX, final Array<double> WORK) {
      int                LDX, M, P, Q;
      int                ISEED( 4 );
      double             THETA( * );
      Complex         WORK( * ), X( LDX, * );
