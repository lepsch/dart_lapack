      ...
      test('DDRVST (SIZE = $N, TYPE = $JTYPE)', () {
        ...
        for (var IUPLO = 0; IUPLO <= 1; IUPLO++) {
          ...
          while (true) {
            ...
            if (IINFO.value != 0) {
              print9999(
                  NOUNIT, 'DSYEV(N,$UPLO)', IINFO.value, N, JTYPE, IOLDSD);
              INFO.value = (IINFO.value).abs();
              if (IINFO.value < 0) {
                return;
              } else {
          ...
          while (true) {
            ...
            NTEST += 2;
            srnamc.SRNAMT = 'DSYEVX';
            dsyevx('N', 'A', UPLO, N, A, LDU, VL, VU, IL, IU, ABSTOL, M2, WA2,
          ...
          while (true) {
            ...
            dlacpy(' ', N, N, V, LDU, A, LDA);
            srnamc.SRNAMT = 'DSYEVX';
            dsyevx('N', 'I', UPLO, N, A, LDU, VL, VU, IL, IU, ABSTOL, M3, WA3,
                Z, LDU, WORK, LWORK, IWORK, IWORK(5 * N + 1), IINFO);
            if (IINFO.value != 0) {
              print9999(
          ...
          while (true) {
            ...
            dlacpy(' ', N, N, V, LDU, A, LDA);
            srnamc.SRNAMT = 'DSYEVX';
            dsyevx('N', 'V', UPLO, N, A, LDU, VL, VU, IL, IU, ABSTOL, M3, WA3,
                Z, LDU, WORK, LWORK, IWORK, IWORK(5 * N + 1), IINFO);
            if (IINFO.value != 0) {
              print9999(
          ...
          while (true) {
            ...
            if (IINFO.value != 0) {
              print9999(
                  NOUNIT, 'DSBEV(N,$UPLO)', IINFO.value, N, JTYPE, IOLDSD);
              INFO.value = (IINFO.value).abs();
              if (IINFO.value < 0) {
                return;
              } else {
          ...
          while (true) {
            ...
            dsbevx('N', 'A', UPLO, N, KD, V, LDU, U, LDU, VL, VU, IL, IU,
                ABSTOL, M3, WA3, Z, LDU, WORK, IWORK, IWORK(5 * N + 1), IINFO);
            if (IINFO.value != 0) {
              print9999(
          ...
          while (true) {
            ...
            if (IINFO.value != 0) {
              print9999(
                  NOUNIT, 'DSYEVD(N,$UPLO)', IINFO.value, N, JTYPE, IOLDSD);
              INFO.value = (IINFO.value).abs();
              if (IINFO.value < 0) {
                return;
              } else {
          ...
          while (true) {
            ...
            if (IINFO.value != 0) {
              print9999(
                  NOUNIT, 'DSBEVD(N,$UPLO)', IINFO.value, N, JTYPE, IOLDSD);
              INFO.value = (IINFO.value).abs();
              if (IINFO.value < 0) {
                return;
              } else {
