...
void derrst(final String PATH, final Nout NUNIT) {
// -- LAPACK test routine --
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  if (lsamen(2, C2, 'ST')) {
    ...
    chkxer('DSYTRD_SB2ST', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 4;
    dsytrd_sb2st('Y', 'N', 'U', -1, 0, A, 1, D, E, C.asArray(), 1, W, 1, INFO);
    chkxer('DSYTRD_SB2ST', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 5;
    ...
    infoc.INFOT = 1;
    dstebz('/', 'E', 0, 0.0, 1.0, 1, 0, 0.0, D, E, M, NSPLIT, X, I1, I2, W, IW,
        INFO);
    chkxer('DSTEBZ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 2;
    dstebz('A', '/', 0, 0.0, 0.0, 0, 0, 0.0, D, E, M, NSPLIT, X, I1, I2, W, IW,
        INFO);
    chkxer('DSTEBZ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 3;
    dstebz('A', 'E', -1, 0.0, 0.0, 0, 0, 0.0, D, E, M, NSPLIT, X, I1, I2, W, IW,
        INFO);
    chkxer('DSTEBZ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 5;
    dstebz('V', 'E', 0, 0.0, 0.0, 0, 0, 0.0, D, E, M, NSPLIT, X, I1, I2, W, IW,
        INFO);
    chkxer('DSTEBZ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 6;
    dstebz('I', 'E', 0, 0.0, 0.0, 0, 0, 0.0, D, E, M, NSPLIT, X, I1, I2, W, IW,
        INFO);
    chkxer('DSTEBZ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 6;
    dstebz('I', 'E', 1, 0.0, 0.0, 2, 1, 0.0, D, E, M, NSPLIT, X, I1, I2, W, IW,
        INFO);
    chkxer('DSTEBZ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 7;
    dstebz('I', 'E', 1, 0.0, 0.0, 1, 0, 0.0, D, E, M, NSPLIT, X, I1, I2, W, IW,
        INFO);
    chkxer('DSTEBZ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 7;
    ...
    chkxer('DSYEVD_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 1;
    ...
    chkxer('DSYEVR_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 3;
    dsyevr_2stage('N', 'A', '/', -1, A, 1, 0.0, 0.0, 1, 1, 0.0, M, R, Z, 1, IW,
        Q.asArray(), 26 * N, IW(2 * N + 1), 10 * N, INFO);
    chkxer('DSYEVR_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 4;
    dsyevr_2stage('N', 'A', 'U', -1, A, 1, 0.0, 0.0, 1, 1, 0.0, M, R, Z, 1, IW,
        Q.asArray(), 26 * N, IW(2 * N + 1), 10 * N, INFO);
    chkxer('DSYEVR_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 6;
    ...
    infoc.INFOT = 1;
    dsyevx_2stage('/', 'A', 'U', 0, A, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W, 1,
        IW, I3, INFO);
    chkxer('DSYEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 1;
    dsyevx_2stage('V', 'A', 'U', 0, A, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W, 1,
        IW, I3, INFO);
    chkxer('DSYEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 2;
    dsyevx_2stage('N', '/', 'U', 0, A, 1, 0.0, 1.0, 1, 0, 0.0, M, X, Z, 1, W, 1,
        IW, I3, INFO);
    chkxer('DSYEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 3;
    dsyevx_2stage('N', 'A', '/', 0, A, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W, 1,
        IW, I3, INFO);
    infoc.INFOT = 4;
    ...
    chkxer('DSYEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 8;
    dsyevx_2stage('N', 'V', 'U', 1, A, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W, 8,
        IW, I3, INFO);
    chkxer('DSYEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 9;
    dsyevx_2stage('N', 'I', 'U', 1, A, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W, 8,
        IW, I3, INFO);
    chkxer('DSYEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 9;
    dsyevx_2stage('N', 'I', 'U', 1, A, 1, 0.0, 0.0, 2, 1, 0.0, M, X, Z, 1, W, 8,
        IW, I3, INFO);
    chkxer('DSYEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 10;
    ...
    chkxer('DSYEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 10;
    dsyevx_2stage('N', 'I', 'U', 1, A, 1, 0.0, 0.0, 1, 2, 0.0, M, X, Z, 1, W, 8,
        IW, I3, INFO);
    chkxer('DSYEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 15;
    ...
    chkxer('DSYTRD_SB2ST', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 4;
    dsytrd_sb2st('N', 'N', 'U', -1, 0, A, 1, D, E, C.asArray(), 1, W, 1, INFO);
    chkxer('DSYTRD_SB2ST', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 5;
    ...
    chkxer('DSBEVD_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 1;
    ...
    infoc.INFOT = 1;
    dsbevx('/', 'A', 'U', 0, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W,
        IW, I3, INFO);
    chkxer('DSBEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 2;
    dsbevx('N', '/', 'U', 0, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W,
        IW, I3, INFO);
    chkxer('DSBEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 3;
    dsbevx('N', 'A', '/', 0, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W,
        IW, I3, INFO);
    chkxer('DSBEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 4;
    dsbevx('N', 'A', 'U', -1, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W,
        IW, I3, INFO);
    chkxer('DSBEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 5;
    dsbevx('N', 'A', 'U', 0, -1, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W,
        IW, I3, INFO);
    chkxer('DSBEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 7;
    dsbevx('N', 'A', 'U', 2, 1, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W,
        IW, I3, INFO);
    chkxer('DSBEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 9;
    dsbevx('V', 'A', 'U', 2, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 2, W,
        IW, I3, INFO);
    chkxer('DSBEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 11;
    dsbevx('N', 'V', 'U', 1, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W,
        IW, I3, INFO);
    chkxer('DSBEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 12;
    dsbevx('N', 'I', 'U', 1, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z, 1, W,
        IW, I3, INFO);
    chkxer('DSBEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 12;
    dsbevx('N', 'I', 'U', 1, 0, A, 1, Q, 1, 0.0, 0.0, 2, 1, 0.0, M, X, Z, 1, W,
        IW, I3, INFO);
    chkxer('DSBEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 13;
    dsbevx('N', 'I', 'U', 2, 0, A, 1, Q, 1, 0.0, 0.0, 2, 1, 0.0, M, X, Z, 1, W,
        IW, I3, INFO);
    chkxer('DSBEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 13;
    dsbevx('N', 'I', 'U', 1, 0, A, 1, Q, 1, 0.0, 0.0, 1, 2, 0.0, M, X, Z, 1, W,
        IW, I3, INFO);
    chkxer('DSBEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 18;
    ...
    infoc.INFOT = 1;
    dsbevx_2stage('/', 'A', 'U', 0, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z,
        1, W, 0, IW, I3, INFO);
    chkxer('DSBEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 1;
    dsbevx_2stage('V', 'A', 'U', 0, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z,
        1, W, 0, IW, I3, INFO);
    chkxer('DSBEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 2;
    dsbevx_2stage('N', '/', 'U', 0, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z,
        1, W, 0, IW, I3, INFO);
    chkxer('DSBEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 3;
    dsbevx_2stage('N', 'A', '/', 0, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z,
        1, W, 0, IW, I3, INFO);
    chkxer('DSBEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 4;
    ...
    chkxer('DSBEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 7;
    dsbevx_2stage('N', 'A', 'U', 2, 1, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z,
        1, W, 0, IW, I3, INFO);
    chkxer('DSBEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    // infoc.INFOT = 9
    // CALL DSBEVX_2STAGE( 'V', 'A', 'U', 2, 0, A, 1, Q, 1, 0.0,
    // $          0.0, 0, 0, 0.0, M, X, Z, 2, W, 0, IW, I3, INFO )
    // CALL CHKXER( 'DSBEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK )
    infoc.INFOT = 11;
    dsbevx_2stage('N', 'V', 'U', 1, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z,
        1, W, 0, IW, I3, INFO);
    chkxer('DSBEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 12;
    dsbevx_2stage('N', 'I', 'U', 1, 0, A, 1, Q, 1, 0.0, 0.0, 0, 0, 0.0, M, X, Z,
        1, W, 0, IW, I3, INFO);
    chkxer('DSBEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 12;
    dsbevx_2stage('N', 'I', 'U', 1, 0, A, 1, Q, 1, 0.0, 0.0, 2, 1, 0.0, M, X, Z,
        1, W, 0, IW, I3, INFO);
    chkxer('DSBEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 13;
    dsbevx_2stage('N', 'I', 'U', 2, 0, A, 1, Q, 1, 0.0, 0.0, 2, 1, 0.0, M, X, Z,
        1, W, 0, IW, I3, INFO);
    chkxer('DSBEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 13;
    dsbevx_2stage('N', 'I', 'U', 1, 0, A, 1, Q, 1, 0.0, 0.0, 1, 2, 0.0, M, X, Z,
        1, W, 0, IW, I3, INFO);
    chkxer('DSBEVX_2STAGE', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    // infoc.INFOT = 18
