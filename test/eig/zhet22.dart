      void zhet22(final int ITYPE, final int UPLO, final int N, final int M, final int KBAND, final Matrix<double> A_, final int LDA, final int D, final int E, final Matrix<double> U_, final int LDU, final Matrix<double> V_, final int LDV, final int TAU, final Array<double> _WORK_, final Array<double> RWORK_, final int RESULT,) {
  final A = A_.dim();
  final U = U_.dim();
  final V = V_.dim();
