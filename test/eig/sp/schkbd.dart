      void schkbd(NSIZES, MVAL, NVAL, NTYPES, DOTYPE, NRHS, ISEED, THRESH, final Matrix<double> A, final int LDA, BD, BE, S1, S2, final Matrix<double> X, final int LDX, Y, Z, final Matrix<double> Q, final int LDQ, final Matrix<double> PT, final int LDPT, U, VT, WORK, LWORK, IWORK, NOUT, Box<int> INFO ) {
