      void schkbd(NSIZES, MVAL, NVAL, NTYPES, final Array<bool> DOTYPE, NRHS, final Array<int> ISEED, THRESH, final Matrix<double> A, final int LDA, BD, BE, S1, S2, final Matrix<double> X, final int LDX, Y, Z, final Matrix<double> Q, final int LDQ, final Matrix<double> PT, final int LDPT, U, VT, final Array<double> WORK, final int LWORK, final Array<int> IWORK, NOUT, final Box<int> INFO ) {
...
// ======================================================================
 ...
 9998 FORMAT( ' SCHKBD: ${} returned INFO=${.i6}.\n${' ' * 9}M=${.i6}, N=${.i6}, JTYPE=${.i6}, ISEED=(${.i5(4, ',')})' );
