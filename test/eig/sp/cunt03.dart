      void cunt03(final int RC, final int MU, final int MV, final int N, final int K, final Matrix<double> U, final int LDU, final Matrix<double> V, final int LDV, final Array<double> WORK, final int LWORK, final Array<double> RWORK, final int RESULT, final Box<int> INFO,) {
