      void cchkbb(final int NSIZES, final int MVAL, final int NVAL, final int NWDTHS, final int KK, final int NTYPES, final Array<bool> DOTYPE, final int NRHS, final Array<int> ISEED, final int THRESH, final int NOUNIT, final Matrix<double> A, final int LDA, final Matrix<double> AB, final int LDAB, final int BD, final int BE, final Matrix<double> Q, final int LDQ, final Matrix<double> P, final int LDP, final Matrix<double> C, final int LDC, final int CC, final Array<double> WORK, final int LWORK, final Array<double> RWORK, final int RESULT, final Box<int> INFO ) {
