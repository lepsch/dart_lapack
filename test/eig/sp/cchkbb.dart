      void cchkbb(final int NSIZES, final int MVAL, final int NVAL, final int NWDTHS, final int KK, final int NTYPES, final Array<bool> DOTYPE_, final int NRHS, final Array<int> ISEED_, final int THRESH, final int NOUNIT, final Matrix<double> A_, final int LDA, final Matrix<double> AB_, final int LDAB, final int BD, final int BE, final Matrix<double> Q_, final int LDQ, final Matrix<double> P_, final int LDP, final Matrix<double> C_, final int LDC, final int CC, final Array<double> WORK_, final int LWORK, final Array<double> RWORK_, final int RESULT, final Box<int> INFO,) {
