      void cchkhb2stg(NSIZES, NN, NWDTHS, KK, NTYPES, DOTYPE, final Array<int> ISEED, THRESH, NOUNIT, final Matrix<double> A, final int LDA, SD, SE, D1, D2, D3, final Matrix<double> U, final int LDU, final Array<double> WORK, final int LWORK, RWORK, RESULT, Box<int> INFO ) {
