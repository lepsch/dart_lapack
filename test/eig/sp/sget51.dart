      void sget51(ITYPE, N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> U, final int LDU, final Matrix<double> V, final int LDV, final Array<double> _WORK, RESULT ) {
