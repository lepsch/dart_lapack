...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void cchkst2stg(final int NSIZES, final int NN, final int NTYPES, final Array<bool> DOTYPE_, final Array<int> ISEED_, final int THRESH, final int NOUNIT, final Matrix<double> A_, final int LDA, final int AP, final int SD, final int SE, final int D1, final int D2, final int D3, final int D4, final int D5, final int WA1, final int WA2, final int WA3, final int WR, final Matrix<double> U_, final int LDU, final int V, final int VP, final int TAU, final int Z, final Array<double> WORK_, final int LWORK, final Array<int> RWORK_, final int LRWORK, final Array<int> IWORK_, final int LIWORK, final int RESULT, final Box<int> INFO,) {
