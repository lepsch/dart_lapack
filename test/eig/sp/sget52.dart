      void sget52(LEFT, N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> E, final int LDE, ALPHAR, ALPHAI, BETA, final Array<double> _WORK, RESULT ) {
