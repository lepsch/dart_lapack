      void cdrvst(NSIZES, NN, NTYPES, DOTYPE, ISEED, THRESH, NOUNIT, A, LDA, D1, D2, D3, WA1, WA2, WA3, U, LDU, V, TAU, Z, WORK, LWORK, RWORK, LRWORK, IWORK, LIWORK, RESULT, INFO ) {
...
// =====================================================================
 ...
 9999 FORMAT( ' CDRVST: ${} returned INFO=', I6, / 9X, 'N=${.i6}, JTYPE=${.i6}, ISEED=(${i5(3, ',')}', I5, ')' );
 9998 FORMAT( ' CDRVST: ${} returned INFO=', I6, / 9X, 'N=${.i6}, KD=${.i6}, JTYPE=${.i6}, ISEED=(${i5(3, ',')}', I5, ')' );
