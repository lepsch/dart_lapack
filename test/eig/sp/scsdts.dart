      void scsdts(final int M, final int P, final int Q, final int X, final int XF, final int LDX, final Matrix<double> U1, final int LDU1, final Matrix<double> U2, final int LDU2, final Matrix<double> V1T, final int LDV1T, final Matrix<double> V2T, final int LDV2T, final int THETA, final Array<int> IWORK, final Array<double> WORK, final int LWORK, final Array<double> RWORK, final int RESULT) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      slaset('Full', M, M, ZERO, ONE, WORK, LDX );
      ssyrk('Upper', 'Conjugate transpose', M, M, -ONE, X, LDX, ONE, WORK, LDX );
      if (M > 0) {
      ...
      slacpy('Full', M, M, X, LDX, XF, LDX );

      // Compute the CSD

      sorcsd('Y', 'Y', 'Y', 'Y', 'N', 'D', M, P, Q, XF(1,1), LDX, XF(1,Q+1), LDX, XF(P+1,1), LDX, XF(P+1,Q+1), LDX, THETA, U1, LDU1, U2, LDU2, V1T, LDV1T, V2T, LDV2T, WORK, LWORK, IWORK, INFO );

      // Compute XF := diag(U1,U2)'*X*diag(V1,V2) - [D11 D12; D21 D22]

      slacpy('Full', M, M, X, LDX, XF, LDX );

      sgemm('No transpose', 'Conjugate transpose', P, Q, Q, ONE, XF, LDX, V1T, LDV1T, ZERO, WORK, LDX );
      ...
      sgemm('No transpose', 'Conjugate transpose', P, M-Q, M-Q, ONE, XF(1,Q+1), LDX, V2T, LDV2T, ZERO, WORK, LDX );
      ...
      sgemm('No transpose', 'Conjugate transpose', M-P, Q, Q, ONE, XF(P+1,1), LDX, V1T, LDV1T, ZERO, WORK, LDX );
      ...
      sgemm('No transpose', 'Conjugate transpose', M-P, M-Q, M-Q, ONE, XF(P+1,Q+1), LDX, V2T, LDV2T, ZERO, WORK, LDX );
      ...
      slaset('Full', P, P, ZERO, ONE, WORK, LDU1 );
      ssyrk('Upper', 'Conjugate transpose', P, P, -ONE, U1, LDU1, ONE, WORK, LDU1 );
      ...
      slaset('Full', M-P, M-P, ZERO, ONE, WORK, LDU2 );
      ssyrk('Upper', 'Conjugate transpose', M-P, M-P, -ONE, U2, LDU2, ONE, WORK, LDU2 );
      ...
      slaset('Full', Q, Q, ZERO, ONE, WORK, LDV1T );
      ssyrk('Upper', 'No transpose', Q, Q, -ONE, V1T, LDV1T, ONE, WORK, LDV1T );
      ...
      slaset('Full', M-Q, M-Q, ZERO, ONE, WORK, LDV2T );
      ssyrk('Upper', 'No transpose', M-Q, M-Q, -ONE, V2T, LDV2T, ONE, WORK, LDV2T );
      ...
      slaset('Full', Q, Q, ZERO, ONE, WORK, LDX );
      ssyrk('Upper', 'Conjugate transpose', Q, M, -ONE, X, LDX, ONE, WORK, LDX );
      if (M > 0) {
      ...
      slacpy('Full', M, Q, X, LDX, XF, LDX );

      // Compute the CSD

      sorcsd2by1('Y', 'Y', 'Y', M, P, Q, XF(1,1), LDX, XF(P+1,1), LDX, THETA, U1, LDU1, U2, LDU2, V1T, LDV1T, WORK, LWORK, IWORK, INFO );

      // Compute [X11;X21] := diag(U1,U2)'*[X11;X21]*V1 - [D11;D21]

      sgemm('No transpose', 'Conjugate transpose', P, Q, Q, ONE, X, LDX, V1T, LDV1T, ZERO, WORK, LDX );
      ...
      sgemm('No transpose', 'Conjugate transpose', M-P, Q, Q, ONE, X(P+1,1), LDX, V1T, LDV1T, ZERO, WORK, LDX );
