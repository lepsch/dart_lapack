      void slsets(final int M, final int P, final int N, final int A, final int AF, final int LDA, final int B, final int BF, final int LDB, final int C, final int CF, final int D, final int DF, final int X, final Array<double> WORK, final int LWORK, final Array<double> RWORK, final int RESULT,) {
