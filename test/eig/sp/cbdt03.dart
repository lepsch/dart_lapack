...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void cbdt03(final int UPLO, final int N, final int KD, final int D, final int E, final Matrix<double> U_, final int LDU, final int S, final Matrix<double> VT_, final int LDVT, final Array<double> _WORK_, final int RESID,) {
  final U = U_.dim();
  final VT = VT_.dim();
