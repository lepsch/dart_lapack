      void cstt21(final int N, final int KBAND, final int AD, final int AE, final int SD, final int SE, final Matrix<double> U, final int LDU, final Array<double> _WORK, final Array<double> RWORK, final int RESULT,) {
