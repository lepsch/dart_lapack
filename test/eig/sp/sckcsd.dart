...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
 ...
 9998 FORMAT( ' M=${.i4} P=${.i4}, Q=${.i4}, type ${.i2}, test ${.i2}, ratio=${.g13_6};
      ...
      void slacsg(final int M, final int P, final int Q, final int THETA, final Array<int> ISEED_, final Matrix<double> X_, final int LDX, final Array<double> WORK_,) {
  final ISEED = ISEED_.dim();
  final X = X_.dim();
