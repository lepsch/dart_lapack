      void cchkhb(NSIZES, NN, NWDTHS, KK, NTYPES, DOTYPE, ISEED, THRESH, NOUNIT, final Matrix<double> A, final int LDA, SD, SE, final Matrix<double> U, final int LDU, WORK, LWORK, RWORK, RESULT, Box<int> INFO ) {
