      void cchkhb(final int NSIZES, final int NN, final int NWDTHS, final int KK, final int NTYPES, final Array<bool> DOTYPE_, final Array<int> ISEED_, final int THRESH, final int NOUNIT, final Matrix<double> A_, final int LDA, final int SD, final int SE, final Matrix<double> U_, final int LDU, final Array<double> WORK_, final int LWORK, final Array<double> RWORK_, final int RESULT, final Box<int> INFO,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
 ...
 9999 FORMAT( ' CCHKHB: ${} returned INFO=${.i6}.\n${' ' * 9}N=${.i6}, JTYPE=${.i6}, ISEED=(${.i5(4, ',')})' );
