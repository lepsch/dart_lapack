      void sdrves(final int NSIZES, final int NN, final int NTYPES, final Array<bool> DOTYPE, final Array<int> ISEED, final int THRESH, final int NOUNIT, final Matrix<double> A, final int LDA, final int H, final int HT, final int WR, final int WI, final int WRT, final int WIT, final Matrix<double> VS, final int LDVS, final int RESULT, final Array<double> _WORK, final int NWORK, final Array<int> IWORK, final Array<bool> BWORK, final Box<int> INFO ) {
