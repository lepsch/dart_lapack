      void cget22(final int TRANSA, final int TRANSE, final int TRANSW, final int N, final Matrix<double> A_, final int LDA, final Matrix<double> E_, final int LDE, final int W, final Array<double> _WORK_, final Array<double> RWORK_, final int RESULT,) {
  final A = A_.dim();
  final E = E_.dim();
