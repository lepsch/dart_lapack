      void cdrvst2stg(NSIZES, NN, NTYPES, DOTYPE, ISEED, THRESH, NOUNIT, final Matrix<double> A, final int LDA, D1, D2, D3, WA1, WA2, WA3, final Matrix<double> U, final int LDU, V, TAU, Z, final Array<double> WORK, final int LWORK, final Array<int> RWORK, final int LRWORK, final Array<int> IWORK, final int LIWORK, RESULT, Box<int> INFO ) {
