      void cget23(COMP, ISRT, BALANC, JTYPE, THRESH, ISEED, NOUNIT, N, final Matrix<double> A, final int LDA, H, W, W1, final Matrix<double> VL, final int LDVL, final Matrix<double> VR, final int LDVR, final Matrix<double> LRE, final int LDLRE, RCONDV, RCNDV1, RCDVIN, RCONDE, RCNDE1, RCDEIN, SCALE, SCALE1, RESULT, final Array<double> WORK, final int LWORK, RWORK, Box<int> INFO ) {
