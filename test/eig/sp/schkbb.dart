      void schkbb(NSIZES, MVAL, NVAL, NWDTHS, KK, NTYPES, final Array<bool> DOTYPE, NRHS, final Array<int> ISEED, THRESH, NOUNIT, final Matrix<double> A, final int LDA, final Matrix<double> AB, final int LDAB, BD, BE, final Matrix<double> Q, final int LDQ, final Matrix<double> P, final int LDP, final Matrix<double> C, final int LDC, CC, final Array<double> WORK, final int LWORK, RESULT, Box<int> INFO ) {
