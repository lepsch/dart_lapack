      void schksb(NSIZES, NN, NWDTHS, KK, NTYPES, DOTYPE, final Array<int> ISEED, THRESH, NOUNIT, final Matrix<double> A, final int LDA, SD, SE, final Matrix<double> U, final int LDU, final Array<double> WORK, final int LWORK, RESULT, Box<int> INFO ) {
