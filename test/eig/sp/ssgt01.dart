      void ssgt01(final int ITYPE, final int UPLO, final int N, final int M, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> Z, final int LDZ, final int D, final Array<double> _WORK, final int RESULT,) {
