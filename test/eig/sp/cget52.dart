      void cget52(final int LEFT, final int N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> E, final int LDE, final int ALPHA, final int BETA, final Array<double> _WORK, final Array<double> RWORK, final int RESULT) {
