      void ssyt21(ITYPE, UPLO, N, KBAND, final Matrix<double> A, final int LDA, D, E, final Matrix<double> U, final int LDU, final Matrix<double> V, final int LDV, TAU, WORK, RESULT ) {
