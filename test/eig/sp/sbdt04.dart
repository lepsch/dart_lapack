      void sbdt04(final int UPLO, final int N, final int D, final int E, final int S, final int NS, final Matrix<double> U_, final int LDU, final Matrix<double> VT_, final int LDVT, final Array<double> _WORK_, final int RESID,) {
  final U = U_.dim();
  final VT = VT_.dim();
