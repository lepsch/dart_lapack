...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void clarhs(final int PATH, final int XTYPE, final int UPLO, final int TRANS, final int M, final int N, final int KL, final int KU, final int NRHS, final Matrix<double> A_, final int LDA, final Matrix<double> X_, final int LDX, final Matrix<double> B_, final int LDB, final Array<int> ISEED_, final Box<int> INFO,) {
  final A = A_.dim();
  final X = X_.dim();
  final B = B_.dim();
