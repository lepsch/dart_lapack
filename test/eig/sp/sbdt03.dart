      void sbdt03(final int UPLO, final int N, final int KD, final int D, final int E, final Matrix<double> U, final int LDU, final int S, final Matrix<double> VT, final int LDVT, final Array<double> _WORK, final int RESID) {
