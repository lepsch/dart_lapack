      void cstt22(N, M, KBAND, AD, AE, SD, SE, final Matrix<double> U, final int LDU, final Matrix<double> WORK, final int LDWORK, final Array<double> RWORK, final int RESULT) {
