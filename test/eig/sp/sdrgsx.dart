      void sdrgsx(NSIZE, NCMAX, THRESH, NIN, NOUT, final Matrix<double> A, final int LDA, B, AI, BI, Z, Q, ALPHAR, ALPHAI, BETA, final Matrix<double> C, final int LDC, S, final Array<double> WORK, final int LWORK, final Array<int> IWORK, final int LIWORK, BWORK, Box<int> INFO ) {
