      void sdrgsx(NSIZE, NCMAX, THRESH, NIN, NOUT, A, LDA, B, AI, BI, Z, Q, ALPHAR, ALPHAI, BETA, C, LDC, S, WORK, LWORK, IWORK, LIWORK, BWORK, INFO ) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
 ...
 9991 FORMAT( ' Matrix order=${.i2}, type=${.i2}, a=', E10.3, ', order(A_11)=${.i2}, result ${.i2} is ' F8.2 );
 9990 FORMAT( ' Matrix order=${.i2}, type=${.i2}, a=', E10.3, ', order(A_11)=${.i2}, result ${.i2} is ' E10.3 );
