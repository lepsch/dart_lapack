      void cckcsd(NM, MVAL, PVAL, QVAL, NMATS, final Array<int> ISEED, THRESH, MMAX, X, XF, U1, U2, V1T, V2T, THETA, final Array<int> IWORK, WORK, final Array<double> RWORK, NIN, NOUT, final Box<int> INFO ) {
