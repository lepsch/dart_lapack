      void cckcsd(NM, MVAL, PVAL, QVAL, NMATS, ISEED, THRESH, MMAX, X, XF, U1, U2, V1T, V2T, THETA, IWORK, WORK, RWORK, NIN, NOUT, Box<int> INFO ) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
 ...
 9998 FORMAT( ' M=${.i4} P=${.i4}, Q=${.i4}, type ${.i2}, test ${.i2}, ratio=${.g13_6};
      ...
      void clacsg(M, P, Q, THETA, ISEED, final Matrix<double> X, final int LDX, WORK ) {
      int                LDX, M, P, Q;
      int                ISEED( 4 );
      double               THETA( * );
      Complex            WORK( * ), X( LDX, * );
