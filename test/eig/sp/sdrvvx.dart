      void sdrvvx(final int NSIZES, final int NN, final int NTYPES, final Array<bool> DOTYPE, final Array<int> ISEED, final int THRESH, final int NIUNIT, final int NOUNIT, final Matrix<double> A, final int LDA, final int H, final int WR, final int WI, final int WR1, final int WI1, final Matrix<double> VL, final int LDVL, final Matrix<double> VR, final int LDVR, final Matrix<double> LRE, final int LDLRE, final int RCONDV, final int RCNDV1, final int RCDVIN, final int RCONDE, final int RCNDE1, final int RCDEIN, final int SCALE, final int SCALE1, final int RESULT, final Array<double> _WORK, final int NWORK, final Array<int> IWORK, final Box<int> INFO ) {
