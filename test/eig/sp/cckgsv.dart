      void cckgsv(NM, MVAL, PVAL, NVAL, NMATS, final Array<int> ISEED, THRESH, NMAX, A, AF, B, BF, U, V, Q, ALPHA, BETA, R, final Array<int> IWORK, final Array<double> _WORK, final Array<double> RWORK, NIN, NOUT, final Box<int> INFO ) {
