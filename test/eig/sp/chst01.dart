      void chst01(final int N, final int ILO, final int IHI, final Matrix<double> A, final int LDA, final Matrix<double> H, final int LDH, final Matrix<double> Q, final int LDQ, final Array<double> WORK, final int LWORK, final Array<double> RWORK, final int RESULT) {
