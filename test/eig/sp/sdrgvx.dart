      void sdrgvx(NSIZE, THRESH, NIN, NOUT, final Matrix<double> A, final int LDA, B, AI, BI, ALPHAR, ALPHAI, BETA, VL, VR, ILO, IHI, LSCALE, RSCALE, S, STRU, DIF, DIFTRU, final Array<double> WORK, final int LWORK, final Array<int> IWORK, final int LIWORK, RESULT, final Array<bool> BWORK, final Box<int> INFO ) {
