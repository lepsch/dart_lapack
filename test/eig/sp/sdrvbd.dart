      void sdrvbd(NSIZES, MM, NN, NTYPES, final Array<bool> DOTYPE, final Array<int> ISEED, THRESH, final Matrix<double> A, final int LDA, final Matrix<double> U, final int LDU, final Matrix<double> VT, final int LDVT, ASAV, USAV, VTSAV, S, SSAV, E, final Array<double> WORK, final int LWORK, final Array<int> IWORK, NOUT, final Box<int> INFO ) {
