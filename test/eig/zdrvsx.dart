...
import 'common.dart';
      ...
      void zdrvsx(NSIZES, NN, NTYPES, DOTYPE, ISEED, THRESH, NIUNIT, NOUNIT, A, LDA, H, HT, W, WT, WTMP, VS, LDVS, VS1, RESULT, WORK, LWORK, RWORK, BWORK, INFO ) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
 ...
 9999 FORMAT( / 1X, '${.a3} -- Complex Schur Form Decomposition Expert Driver\n Matrix types (see ZDRVSX for details): ' );
 ...
 9991 FORMAT( ' ZDRVSX: ${} returned INFO=${.i6}.\n${' ' * 9}N=${.i6}, JTYPE=${.i6}, ISEED=(${i5(3, ',')}', I5, ')' );
