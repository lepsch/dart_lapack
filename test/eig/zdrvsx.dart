...
import 'common.dart';
      ...
      void zdrvsx(NSIZES, NN, NTYPES, DOTYPE, ISEED, THRESH, NIUNIT, NOUNIT, final Matrix<double> A, final int LDA, H, HT, W, WT, WTMP, final Matrix<double> VS, final int LDVS, VS1, RESULT, WORK, LWORK, RWORK, BWORK, Box<int> INFO ) {
