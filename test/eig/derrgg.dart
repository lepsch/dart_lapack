...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  if (lsamen(2, C2, 'GG')) {
    ...
    infoc.INFOT = 1;
    dggsvd3('/', 'N', 'N', 0, 0, 0, DUMMYK, DUMMYL, A, 1, B, 1, R1, R2, U, 1, V,
    ...
    chkxer('DGGSVD3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 10;
    dggsvd3('N', 'N', 'N', 2, 1, 1, DUMMYK, DUMMYL, A, 1, B, 1, R1, R2, U, 1, V,
        1, Q, 1, W, LWORK, IDUM, INFO);
    chkxer('DGGSVD3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 12;
    dggsvd3('N', 'N', 'N', 1, 1, 2, DUMMYK, DUMMYL, A, 1, B, 1, R1, R2, U, 1, V,
        1, Q, 1, W, LWORK, IDUM, INFO);
    chkxer('DGGSVD3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 16;
    dggsvd3('U', 'N', 'N', 2, 2, 2, DUMMYK, DUMMYL, A, 2, B, 2, R1, R2, U, 1, V,
        1, Q, 1, W, LWORK, IDUM, INFO);
    chkxer('DGGSVD3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 18;
    dggsvd3('N', 'V', 'N', 1, 1, 2, DUMMYK, DUMMYL, A, 1, B, 2, R1, R2, U, 1, V,
        1, Q, 1, W, LWORK, IDUM, INFO);
    chkxer('DGGSVD3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 20;
    ...
    infoc.INFOT = 1;
    dggsvp3('/', 'N', 'N', 0, 0, 0, A, 1, B, 1, TOLA.value, TOLB.value, DUMMYK,
    ...
    chkxer('DGGSVP3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 4;
    dggsvp3('N', 'N', 'N', -1, 0, 0, A, 1, B, 1, TOLA.value, TOLB.value, DUMMYK,
        DUMMYL, U, 1, V, 1, Q, 1, IW, TAU, W, LWORK, INFO);
    chkxer('DGGSVP3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 5;
    dggsvp3('N', 'N', 'N', 0, -1, 0, A, 1, B, 1, TOLA.value, TOLB.value, DUMMYK,
        DUMMYL, U, 1, V, 1, Q, 1, IW, TAU, W, LWORK, INFO);
    chkxer('DGGSVP3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 6;
    dggsvp3('N', 'N', 'N', 0, 0, -1, A, 1, B, 1, TOLA.value, TOLB.value, DUMMYK,
        DUMMYL, U, 1, V, 1, Q, 1, IW, TAU, W, LWORK, INFO);
    chkxer('DGGSVP3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 8;
    dggsvp3('N', 'N', 'N', 2, 1, 1, A, 1, B, 1, TOLA.value, TOLB.value, DUMMYK,
        DUMMYL, U, 1, V, 1, Q, 1, IW, TAU, W, LWORK, INFO);
    chkxer('DGGSVP3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 10;
    dggsvp3('N', 'N', 'N', 1, 2, 1, A, 1, B, 1, TOLA.value, TOLB.value, DUMMYK,
        DUMMYL, U, 1, V, 1, Q, 1, IW, TAU, W, LWORK, INFO);
    chkxer('DGGSVP3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 16;
    dggsvp3('U', 'N', 'N', 2, 2, 2, A, 2, B, 2, TOLA.value, TOLB.value, DUMMYK,
        DUMMYL, U, 1, V, 1, Q, 1, IW, TAU, W, LWORK, INFO);
    chkxer('DGGSVP3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 18;
    dggsvp3('N', 'V', 'N', 1, 2, 1, A, 1, B, 2, TOLA.value, TOLB.value, DUMMYK,
        DUMMYL, U, 1, V, 1, Q, 1, IW, TAU, W, LWORK, INFO);
    chkxer('DGGSVP3', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 20;
    ...
    srnamc.SRNAMT = 'DGGES ';
    infoc.INFOT = 1;
    dgges('/', 'N', 'S', dlctes, 1, A, 1, B, 1, SDIM, R1, R2, R3, Q, 1, U, 1, W,
        1, BW, INFO);
    ...
    chkxer('DGGES ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 3;
    dgges('N', 'V', '/', dlctes, 1, A, 1, B, 1, SDIM, R1, R2, R3, Q, 1, U, 1, W,
        1, BW, INFO);
    chkxer('DGGES ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 5;
    ...
    chkxer('DGGES ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 7;
    dgges('N', 'V', 'S', dlctes, 1, A, 0, B, 1, SDIM, R1, R2, R3, Q, 1, U, 1, W,
        1, BW, INFO);
    chkxer('DGGES ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 9;
    dgges('N', 'V', 'S', dlctes, 1, A, 1, B, 0, SDIM, R1, R2, R3, Q, 1, U, 1, W,
        1, BW, INFO);
    chkxer('DGGES ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 15;
    dgges('N', 'V', 'S', dlctes, 1, A, 1, B, 1, SDIM, R1, R2, R3, Q, 0, U, 1, W,
        1, BW, INFO);
    chkxer('DGGES ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 15;
    dgges('V', 'V', 'S', dlctes, 2, A, 2, B, 2, SDIM, R1, R2, R3, Q, 1, U, 2, W,
        1, BW, INFO);
    chkxer('DGGES ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 17;
    dgges('N', 'V', 'S', dlctes, 1, A, 1, B, 1, SDIM, R1, R2, R3, Q, 1, U, 0, W,
        1, BW, INFO);
    chkxer('DGGES ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 17;
    dgges('V', 'V', 'S', dlctes, 2, A, 2, B, 2, SDIM, R1, R2, R3, Q, 2, U, 1, W,
        1, BW, INFO);
    chkxer('DGGES ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 19;
    ...
    chkxer('DGGES3 ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 5;
    dgges3('N', 'V', 'S', dlctes, -1, A, 1, B, 1, SDIM, R1, R2, R3, Q, 1, U, 1,
        W, 1, BW, INFO);
    chkxer('DGGES3 ', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 7;
    ...
    infoc.INFOT = 1;
    dggesx('/', 'N', 'S', dlctsx, 'N', 1, A, 1, B, 1, SDIM, R1, R2, R3, Q, 1, U,
        1, RCE, RCV, W, 1, IW, 1, BW, INFO);
    ...
    chkxer('DGGESX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 3;
    dggesx('V', 'V', '/', dlctsx, 'N', 1, A, 1, B, 1, SDIM, R1, R2, R3, Q, 1, U,
        1, RCE, RCV, W, 1, IW, 1, BW, INFO);
    chkxer('DGGESX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 5;
    dggesx('V', 'V', 'S', dlctsx, '/', 1, A, 1, B, 1, SDIM, R1, R2, R3, Q, 1, U,
        1, RCE, RCV, W, 1, IW, 1, BW, INFO);
    chkxer('DGGESX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 6;
    ...
    chkxer('DGGESX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 8;
    dggesx('V', 'V', 'S', dlctsx, 'B', 1, A, 0, B, 1, SDIM, R1, R2, R3, Q, 1, U,
        1, RCE, RCV, W, 1, IW, 1, BW, INFO);
    chkxer('DGGESX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 10;
    dggesx('V', 'V', 'S', dlctsx, 'B', 1, A, 1, B, 0, SDIM, R1, R2, R3, Q, 1, U,
        1, RCE, RCV, W, 1, IW, 1, BW, INFO);
    chkxer('DGGESX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 16;
    dggesx('V', 'V', 'S', dlctsx, 'B', 1, A, 1, B, 1, SDIM, R1, R2, R3, Q, 0, U,
        1, RCE, RCV, W, 1, IW, 1, BW, INFO);
    chkxer('DGGESX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 16;
    dggesx('V', 'V', 'S', dlctsx, 'B', 2, A, 2, B, 2, SDIM, R1, R2, R3, Q, 1, U,
        1, RCE, RCV, W, 1, IW, 1, BW, INFO);
    chkxer('DGGESX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 18;
    dggesx('V', 'V', 'S', dlctsx, 'B', 1, A, 1, B, 1, SDIM, R1, R2, R3, Q, 1, U,
        0, RCE, RCV, W, 1, IW, 1, BW, INFO);
    chkxer('DGGESX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 18;
    dggesx('V', 'V', 'S', dlctsx, 'B', 2, A, 2, B, 2, SDIM, R1, R2, R3, Q, 2, U,
        1, RCE, RCV, W, 1, IW, 1, BW, INFO);
    chkxer('DGGESX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 22;
    dggesx('V', 'V', 'S', dlctsx, 'B', 2, A, 2, B, 2, SDIM, R1, R2, R3, Q, 2, U,
        2, RCE, RCV, W, 1, IW, 1, BW, INFO);
    chkxer('DGGESX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 24;
    ...
    infoc.INFOT = 1;
    dggevx('/', 'N', 'N', 'N', 1, A, 1, B, 1, R1, R2, R3, Q, 1, U, 1, ILO, IHI,
    ...
    chkxer('DGGEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 5;
    dggevx('N', 'N', 'N', 'N', -1, A, 1, B, 1, R1, R2, R3, Q, 1, U, 1, ILO, IHI,
        LS, RS, ANRM, BNRM, RCE, RCV, W, 1, IW, BW, INFO);
    chkxer('DGGEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 7;
    dggevx('N', 'N', 'N', 'N', 1, A, 0, B, 1, R1, R2, R3, Q, 1, U, 1, ILO, IHI,
        LS, RS, ANRM, BNRM, RCE, RCV, W, 1, IW, BW, INFO);
    chkxer('DGGEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 9;
    dggevx('N', 'N', 'N', 'N', 1, A, 1, B, 0, R1, R2, R3, Q, 1, U, 1, ILO, IHI,
        LS, RS, ANRM, BNRM, RCE, RCV, W, 1, IW, BW, INFO);
    chkxer('DGGEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 14;
    dggevx('N', 'N', 'N', 'N', 1, A, 1, B, 1, R1, R2, R3, Q, 0, U, 1, ILO, IHI,
        LS, RS, ANRM, BNRM, RCE, RCV, W, 1, IW, BW, INFO);
    chkxer('DGGEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 14;
    dggevx('N', 'V', 'N', 'N', 2, A, 2, B, 2, R1, R2, R3, Q, 1, U, 2, ILO, IHI,
        LS, RS, ANRM, BNRM, RCE, RCV, W, 1, IW, BW, INFO);
    chkxer('DGGEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 16;
    dggevx('N', 'N', 'N', 'N', 1, A, 1, B, 1, R1, R2, R3, Q, 1, U, 0, ILO, IHI,
        LS, RS, ANRM, BNRM, RCE, RCV, W, 1, IW, BW, INFO);
    chkxer('DGGEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 16;
    dggevx('N', 'N', 'V', 'N', 2, A, 2, B, 2, R1, R2, R3, Q, 2, U, 1, ILO, IHI,
        LS, RS, ANRM, BNRM, RCE, RCV, W, 1, IW, BW, INFO);
    chkxer('DGGEVX', infoc.INFOT, infoc.NOUT, infoc.LERR, infoc.OK);
    infoc.INFOT = 26;
