      void ddrvsg(NSIZES, NN, NTYPES, DOTYPE, ISEED, THRESH, NOUNIT, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, D, final Matrix<double> Z, final int LDZ, AB, BB, AP, BP, WORK, NWORK, IWORK, LIWORK, RESULT, Box<int> INFO ) {
