      void ddrvsg(final int NSIZES, final int NN, final int NTYPES, final Array<bool> DOTYPE_, final Array<int> ISEED_, final int THRESH, final int NOUNIT, final Matrix<double> A_, final int LDA, final Matrix<double> B_, final int LDB, final int D, final Matrix<double> Z_, final int LDZ, final int AB, final int BB, final int AP, final int BP, final Array<double> _WORK_, final int NWORK, final Array<int> IWORK_, final int LIWORK, final int RESULT, final Box<int> INFO,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      double             A( LDA, * ), AB( LDA, * ), AP( * ), B( LDB, * ), BB( LDB, * ), BP( * ), D( * ), RESULT( * ), WORK( * ), Z( LDZ, * );
      // ..
      ...
      return;
 9999 FORMAT( ' DDRVSG: ${} returned INFO=${.i6}.\n${' ' * 9}N=${.i6}, JTYPE=${.i6}, ISEED=(${.i5(4, ',')})' );
      }
