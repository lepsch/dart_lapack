      void zckglm(NN, NVAL, MVAL, PVAL, NMATS, final Array<int> ISEED, THRESH, NMAX, A, AF, B, BF, X, final Array<double> _WORK, final Array<double> RWORK, NIN, NOUT, final Box<int> INFO ) {
