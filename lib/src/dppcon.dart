...
import 'package:lapack/src/xerbla.dart';
      ...
      void dppcon(final int UPLO, final int N, final int AP, final int ANORM, final int RCOND, final Array<double> _WORK_, final Array<int> IWORK_, final Box<int> INFO,) {
