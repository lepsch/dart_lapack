...
import 'package:lapack/src/xerbla.dart';
      ...
      double dla_porcond(UPLO, N, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, CMODE, C, INFO, final Array<double> _WORK, final Array<int> IWORK) {
