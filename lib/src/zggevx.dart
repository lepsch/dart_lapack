      void zggevx(BALANC, JOBVL, JOBVR, SENSE, N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, ALPHA, BETA, final Matrix<double> VL, final int LDVL, final Matrix<double> VR, final int LDVR, ILO, IHI, LSCALE, RSCALE, ABNRM, BBNRM, RCONDE, RCONDV, final Array<double> WORK, final int LWORK, final Array<double> RWORK, final Array<int> IWORK, final Array<bool> BWORK, final Box<int> INFO ) {
