      void zgesvdx(final int JOBU, final int JOBVT, final int RANGE, final int M, final int N, final Matrix<double> A, final int LDA, final int VL, final int VU, final int IL, final int IU, final int NS, final int S, final Matrix<double> U, final int LDU, final Matrix<double> VT, final int LDVT, final Array<double> WORK, final int LWORK, final Array<double> RWORK, final Array<int> IWORK, final Box<int> INFO ) {
