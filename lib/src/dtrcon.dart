...
import 'package:lapack/src/xerbla.dart';
      ...
      void dtrcon(final int NORM, final int UPLO, final int DIAG, final int N, final Matrix<double> A, final int LDA, final int RCOND, final Array<double> _WORK, final Array<int> IWORK, final Box<int> INFO ) {
