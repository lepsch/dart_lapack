...
import 'package:dart_lapack/src/dla_syrcond.dart';
import 'package:dart_lapack/src/dla_syrfsx_extended.dart';
...
void dsyrfsx(
  ...
  if (N_ERR_BNDS >= 1 && N_NORMS >= 1) {
    ...
    if (RCEQU) {
      RCOND_TMP = dla_syrcond(
          UPLO, N, A, LDA, AF, LDAF, IPIV, -1, S, INFO, WORK, IWORK);
    } else {
      RCOND_TMP =
          dla_syrcond(UPLO, N, A, LDA, AF, LDAF, IPIV, 0, S, INFO, WORK, IWORK);
    }
    for (J = 1; J <= NRHS; J++) {
