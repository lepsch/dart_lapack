...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsyequb(final int UPLO, final int N, final Matrix<double> A_, final int LDA, final int S, final int SCOND, final int AMAX, final Array<double> _WORK_, final Box<int> INFO,) {
  final A = A_.dim();
