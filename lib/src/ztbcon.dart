      void ztbcon(final int NORM, final int UPLO, final int DIAG, final int N, final int KD, final Matrix<double> AB, final int LDAB, final int RCOND, final Array<double> _WORK, final Array<double> RWORK, final Box<int> INFO ) {
