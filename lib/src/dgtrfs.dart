...
import 'package:lapack/src/xerbla.dart';
      ...
      void dgtrfs(TRANS, N, NRHS, DL, D, DU, DLF, DF, DUF, DU2, final Array<int> IPIV, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, FERR, BERR, final Array<double> _WORK, final Array<int> IWORK, final Box<int> INFO ) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      for (J = 1; J <= NRHS; J++) { // 110
         ...
         dlagtm(TRANS, N, 1, -ONE, DL, D, DU, X( 1, J ), LDX, ONE, WORK( N+1 ), N );
