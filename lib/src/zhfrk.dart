      void zhfrk(final int TRANSR, final int UPLO, final int TRANS, final int N, final int K, final int ALPHA, final Matrix<double> A_, final int LDA, final int BETA, final int C,) {
  final A = A_.dim();
