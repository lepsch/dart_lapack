...
import 'package:lapack/src/xerbla.dart';
      ...
      void dbdsvdx(UPLO, JOBZ, RANGE, N, D, E, VL, VU, IL, IU, NS, S, Z, LDZ, WORK, IWORK, INFO) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      if ( ALLSV ) {
         ...
         if ( NS == 0 ) {
            ...
            if (WANTZ) dlaset( 'F', N*2, NS, ZERO, ZERO, Z, LDZ );
         }
      } else if ( INDSV ) {
               ...
               if ( NTGK > 0 ) {
                  ...
                  if ( NSL > 0 && WANTZ ) {
                     ...
                     for (I = 0; I <= min( NSL-1, NRU-1 ); I++) {
                        ...
                        CALL DSCAL( NRU, ONE/NRMU, Z( IROWU,ICOLZ+I ), 2 )                         IF( NRMU != ONE && ( NRMU-ORTOL ).abs()*SQRT2 > ONE ) THEN;
                           for (J = 0; J <= I-1; J++) {
                     ...
                     for (I = 0; I <= min( NSL-1, NRV-1 ); I++) {
                        ...
                        CALL DSCAL( NRV, -ONE/NRMV, Z( IROWV,ICOLZ+I ), 2 )                         IF( NRMV != ONE && ( NRMV-ORTOL ).abs()*SQRT2 > ONE ) THEN;
                           for (J = 0; J <= I-1; J++) {
      ...
      for (I = 1; I <= NS-1; I++) {
         ...
         if ( K != NS+1-I ) {
            S[K] = S( NS+1-I );
            S[NS+1-I] = SMIN;
            if (WANTZ) dswap( N*2, Z( 1,K ), 1, Z( 1,NS+1-I ), 1 );
         }
      }
