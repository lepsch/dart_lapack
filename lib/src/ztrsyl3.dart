      void ztrsyl3(TRANA, TRANB, ISGN, M, N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> C, final int LDC, SCALE, final Matrix<double> SWORK, final int LDSWORK, final Box<int> INFO ) {
      String             TRANA, TRANB;
