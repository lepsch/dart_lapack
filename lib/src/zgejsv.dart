      void zgejsv(JOBA, JOBU, JOBV, JOBR, JOBT, JOBP, M, N, final Matrix<double> A, final int LDA, SVA, final Matrix<double> U, final int LDU, final Matrix<double> V, final int LDV, CWORK, LWORK, final Array<int> RWORK, final int LRWORK, IWORK, Box<int> INFO ) {
