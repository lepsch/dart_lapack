...
// .. Figure TOTAL flops ..
 ...
 9999 FORMAT( ' Time for ', G10.3,' SAXPY ops = ${.g10_3} seconds' );
 9998 FORMAT( ' SAXPY performance rate        = ${.g10_3} mflops ' );
 9997 FORMAT( ' Including SECOND, time        = ${.g10_3} seconds' );
 9996 FORMAT( ' Average time for SECOND       = ${.g10_3} milliseconds' );
