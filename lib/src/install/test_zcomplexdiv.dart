...
// Univ. of Tennessee, Univ. of California Berkeley and NAG Ltd..
      ...
      double             aInf, aNaN, b, eps, blueMin, blueMax, OV, Xj;
      Complex    Y, Y2, R;
        ...
        if (Xj == 0.0) {
            ...
            while (Xj != limX[i]) {
                ...
                if ( R != Complex(0.0,1.0) ) {
                    ...
                    WRITE( 0, FMT = 9999 ) 'd',i, Xj, '(0+x*I)/(x+0*I)', R, Complex(0.0,1.0);
                }
                Xj = Xj * stepX[i];
            }
        }
        ...
        if (Xj == 0.0) {
            ...
            while (Xj != limX[i]) {
                ...
                if ( R != Complex(0.0,-1.0) ) {
                    ...
                    WRITE( 0, FMT = 9999 ) 'e',i, Xj, '(x+0*I)/(0+x*I)', R, Complex(0.0,-1.0);
                }
                Xj = Xj * stepX[i];
            }
        }
        ...
        if (Xj == 0.0) {
            ...
            while (Xj != limX[i]) {
                ...
                if ( R != Complex(0.0,1.0) ) {
                    ...
                    WRITE( 0, FMT = 9999 ) 'f',i, Xj, '(x+x*I)/(x-x*I)', R, Complex(0.0,1.0);
                }
                Xj = Xj * stepX[i];
            }
        }
      ...
      for (i = 1; i <= nInf; i++) { // 70
          ...
          if ( (R != Complex.zero) && (R == R) ) {
              ...
              WRITE( *, FMT = 9998 ) 'ia',i, Complex.zero, Y, R, 'NaN and 0';
          }
          R = Complex.one / Y;
          if ( (R != Complex.zero) && (R == R) ) {
              caseInfFails = caseInfFails + 1;
              WRITE( *, FMT = 9998 ) 'ib',i, Complex.one, Y, R, 'NaN and 0';
          }
          R = Y / Y;
          if (R == R) {
              caseInfFails = caseInfFails + 1;
      ...
      for (i = 1; i <= nNaN; i++) { // 80
          ...
          if (R == R) {
              ...
              WRITE( *, FMT = 9998 ) 'na',i, Complex.zero, Y, R, 'NaN';
          }
          R = Complex.one / Y;
          if (R == R) {
              caseNaNFails = caseNaNFails + 1;
              WRITE( *, FMT = 9998 ) 'nb',i, Complex.one, Y, R, 'NaN';
          }
          R = Y / Y;
          if (R == R) {
              caseNaNFails = caseNaNFails + 1;
...
void _print9999(String f, int i, double v) {
  print('[${f.a2}${i.i1}] X = ${v.e16_6}', ES24.16e3, ' : ${.a15} = ', (ES24.16e3,SP,ES24.16e3,"*I"), ' differs from ', (ES24.16e3,SP,ES24.16e3,"*I"));
}
