...
import 'package:lapack/src/dlasyf.dart';
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  if (UPPER) {
    ...
    // KB.value, where KB.value is the number of columns factorized by DLASYF;
    ...
    while (K >= 1) {
      if (K > NB) {
        ...
        dlasyf(UPLO, K, NB, KB, A, LDA, IPIV, WORK.asMatrix(LDWORK), LDWORK,
            IINFO);
      } else {
    ...
    while (K <= N) {
      if (K <= N - NB) {
        ...
        dlasyf(UPLO, N - K + 1, NB, KB, A(K, K), LDA, IPIV(K),
