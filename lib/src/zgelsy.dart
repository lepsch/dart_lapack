      void zgelsy(M, N, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, JPVT, RCOND, RANK, final Array<double> WORK, final int LWORK, RWORK, Box<int> INFO ) {
