      void dlarfb(SIDE, TRANS, DIRECT, STOREV, M, N, K, V, LDV, T, LDT, C, LDC, WORK, LDWORK ) {
         ...
         if ( lsame( DIRECT, 'F' ) ) {
            ...
            if ( lsame( SIDE, 'L' ) ) {
               ...
               if ( M > K ) {
                  ...
                  dgemm('Transpose', 'No transpose', N, K, M-K, ONE, C( K+1, 1 ), LDC, V( K+1, 1 ), LDV, ONE, WORK, LDWORK );
               }

               // W := W * T**T  or  W * T

               dtrmm('Right', 'Upper', TRANST, 'Non-unit', N, K, ONE, T, LDT, WORK, LDWORK );
               ...
               if ( M > K ) {
                  ...
                  dgemm('No transpose', 'Transpose', M-K, N, K, -ONE, V( K+1, 1 ), LDV, WORK, LDWORK, ONE, C( K+1, 1 ), LDC );
               }
               ...
               if ( N > K ) {
                  ...
                  dgemm('No transpose', 'No transpose', M, K, N-K, ONE, C( 1, K+1 ), LDC, V( K+1, 1 ), LDV, ONE, WORK, LDWORK );
               }

               // W := W * T  or  W * T**T

               dtrmm('Right', 'Upper', TRANS, 'Non-unit', M, K, ONE, T, LDT, WORK, LDWORK );
               ...
               if ( N > K ) {
                  ...
                  dgemm('No transpose', 'Transpose', M, N-K, K, -ONE, WORK, LDWORK, V( K+1, 1 ), LDV, ONE, C( 1, K+1 ), LDC );
               }
            ...
            if ( lsame( SIDE, 'L' ) ) {
               ...
               for (J = 1; J <= K; J++) { // 70
                  dcopy(N, C( M-K+J, 1 ), LDC, WORK( 1, J ), 1 );
               } // 70
               ...
               dtrmm('Right', 'Upper', 'Transpose', 'Unit', N, K, ONE, V( M-K+1, 1 ), LDV, WORK, LDWORK );
               ...
               for (J = 1; J <= K; J++) { // 100
                  dcopy(M, C( 1, N-K+J ), 1, WORK( 1, J ), 1 );
               } // 100
               ...
               dtrmm('Right', 'Upper', 'Transpose', 'Unit', M, K, ONE, V( N-K+1, 1 ), LDV, WORK, LDWORK );
         ...
         if ( lsame( DIRECT, 'F' ) ) {
            ...
            if ( lsame( SIDE, 'L' ) ) {
               ...
               if ( M > K ) {
                  ...
                  dgemm('Transpose', 'Transpose', N, K, M-K, ONE, C( K+1, 1 ), LDC, V( 1, K+1 ), LDV, ONE, WORK, LDWORK );
               }
               ...
               if ( M > K ) {
                  ...
                  dgemm('Transpose', 'Transpose', M-K, N, K, -ONE, V( 1, K+1 ), LDV, WORK, LDWORK, ONE, C( K+1, 1 ), LDC );
               }
               ...
               if ( N > K ) {
                  ...
                  dgemm('No transpose', 'Transpose', M, K, N-K, ONE, C( 1, K+1 ), LDC, V( 1, K+1 ), LDV, ONE, WORK, LDWORK );
               }
               ...
               if ( N > K ) {
                  ...
                  dgemm('No transpose', 'No transpose', M, N-K, K, -ONE, WORK, LDWORK, V( 1, K+1 ), LDV, ONE, C( 1, K+1 ), LDC );
               }
            ...
            if ( lsame( SIDE, 'L' ) ) {
               ...
               dtrmm('Right', 'Lower', 'No transpose', 'Unit', N, K, ONE, V( 1, M-K+1 ), LDV, WORK, LDWORK );
               ...
               dtrmm('Right', 'Lower', 'No transpose', 'Unit', M, K, ONE, V( 1, N-K+1 ), LDV, WORK, LDWORK );
