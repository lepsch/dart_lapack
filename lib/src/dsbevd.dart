...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsbevd(final int JOBZ, final int UPLO, final int N, final int KD, final Matrix<double> AB, final int LDAB, final int W, final Matrix<double> Z, final int LDZ, final Array<double> WORK, final int LWORK, final Array<int> IWORK, final int LIWORK, final Box<int> INFO ) {
