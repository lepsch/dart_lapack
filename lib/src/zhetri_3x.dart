      void zhetri_3x(final int UPLO, final int N, final Matrix<double> A_, final int LDA, final int E, final Array<int> IPIV_, final Array<double> _WORK_, final int NB, final Box<int> INFO,) {
  final A = A_.dim();
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      if ( UPPER ) {
         ...
         while (CUT > 0) {
            ...
            zgemm('C', 'N', NNB, NNB, CUT, CONE, A( 1, CUT+1 ), LDA, WORK, N+NB+1, CZERO, WORK(U11+1,1), N+NB+1 );
         ...
         while (CUT < N) {
            ...
            if ( (CUT+NNB) < N ) {
               ...
               zgemm('C', 'N', NNB, NNB, N-NNB-CUT, CONE, A( CUT+NNB+1, CUT+1 ), LDA, WORK, N+NB+1, CZERO, WORK( U11+1, 1 ), N+NB+1 );
