         ...
         // Form  y  when upper triangle of A is stored.
          ...
          if ((INCX == 1) && (INCY == 1)) {
              for (J = 1; J <= N; J++) { // 60
                  ...
                  Y[J] = Y(J) + TEMP1*(A(KPLUS1,J)).toDouble() + ALPHA*TEMP2;
              } // 60
          } else {
              JX = KX;
              JY = KY;
              for (J = 1; J <= N; J++) { // 80
                  ...
                  Y[JY] = Y(JY) + TEMP1*(A(KPLUS1,J)).toDouble() + ALPHA*TEMP2;
                  JX = JX + INCX;
                  JY = JY + INCY;
                  if (J > K) {
                      KX = KX + INCX;
         ...
         // Form  y  when lower triangle of A is stored.
          ...
          if ((INCX == 1) && (INCY == 1)) {
              ...
              for (J = 1; J <= N; J++) { // 120
                  TEMP1 = ALPHA*X(JX);
                  TEMP2 = ZERO;
                  Y[JY] = Y(JY) + TEMP1*(A(1,J)).toDouble();
                  L = 1 - J;
                  IX = JX;
                  IY = JY;
