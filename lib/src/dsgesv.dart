...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsgesv(N, NRHS, final Matrix<double> A, final int LDA, final Array<int> IPIV, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, final Array<double> _WORK, SWORK, ITER, final Box<int> INFO ) {
