...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsgesv(N, NRHS, final Matrix<double> A, final int LDA, IPIV, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, WORK, SWORK, ITER, Box<int> INFO ) {
