...
import 'package:dart_lapack/src/zla_syrcond_c.dart';
import 'package:dart_lapack/src/zla_syrcond_x.dart';
import 'package:dart_lapack/src/zla_syrfsx_extended.dart';
...
void zsyrfsx(
  ...
  if (N_ERR_BNDS >= 1 && N_NORMS >= 1) {
    ...
    if (RCEQU) {
      RCOND_TMP = zla_syrcond_c(
          UPLO, N, A, LDA, AF, LDAF, IPIV, S, true, INFO, WORK, RWORK);
    } else {
      RCOND_TMP = zla_syrcond_c(
          UPLO, N, A, LDA, AF, LDAF, IPIV, S, false, INFO, WORK, RWORK);
    }
    for (J = 1; J <= NRHS; J++) {
