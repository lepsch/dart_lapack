...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsprfs(final int UPLO, final int N, final int NRHS, final int AP, final int AFP, final Array<int> IPIV_, final Matrix<double> B_, final int LDB, final Matrix<double> X_, final int LDX, final int FERR, final int BERR, final Array<double> _WORK_, final Array<int> IWORK_, final Box<int> INFO,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      for (J = 1; J <= NRHS; J++) { // 140
        ...
        //  } // 20
         ...
         dspmv(UPLO, N, -ONE, AP, X( 1, J ), 1, ONE, WORK( N+1 ), 1 );
         ...
         if ( BERR( J ) > EPS && TWO*BERR( J ) <= LSTRES && COUNT <= ITMAX ) {
            ...
            dsptrs(UPLO, N, 1, AFP, IPIV, WORK( N+1 ), N, INFO );
