...
import 'package:lapack/src/xerbla.dart';
      ...
      void dorbdb(final int TRANS, final int SIGNS, final int M, final int P, final int Q, final Matrix<double> X11, final int LDX11, final Matrix<double> X12, final int LDX12, final Matrix<double> X21, final int LDX21, final Matrix<double> X22, final int LDX22, final int THETA, final int PHI, final int TAUP1, final int TAUP2, final int TAUQ1, final int TAUQ2, final Array<double> WORK, final int LWORK, final Box<int> INFO,) {
...
// ====================================================================
      ...
      if ( COLMAJOR ) {
         ...
         for (I = Q + 1; I <= P; I++) {
            ...
            if (M-P-Q >= 1) dlarf( 'R', M-P-Q, M-Q-I+1, X12(I,I), LDX12, TAUQ2(I), X22(Q+1,I), LDX22, WORK );
         ...
         for (I = Q + 1; I <= P; I++) {
            ...
            if (M-P-Q >= 1) dlarf( 'L', M-Q-I+1, M-P-Q, X12(I,I), 1, TAUQ2(I), X22(I,Q+1), LDX22, WORK );
