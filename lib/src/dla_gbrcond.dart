...
import 'package:lapack/src/xerbla.dart';
      ...
      double dla_gbrcond(TRANS, N, KL, KU, final Matrix<double> AB, final int LDAB, final Matrix<double> AFB, final int LDAFB, final Array<int> IPIV, CMODE, C, INFO, final Array<double> _WORK, IWORK ) {
