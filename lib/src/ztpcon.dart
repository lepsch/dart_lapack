      void ztpcon(final int NORM, final int UPLO, final int DIAG, final int N, final int AP, final int RCOND, final Array<double> _WORK_, final Array<double> RWORK_, final Box<int> INFO,) {
