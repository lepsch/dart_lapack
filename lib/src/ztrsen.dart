      void ztrsen(final int JOB, final int COMPQ, final int SELECT, final int N, final Matrix<double> T, final int LDT, final Matrix<double> Q, final int LDQ, final int W, final int M, final int S, final int SEP, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
