      void ztrsen(JOB, COMPQ, SELECT, N, final Matrix<double> T, final int LDT, final Matrix<double> Q, final int LDQ, W, M, S, SEP, final Array<double> WORK, final int LWORK, Box<int> INFO ) {
