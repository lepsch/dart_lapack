...
import 'package:lapack/src/xerbla.dart';
      ...
      void dpbtf2(final String UPLO, final int N, final int KD, final Matrix<double> AB_, final int LDAB, final Box<int> INFO,) {
      ...
      if ( UPPER ) {
         ...
         for (J = 1; J <= N; J++) {
            ...
            if ( KN > 0 ) {
               ...
               dsyr('Upper', KN, -ONE, AB( KD, J+1 ).asArray(), KLD, AB( KD+1, J+1 ), KLD );
            }
         }
      } else {
