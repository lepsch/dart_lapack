...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  zggrqf(P, M, N, B, LDB, WORK, A, LDA, WORK(P + 1), WORK(P + MN + 1),
      LWORK - P - MN, INFO);
  ...
  zunmqr('Left', 'Conjugate Transpose', M, 1, MN, A, LDA, WORK(P + 1),
  ...
  if (P > 0) {
    ztrtrs('Upper', 'No transpose', 'Non-unit', P, 1, B(1, N - P + 1), LDB,
        D.asMatrix(P), P, INFO);
    ...
    zgemv('No transpose', N - P, P, -Complex.one, A(1, N - P + 1), LDA, D, 1,
        Complex.one, C, 1);
  }
  ...
  if (N > P) {
    ztrtrs('Upper', 'No transpose', 'Non-unit', N - P, 1, A, LDA,
  ...
  if (NR > 0) {
    ztrmv('Upper', 'No transpose', 'Non unit', NR, A(N - P + 1, N - P + 1), LDA,
        D, 1);
  ...
  zunmrq('Left', 'Conjugate Transpose', N, 1, P, B, LDB, WORK(1), X.asMatrix(N),
