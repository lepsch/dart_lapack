      double zla_porpvgrw(final int UPLO, final int NCOLS, final Matrix<double> A_, final int LDA, final Matrix<double> AF_, final int LDAF, final Array<double> WORK_,) {
  final A = A_.dim();
  final AF = AF_.dim();
