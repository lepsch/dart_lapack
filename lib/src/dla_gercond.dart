...
import 'package:lapack/src/xerbla.dart';
      ...
      double dla_gercond(TRANS, N, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, final Array<int> IPIV, CMODE, C, INFO, final Array<double> _WORK, IWORK ) {
