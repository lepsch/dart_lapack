...
import 'package:lapack/src/xerbla.dart';
      ...
      void dtrsyl3(final int TRANA, final int TRANB, final int ISGN, final int M, final int N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> C, final int LDC, final int SCALE, final Array<int> IWORK, final int LIWORK, final Matrix<double> SWORK, final int LDSWORK, final Box<int> INFO ) {
      String             TRANA, TRANB;
