...
import 'package:lapack/src/xerbla.dart';
      ...
      void dpbcon(final int UPLO, final int N, final int KD, final Matrix<double> AB, final int LDAB, final int ANORM, final int RCOND, final Array<double> _WORK, final Array<int> IWORK, final Box<int> INFO ) {
