      void zgbtrs(final int TRANS, final int N, final int KL, final int KU, final int NRHS, final Matrix<double> AB, final int LDAB, final Array<int> IPIV, final Matrix<double> B, final int LDB, final Box<int> INFO ) {
