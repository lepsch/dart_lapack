...
import 'package:lapack/src/xerbla.dart';
      ...
      void dpprfs(UPLO, N, NRHS, AP, AFP, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, FERR, BERR, final Array<double> _WORK, final Array<int> IWORK, final Box<int> INFO ) {
