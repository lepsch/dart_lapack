      void zgesvj(final int JOBA, final int JOBU, final int JOBV, final int M, final int N, final Matrix<double> A_, final int LDA, final int SVA, final int MV, final Matrix<double> V_, final int LDV, final int CWORK, final int LWORK, final Array<int> RWORK_, final int LRWORK, final Box<int> INFO,) {
  final A = A_.dim();
  final V = V_.dim();
