...
import 'package:lapack/src/xerbla.dart';
      ...
      void dppsvx(FACT, UPLO, N, NRHS, AP, AFP, EQUED, S, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, RCOND, FERR, BERR, WORK, IWORK, final Box<int> INFO ) {
