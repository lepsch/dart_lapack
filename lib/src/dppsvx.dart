...
import 'package:lapack/src/xerbla.dart';
      ...
      void dppsvx(final int FACT, final int UPLO, final int N, final int NRHS, final int AP, final int AFP, final int EQUED, final int S, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, final int RCOND, final int FERR, final int BERR, final Array<double> _WORK, final Array<int> IWORK, final Box<int> INFO ) {
