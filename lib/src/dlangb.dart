...
import 'package:lapack/src/xerbla.dart';
      ...
      double dlangb(final int NORM, final int N, final int KL, final int KU, final Matrix<double> AB, final int LDAB, final Array<double> WORK) {
...
// =====================================================================
      ...
      if ( N == 0 ) {
         ...
         for (J = 1; J <= N; J++) { // 90
            L = max( 1, J-KU );
            K = KU + 1 - J + L;
            dlassq(min( N, J+KL )-L+1, AB( K, J ), 1, SCALE, SUM );
         } // 90
