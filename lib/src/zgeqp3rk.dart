...
import 'package:lapack/src/zlaqp2rk.dart';
import 'package:lapack/src/zlaqp3rk.dart';
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  int IOFFSET,
      ...
      NBMIN,
      NX;
  double EPS, HUGEVAL, MAXC2NRM = 0, SAFMIN;
  final IINFO = Box(0), JB = Box(0), JBF = Box(0), KF = Box(0);
