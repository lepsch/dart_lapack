      void ztprfb(final int SIDE, final int TRANS, final int DIRECT, final int STOREV, final int M, final int N, final int K, final int L, final Matrix<double> V_, final int LDV, final Matrix<double> T_, final int LDT, final Matrix<double> A_, final int LDA, final Matrix<double> B_, final int LDB, final Array<double> _WORK_, final int LDWORK,) {
  final V = V_.dim();
  final T = T_.dim();
  final A = A_.dim();
  final B = B_.dim();
...
// ---------------------------------------------------------------------------
         ...
         ztrmm('L', 'U', TRANS, 'N', K, N, ONE, T, LDT, WORK, LDWORK );
...
// ---------------------------------------------------------------------------
         ...
         ztrmm('R', 'U', TRANS, 'N', M, K, ONE, T, LDT, WORK, LDWORK );
...
// ---------------------------------------------------------------------------
         ...
         ztrmm('L', 'L', TRANS, 'N', K, N, ONE, T, LDT, WORK, LDWORK );
...
// ---------------------------------------------------------------------------
         ...
         ztrmm('R', 'L', TRANS, 'N', M, K, ONE, T, LDT, WORK, LDWORK );
