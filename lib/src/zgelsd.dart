      void zgelsd(M, N, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, S, RCOND, RANK, final Array<double> WORK, final int LWORK, RWORK, IWORK, Box<int> INFO ) {
