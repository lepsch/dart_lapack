...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsposv(UPLO, N, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, WORK, SWORK, ITER, final Box<int> INFO ) {
