      void zhpevx(final int JOBZ, final int RANGE, final int UPLO, final int N, final int AP, final int VL, final int VU, final int IL, final int IU, final int ABSTOL, final int M, final int W, final Matrix<double> Z, final int LDZ, final Array<double> _WORK, final Array<double> RWORK, final Array<int> IWORK, final int IFAIL, final Box<int> INFO,) {
