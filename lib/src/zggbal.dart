      void zggbal(final int JOB, final int N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final int ILO, final int IHI, final int LSCALE, final int RSCALE, final Array<double> _WORK, final Box<int> INFO,) {
