      void cggesx(final int JOBVSL, final int JOBVSR, final int SORT, final int SELCTG, final int SENSE, final int N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final int SDIM, final int ALPHA, final int BETA, final Matrix<double> VSL, final int LDVSL, final Matrix<double> VSR, final int LDVSR, final int RCONDE, final int RCONDV, final Array<double> WORK, final int LWORK, final Array<double> RWORK, final Array<int> IWORK, final int LIWORK, final Array<bool> BWORK, final Box<int> INFO ) {
