      void shgeqz(JOB, COMPQ, COMPZ, N, ILO, IHI, final Matrix<double> H, final int LDH, final Matrix<double> T, final int LDT, ALPHAR, ALPHAI, BETA, final Matrix<double> Q, final int LDQ, final Matrix<double> Z, final int LDZ, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
