      void strsyl(final int TRANA, final int TRANB, final int ISGN, final int M, final int N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> C, final int LDC, final int SCALE, final Box<int> INFO ) {
