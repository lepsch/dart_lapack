      void cgesvdq(JOBA, JOBP, JOBR, JOBU, JOBV, M, N, final Matrix<double> A, final int LDA, S, final Matrix<double> U, final int LDU, final Matrix<double> V, final int LDV, NUMRANK, IWORK, LIWORK, CWORK, LCWORK, RWORK, LRWORK, Box<int> INFO ) {
      // .. Scalar Arguments ..
