      void chgeqz(JOB, COMPQ, COMPZ, N, ILO, IHI, final Matrix<double> H, final int LDH, final Matrix<double> T, final int LDT, ALPHA, BETA, final Matrix<double> Q, final int LDQ, final Matrix<double> Z, final int LDZ, final Array<double> WORK, final int LWORK, RWORK, final Box<int> INFO ) {
