      void cgbcon(final int NORM, final int N, final int KL, final int KU, final Matrix<double> AB_, final int LDAB, final Array<int> IPIV_, final int ANORM, final int RCOND, final Array<double> _WORK_, final Array<double> RWORK_, final Box<int> INFO,) {
  final AB = AB_.dim();
