      void cgbcon(final int NORM, final int N, final int KL, final int KU, final Matrix<double> AB, final int LDAB, final Array<int> IPIV, final int ANORM, final int RCOND, final Array<double> _WORK, final Array<double> RWORK, final Box<int> INFO ) {
