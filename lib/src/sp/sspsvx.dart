      void sspsvx(FACT, UPLO, N, NRHS, AP, AFP, IPIV, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, RCOND, FERR, BERR, WORK, IWORK, Box<int> INFO ) {
