      void cggevx(final int BALANC, final int JOBVL, final int JOBVR, final int SENSE, final int N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final int ALPHA, final int BETA, final Matrix<double> VL, final int LDVL, final Matrix<double> VR, final int LDVR, final int ILO, final int IHI, final int LSCALE, final int RSCALE, final int ABNRM, final int BBNRM, final int RCONDE, final int RCONDV, final Array<double> WORK, final int LWORK, final Array<double> RWORK, final Array<int> IWORK, final Array<bool> BWORK, final Box<int> INFO,) {
