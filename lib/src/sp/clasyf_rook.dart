...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void clasyf_rook(final int UPLO, final int N, final int NB, final int KB, final Matrix<double> A_, final int LDA, final Array<int> IPIV_, final Matrix<double> W_, final int LDW, final Box<int> INFO,) {
  final A = A_.dim();
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      double               ABSAKK, ALPHA, COLMAX, ROWMAX, STEMP, SFMIN;
      ...
      if ( lsame( UPLO, 'U' ) ) {
         ...
         J = K + 1;
            ...
            JJ = J - 1;
            if (JP1 != JJ && KSTEP == 2) cswap( N-J+1, A( JP1, J ), LDA, A( JJ, J ), LDA );
         IF( J <= N ) GO TO 60;
         ...
         J = K - 1;
            ...
            JJ = J + 1;
            if (JP1 != JJ && KSTEP == 2) cswap( J, A( JP1, 1 ), LDA, A( JJ, 1 ), LDA );
         IF( J >= 1 ) GO TO 120;
