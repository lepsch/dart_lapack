      double cla_syrpvgrw(final int UPLO, final int N, final int INFO, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, final Array<int> IPIV, final Array<double> WORK,) {
