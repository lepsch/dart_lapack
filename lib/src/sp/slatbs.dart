...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void slatbs(final int UPLO, final int TRANS, final int DIAG, final int NORMIN, final int N, final int KD, final Matrix<double> AB_, final int LDAB, final int X, final int SCALE, final int CNORM, final Box<int> INFO,) {
  final AB = AB_.dim();
