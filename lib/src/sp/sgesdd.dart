      void sgesdd(JOBZ, M, N, final Matrix<double> A, final int LDA, S, final Matrix<double> U, final int LDU, final Matrix<double> VT, final int LDVT, final Array<double> WORK, final int LWORK, IWORK, final Box<int> INFO ) {
