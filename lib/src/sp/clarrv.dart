      void clarrv(N, VL, VU, D, L, PIVMIN, ISPLIT, M, DOL, DOU, MINRGP, RTOL1, RTOL2, W, WERR, WGAP, IBLOCK, INDEXW, GERS, final Matrix<double> Z, final int LDZ, ISUPPZ, WORK, IWORK, Box<int> INFO ) {
