      void sla_geamv(final int TRANS, final int M, final int N, final int ALPHA, final Matrix<double> A, final int LDA, final int X, final int INCX, final int BETA, final int Y, final int INCY,) {
