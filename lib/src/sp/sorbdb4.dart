      void sorbdb4(M, P, Q, final Matrix<double> X11, final int LDX11, final Matrix<double> X21, final int LDX21, THETA, PHI, TAUP1, TAUP2, TAUQ1, PHANTOM, final Array<double> WORK, final int LWORK, Box<int> INFO ) {
