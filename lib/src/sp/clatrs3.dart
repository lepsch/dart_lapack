      void clatrs3(UPLO, TRANS, DIAG, NORMIN, N, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> X, final int LDX, SCALE, CNORM, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
