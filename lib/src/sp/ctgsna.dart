      void ctgsna(JOB, HOWMNY, SELECT, N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> VL, final int LDVL, final Matrix<double> VR, final int LDVR, S, DIF, MM, M, final Array<double> WORK, final int LWORK, IWORK, Box<int> INFO ) {
