      void ctgsja(JOBU, JOBV, JOBQ, M, P, N, K, L, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, TOLA, TOLB, ALPHA, BETA, final Matrix<double> U, final int LDU, final Matrix<double> V, final int LDV, final Matrix<double> Q, final int LDQ, WORK, NCYCLE, Box<int> INFO ) {
