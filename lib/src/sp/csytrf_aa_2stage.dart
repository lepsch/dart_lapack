      void csytrf_aa_2stage(final int UPLO, final int N, final Matrix<double> A, final int LDA, final int TB, final int LTB, final Array<int> IPIV, final int IPIV2, final Array<double> WORK, final int LWORK, final Box<int> INFO,) {
