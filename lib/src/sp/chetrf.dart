...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void chetrf(final int UPLO, final int N, final Matrix<double> A_, final int LDA, final Array<int> IPIV_, final Array<double> WORK_, final int LWORK, final Box<int> INFO,) {
  final A = A_.dim();
...
// =====================================================================
      ...
      if ( UPPER ) {
         ...
         if ( K <= N-NB ) {
            ...
            clahef(UPLO, N-K+1, NB, KB, A( K, K ), LDA, IPIV( K ), WORK, N, IINFO );
         } else {
