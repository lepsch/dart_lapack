...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void sspevx(final int JOBZ, final int RANGE, final int UPLO, final int N, final int AP, final int VL, final int VU, final int IL, final int IU, final int ABSTOL, final int M, final int W, final Matrix<double> Z_, final int LDZ, final Array<double> _WORK_, final Array<int> IWORK_, final int IFAIL, final Box<int> INFO,) {
  final Z = Z_.dim();
