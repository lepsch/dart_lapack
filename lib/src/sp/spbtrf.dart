      void spbtrf(final int UPLO, final int N, final int KD, final Matrix<double> AB_, final int LDAB, final Box<int> INFO,) {
  final AB = AB_.dim();
            ...
            for (I = 1; NB < 0 ? I >= N : I <= N; I += NB) { // 70
               ...
               if ( I+IB <= N ) {
                  ...
                  if ( I3 > 0 ) {
                     ...
                     if (I2 > 0) sgemm( 'Transpose', 'No Transpose', I2, I3, IB, -ONE, AB( KD+1-IB, I+IB ), LDAB-1, WORK, LDWORK, ONE, AB( 1+IB, I+KD ), LDAB-1 );
            ...
            for (I = 1; NB < 0 ? I >= N : I <= N; I += NB) { // 140
               ...
               if ( I+IB <= N ) {
                  ...
                  if ( I3 > 0 ) {
                     ...
                     if (I2 > 0) sgemm( 'No transpose', 'Transpose', I3, I2, IB, -ONE, WORK, LDWORK, AB( 1+IB, I ), LDAB-1, ONE, AB( 1+KD-IB, I+IB ), LDAB-1 );
