      void shseqr(JOB, COMPZ, N, ILO, IHI, final Matrix<double> H, final int LDH, WR, WI, final Matrix<double> Z, final int LDZ, final Array<double> WORK, final int LWORK, Box<int> INFO ) {
