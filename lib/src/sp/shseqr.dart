      void shseqr(final int JOB, final int COMPZ, final int N, final int ILO, final int IHI, final Matrix<double> H_, final int LDH, final int WR, final int WI, final Matrix<double> Z_, final int LDZ, final Array<double> WORK_, final int LWORK, final Box<int> INFO,) {
  final H = H_.dim();
  final Z = Z_.dim();
