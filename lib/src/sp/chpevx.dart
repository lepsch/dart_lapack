      void chpevx(JOBZ, RANGE, UPLO, N, AP, VL, VU, IL, IU, ABSTOL, M, W, final Matrix<double> Z, final int LDZ, final Array<double> _WORK, final Array<double> RWORK, final Array<int> IWORK, IFAIL, final Box<int> INFO ) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      if ( N == 1 ) {
         if ( ALLEIG || INDEIG ) {
            ...
            if ( VL < REAL( AP( 1 ) ) && VU >= double( AP( 1 ) ) ) {
               M = 1;
               W[1] = double( AP( 1 ) );
            }
         }
