      void chpevx(JOBZ, RANGE, UPLO, N, AP, VL, VU, IL, IU, ABSTOL, M, W, final Matrix<double> Z, final int LDZ, WORK, final Array<double> RWORK, final Array<int> IWORK, IFAIL, final Box<int> INFO ) {
