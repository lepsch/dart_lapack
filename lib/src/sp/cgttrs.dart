      void cgttrs(final int TRANS, final int N, final int NRHS, final int DL, final int D, final int DU, final int DU2, final Array<int> IPIV_, final Matrix<double> B_, final int LDB, final Box<int> INFO,) {
