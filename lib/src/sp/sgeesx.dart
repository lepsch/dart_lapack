      void sgeesx(JOBVS, SORT, SELECT, SENSE, N, final Matrix<double> A, final int LDA, SDIM, WR, WI, final Matrix<double> VS, final int LDVS, RCONDE, RCONDV, final Array<double> WORK, final int LWORK, final Array<int> IWORK, final int LIWORK, BWORK, Box<int> INFO ) {
