...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void sgeesx(final int JOBVS, final int SORT, final int SELECT, final int SENSE, final int N, final Matrix<double> A_, final int LDA, final int SDIM, final int WR, final int WI, final Matrix<double> VS_, final int LDVS, final int RCONDE, final int RCONDV, final Array<double> WORK_, final int LWORK, final Array<int> IWORK_, final int LIWORK, final Array<bool> BWORK_, final Box<int> INFO,) {
  final A = A_.dim();
  final VS = VS_.dim();
