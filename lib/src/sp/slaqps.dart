...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void slaqps(final int M, final int N, final int OFFSET, final int NB, final int KB, final Matrix<double> A_, final int LDA, final int JPVT, final int TAU, final int VN1, final int VN2, final int AUXV, final int F, final int LDF,) {
  final A = A_.dim();
