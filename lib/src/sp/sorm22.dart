      void sorm22(SIDE, TRANS, M, N, N1, N2, final Matrix<double> Q, final int LDQ, final Matrix<double> C, final int LDC, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
