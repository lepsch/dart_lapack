      void chetri_3x(final int UPLO, final int N, final Matrix<double> A_, final int LDA, final int E, final Array<int> IPIV_, final Array<double> _WORK_, final int NB, final Box<int> INFO,) {
  final A = A_.dim();
