      void sorbdb5(final int M1, final int M2, final int N, final int X1, final int INCX1, final int X2, final int INCX2, final Matrix<double> Q1_, final int LDQ1, final Matrix<double> Q2_, final int LDQ2, final Array<double> WORK_, final int LWORK, final Box<int> INFO,) {
  final Q1 = Q1_.dim();
  final Q2 = Q2_.dim();
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      for (I = 1; I <= M1; I++) {
         ...
         CALL SORBDB6( M1, M2, N, X1, INCX1, X2, INCX2, Q1, LDQ1, Q2, LDQ2, WORK, LWORK, CHILDINFO )          IF( SNRM2(M1,X1,INCX1) != REALZERO || SNRM2(M2,X2,INCX2) != REALZERO ) THEN;
            return;
         }
      }
