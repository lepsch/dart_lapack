      void sgeqp3rk(M, N, NRHS, KMAX, ABSTOL, RELTOL, final Matrix<double> A, final int LDA, K, MAXC2NRMK, RELMAXC2NRMK, JPIV, TAU, final Array<double> WORK, final int LWORK, IWORK, Box<int> INFO ) {
