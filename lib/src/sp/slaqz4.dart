      void slaqz4(final int ILSCHUR, final int ILQ, final int ILZ, final int N, final int ILO, final int IHI, final int NSHIFTS, final int NBLOCK_DESIRED, final int SR, final int SI, final int SS, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> Q, final int LDQ, final Matrix<double> Z, final int LDZ, final Matrix<double> QC, final int LDQC, final Matrix<double> ZC, final int LDZC, final Array<double> WORK, final int LWORK, final Box<int> INFO,) {
      // Function arguments
