      void sgeev(JOBVL, JOBVR, N, final Matrix<double> A, final int LDA, WR, WI, final Matrix<double> VL, final int LDVL, final Matrix<double> VR, final int LDVR, WORK, LWORK, Box<int> INFO ) {
