      double cla_porcond_c(UPLO, N, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, C, CAPPLY, INFO, final Array<double> _WORK, final Array<double> RWORK) {
