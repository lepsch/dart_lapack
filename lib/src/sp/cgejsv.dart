      void cgejsv(final int JOBA, final int JOBU, final int JOBV, final int JOBR, final int JOBT, final int JOBP, final int M, final int N, final Matrix<double> A, final int LDA, final int SVA, final Matrix<double> U, final int LDU, final Matrix<double> V, final int LDV, final int CWORK, final int LWORK, final Array<int> RWORK, final int LRWORK, final Array<int> IWORK, final Box<int> INFO,) {
...
// 8991    CONTINUE
         ...
         if (ROWPIV) claswp( N1, U, LDU, 1, M-1, IWORK(IWOFF+1), -1 );
...
// [TP]       COND_OK is a tuning parameter.
      ...
      // $                     V(q,p) = TEMP1 * ( V(q,p) / ABS(V(q,p)) ) V(q,p) = CTEMP
               ...
               if (NR != N) clacpy( 'A', N, NR, V, LDV, CWORK(2*N+1), N );
               // .. save ...
