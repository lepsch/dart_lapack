      void sgbcon(NORM, N, KL, KU, final Matrix<double> AB, final int LDAB, final Array<int> IPIV, ANORM, RCOND, final Array<double> _WORK, final Array<int> IWORK, final Box<int> INFO ) {
