      void ctrexc(COMPQ, N, final Matrix<double> T, final int LDT, final Matrix<double> Q, final int LDQ, IFST, ILST, final Box<int> INFO ) {
...
// =====================================================================
      ...
      for (K = IFST + M1; M3 < 0 ? K >= ILST + M2 : K <= ILST + M2; K += M3) { // 10
         ...
         if (K+2 <= N) crot( N-K-1, T( K, K+2 ), LDT, T( K+1, K+2 ), LDT, CS, SN );
