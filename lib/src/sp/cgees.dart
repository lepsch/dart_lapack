      void cgees(final int JOBVS, final int SORT, final int SELECT, final int N, final Matrix<double> A, final int LDA, final int SDIM, final int W, final Matrix<double> VS, final int LDVS, final Array<double> WORK, final int LWORK, final Array<double> RWORK, final Array<bool> BWORK, final Box<int> INFO,) {
