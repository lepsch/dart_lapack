      void ssteqr(COMPZ, N, D, E, final Matrix<double> Z, final int LDZ, final Array<double> _WORK, final Box<int> INFO ) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      if ( LEND > L ) {
         ...
         if ( M == L+1 ) {
            if ( ICOMPZ > 0 ) {
               ...
               WORK[L] = C;
               WORK[N-1+L] = S;
               slasr('R', 'V', 'B', N, 2, WORK( L ), WORK( N-1+L ), Z( 1, L ), LDZ );
            } else {
         ...
         if ( ICOMPZ > 0 ) {
            MM = M - L + 1;
            slasr('R', 'V', 'B', N, MM, WORK( L ), WORK( N-1+L ), Z( 1, L ), LDZ );
         }
         ...
         if ( M == L-1 ) {
            if ( ICOMPZ > 0 ) {
               ...
               WORK[M] = C;
               WORK[N-1+M] = S;
               slasr('R', 'V', 'F', N, 2, WORK( M ), WORK( N-1+M ), Z( 1, L-1 ), LDZ );
            } else {
         ...
         if ( ICOMPZ > 0 ) {
            MM = L - M + 1;
            slasr('R', 'V', 'F', N, MM, WORK( M ), WORK( N-1+M ), Z( 1, M ), LDZ );
         }
      ...
      if ( ISCALE == 1 ) {
         slascl('G', 0, 0, SSFMAX, ANORM, LENDSV-LSV+1, 1, D( LSV ), N, INFO );
         slascl('G', 0, 0, SSFMAX, ANORM, LENDSV-LSV, 1, E( LSV ), N, INFO );
      } else if ( ISCALE == 2 ) {
         slascl('G', 0, 0, SSFMIN, ANORM, LENDSV-LSV+1, 1, D( LSV ), N, INFO );
         slascl('G', 0, 0, SSFMIN, ANORM, LENDSV-LSV, 1, E( LSV ), N, INFO );
      }
