      void sla_gbamv(final int TRANS, final int M, final int N, final int KL, final int KU, final int ALPHA, final Matrix<double> AB, final int LDAB, final int X, final int INCX, final int BETA, final int Y, final int INCY) {
