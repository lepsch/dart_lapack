      void sbbcsd(final int JOBU1, final int JOBU2, final int JOBV1T, final int JOBV2T, final int TRANS, final int M, final int P, final int Q, final int THETA, final int PHI, final Matrix<double> U1, final int LDU1, final Matrix<double> U2, final int LDU2, final Matrix<double> V1T, final int LDV1T, final Matrix<double> V2T, final int LDV2T, final int B11D, final int B11E, final int B12D, final int B12E, final int B21D, final int B21E, final int B22D, final int B22E, final Array<double> WORK, final int LWORK, final Box<int> INFO,) {
