      void clarfb_gett(final int IDENT, final int M, final int N, final int K, final Matrix<double> T_, final int LDT, final Matrix<double> A_, final int LDA, final Matrix<double> B_, final int LDB, final Array<double> _WORK_, final int LDWORK,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  final _WORK = _WORK_.dim();
      ...
      if ( N > K ) {
         ...
         if ( M > 0 ) {
            cgemm('C', 'N', K, N-K, M, CONE, B, LDB, B( 1, K+1 ), LDB, CONE, WORK, LDWORK );
         }

         // col2_(4) Compute W2: = T * W2,
         // T is upper-triangular.

         ctrmm('L', 'U', 'N', 'N', K, N-K, CONE, T, LDT, WORK, LDWORK );

         // col2_(5) Compute B2: = B2 - V2 * W2 = B2 - B1 * W2,
         // V2 stored in B1.

         if ( M > 0 ) {
            cgemm('N', 'N', M, N-K, K, -CONE, B, LDB, WORK, LDWORK, CONE, B( 1, K+1 ), LDB );
         }
         ...
         if ( LNOTIDENT ) {
            ...
            ctrmm('L', 'L', 'N', 'U', K, N-K, CONE, A, LDA, WORK, LDWORK );
         }
      ...
      if ( LNOTIDENT ) {
         ...
         ctrmm('L', 'L', 'C', 'U', K, K, CONE, A, LDA, WORK, LDWORK );
      }
      ...
      if ( LNOTIDENT ) {
         ...
         ctrmm('L', 'L', 'N', 'U', K, K, CONE, A, LDA, WORK, LDWORK );
