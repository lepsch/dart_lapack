      void slaed7(ICOMPQ, N, QSIZ, TLVLS, CURLVL, CURPBM, D, final Matrix<double> Q, final int LDQ, INDXQ, RHO, CUTPNT, QSTORE, QPTR, PRMPTR, PERM, GIVPTR, GIVCOL, GIVNUM, WORK, IWORK, Box<int> INFO ) {
