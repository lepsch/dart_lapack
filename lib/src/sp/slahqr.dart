      void slahqr(final int WANTT, final int WANTZ, final int N, final int ILO, final int IHI, final Matrix<double> H, final int LDH, final int WR, final int WI, final int ILOZ, final int IHIZ, final Matrix<double> Z, final int LDZ, final Box<int> INFO ) {
...
// =========================================================
      ...
      if ( L == I ) {
         ...
         if ( WANTT ) {
            ...
            if (I2 > I) srot( I2-I, H( I-1, I+1 ), LDH, H( I, I+1 ), LDH, CS, SN );
