...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void ssytrd_2stage(final int VECT, final int UPLO, final int N, final Matrix<double> A_, final int LDA, final int D, final int E, final int TAU, final int HOUS2, final int LHOUS2, final Array<double> WORK_, final int LWORK, final Box<int> INFO,) {
  final A = A_.dim();
...
// =====================================================================
      ...
      ABPOS = 1;
      WPOS  = ABPOS + LDAB*N;
      ssytrd_sy2sb(UPLO, N, KD, A, LDA, WORK( ABPOS ), LDAB, TAU, WORK( WPOS ), LWRK, INFO );
      if ( INFO != 0 ) {
         xerbla('SSYTRD_SY2SB', -INFO );
         return;
      }
      ssytrd_sb2st('Y', VECT, UPLO, N, KD, WORK( ABPOS ), LDAB, D, E, HOUS2, LHOUS2, WORK( WPOS ), LWRK, INFO );
      if ( INFO != 0 ) {
