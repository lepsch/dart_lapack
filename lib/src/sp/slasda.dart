      void slasda(ICOMPQ, SMLSIZ, N, SQRE, D, E, final Matrix<double> U, final int LDU, VT, K, DIFL, DIFR, Z, POLES, GIVPTR, GIVCOL, LDGCOL, PERM, GIVNUM, C, S, WORK, IWORK, Box<int> INFO ) {
