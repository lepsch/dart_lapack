      void clahef_rk(final int UPLO, final int N, final int NB, final int KB, final Matrix<double> A, final int LDA, final int E, final Array<int> IPIV, final Matrix<double> W, final int LDW, final Box<int> INFO ) {
