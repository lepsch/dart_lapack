      void slasy2(LTRANL, LTRANR, ISGN, N1, N2, final Matrix<double> TL, final int LDTL, final Matrix<double> TR, final int LDTR, final Matrix<double> B, final int LDB, SCALE, final Matrix<double> X, final int LDX, XNORM, final Box<int> INFO ) {
