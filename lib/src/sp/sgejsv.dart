      void sgejsv(final int JOBA, final int JOBU, final int JOBV, final int JOBR, final int JOBT, final int JOBP, final int M, final int N, final Matrix<double> A, final int LDA, final int SVA, final Matrix<double> U, final int LDU, final Matrix<double> V, final int LDV, final Array<double> WORK, final int LWORK, final Array<int> IWORK, final Box<int> INFO ) {
