...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void csyequb(final int UPLO, final int N, final Matrix<double> A_, final int LDA, final int S, final int SCOND, final int AMAX, final Array<double> _WORK_, final Box<int> INFO,) {
  final A = A_.dim();
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      for (ITER = 1; ITER <= MAX_ITER; ITER++) {
         ...
         for (I = 1; I <= N; I++) {
            ...
            SI = S( I );
            C2 = ( N-1 ) * T;
            C1 = REAL( N-2 ) * ( double( WORK( I ) ) - T*SI );
            C0 = -(T*SI)*SI + 2 * double( WORK( I ) ) * SI - N*AVG;
            D = C1*C1 - 4*C0*C2;
