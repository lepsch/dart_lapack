      void chseqr(final int JOB, final int COMPZ, final int N, final int ILO, final int IHI, final Matrix<double> H, final int LDH, final int W, final Matrix<double> Z, final int LDZ, final Array<double> WORK, final int LWORK, final Box<int> INFO,) {
