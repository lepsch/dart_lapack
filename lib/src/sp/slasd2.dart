...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void slasd2(final int NL, final int NR, final int SQRE, final int K, final int D, final int Z, final int ALPHA, final int BETA, final Matrix<double> U_, final int LDU, final Matrix<double> VT_, final int LDVT, final int DSIGMA, final Matrix<double> U2_, final int LDU2, final Matrix<double> VT2_, final int LDVT2, final int IDXP, final int IDX, final int IDXC, final int IDXQ, final int COLTYP, final Box<int> INFO,) {
  final U = U_.dim();
  final VT = VT_.dim();
  final U2 = U2_.dim();
  final VT2 = VT2_.dim();
