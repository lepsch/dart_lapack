      void ctrsna(final int JOB, final int HOWMNY, final int SELECT, final int N, final Matrix<double> T, final int LDT, final Matrix<double> VL, final int LDVL, final Matrix<double> VR, final int LDVR, final int S, final int SEP, final int MM, final int M, final Matrix<double> WORK, final int LDWORK, final Array<double> RWORK, final Box<int> INFO ) {
