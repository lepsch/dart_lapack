      void strsen(JOB, COMPQ, SELECT, N, final Matrix<double> T, final int LDT, final Matrix<double> Q, final int LDQ, WR, WI, M, S, SEP, WORK, LWORK, IWORK, LIWORK, Box<int> INFO ) {
