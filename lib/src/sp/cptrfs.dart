...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void cptrfs(final int UPLO, final int N, final int NRHS, final int D, final int E, final int DF, final int EF, final Matrix<double> B_, final int LDB, final Matrix<double> X_, final int LDX, final int FERR, final int BERR, final Array<double> _WORK_, final Array<double> RWORK_, final Box<int> INFO,) {
  final B = B_.dim();
  final X = X_.dim();
