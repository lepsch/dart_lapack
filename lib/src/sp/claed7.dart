      void claed7(final int N, final int CUTPNT, final int QSIZ, final int TLVLS, final int CURLVL, final int CURPBM, final int D, final Matrix<double> Q, final int LDQ, final int RHO, final int INDXQ, final int QSTORE, final int QPTR, final int PRMPTR, final int PERM, final int GIVPTR, final int GIVCOL, final int GIVNUM, final Array<double> _WORK, final Array<double> RWORK, final Array<int> IWORK, final Box<int> INFO,) {
