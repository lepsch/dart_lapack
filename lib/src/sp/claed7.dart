      void claed7(N, CUTPNT, QSIZ, TLVLS, CURLVL, CURPBM, D, final Matrix<double> Q, final int LDQ, RHO, INDXQ, QSTORE, QPTR, PRMPTR, PERM, GIVPTR, GIVCOL, GIVNUM, WORK, RWORK, IWORK, final Box<int> INFO ) {
