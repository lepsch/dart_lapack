      void cggsvd3(final int JOBU, final int JOBV, final int JOBQ, final int M, final int N, final int P, final int K, final int L, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final int ALPHA, final int BETA, final Matrix<double> U, final int LDU, final Matrix<double> V, final int LDV, final Matrix<double> Q, final int LDQ, final Array<double> WORK, final int LWORK, final Array<double> RWORK, final Array<int> IWORK, final Box<int> INFO ) {
