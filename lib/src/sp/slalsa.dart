      void slalsa(ICOMPQ, SMLSIZ, N, NRHS, final Matrix<double> B, final int LDB, final Matrix<double> BX, final int LDBX, final Matrix<double> U, final int LDU, VT, K, DIFL, DIFR, Z, POLES, GIVPTR, GIVCOL, LDGCOL, PERM, GIVNUM, C, S, WORK, IWORK, Box<int> INFO ) {
