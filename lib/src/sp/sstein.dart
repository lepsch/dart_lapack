      void sstein(final int N, final int D, final int E, final int M, final int W, final int IBLOCK, final int ISPLIT, final Matrix<double> Z, final int LDZ, final Array<double> _WORK, final Array<int> IWORK, final int IFAIL, final Box<int> INFO,) {
