      void cggbal(final int JOB, final int N, final Matrix<double> A_, final int LDA, final Matrix<double> B_, final int LDB, final int ILO, final int IHI, final int LSCALE, final int RSCALE, final Array<double> _WORK_, final Box<int> INFO,) {
  final A = A_.dim();
  final B = B_.dim();
