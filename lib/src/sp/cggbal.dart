      void cggbal(JOB, N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, ILO, IHI, LSCALE, RSCALE, final Array<double> _WORK, final Box<int> INFO ) {
