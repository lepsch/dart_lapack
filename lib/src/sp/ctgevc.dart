      void ctgevc(SIDE, HOWMNY, SELECT, N, final Matrix<double> S, final int LDS, final Matrix<double> P, final int LDP, final Matrix<double> VL, final int LDVL, final Matrix<double> VR, final int LDVR, MM, M, WORK, RWORK, Box<int> INFO ) {
