      void ctgevc(final int SIDE, final int HOWMNY, final int SELECT, final int N, final Matrix<double> S, final int LDS, final Matrix<double> P, final int LDP, final Matrix<double> VL, final int LDVL, final Matrix<double> VR, final int LDVR, final int MM, final int M, final Array<double> _WORK, final Array<double> RWORK, final Box<int> INFO ) {
