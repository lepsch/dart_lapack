      void cuncsd2by1(JOBU1, JOBU2, JOBV1T, M, P, Q, final Matrix<double> X11, final int LDX11, final Matrix<double> X21, final int LDX21, THETA, final Matrix<double> U1, final int LDU1, final Matrix<double> U2, final int LDU2, final Matrix<double> V1T, final int LDV1T, WORK, LWORK, RWORK, LRWORK, IWORK, Box<int> INFO ) {
