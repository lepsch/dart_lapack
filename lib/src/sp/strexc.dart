      void strexc(final int COMPQ, final int N, final Matrix<double> T, final int LDT, final Matrix<double> Q, final int LDQ, final int IFST, final int ILST, final Array<double> _WORK, final Box<int> INFO ) {
