      void cgeesx(final int JOBVS, final int SORT, final int SELECT, final int SENSE, final int N, final Matrix<double> A_, final int LDA, final int SDIM, final int W, final Matrix<double> VS_, final int LDVS, final int RCONDE, final int RCONDV, final Array<double> WORK_, final int LWORK, final Array<double> RWORK_, final Array<bool> BWORK_, final Box<int> INFO,) {
  final A = A_.dim();
  final VS = VS_.dim();
