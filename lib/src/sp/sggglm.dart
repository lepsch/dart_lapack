...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void sggglm(final int N, final int M, final int P, final Matrix<double> A_, final int LDA, final Matrix<double> B_, final int LDB, final int D, final int X, final int Y, final Array<double> WORK_, final int LWORK, final Box<int> INFO,) {
  final A = A_.dim();
  final B = B_.dim();
