      void sgesvj(JOBA, JOBU, JOBV, M, N, final Matrix<double> A, final int LDA, SVA, MV, final Matrix<double> V, final int LDV, final Array<double> WORK, final int LWORK, Box<int> INFO ) {
