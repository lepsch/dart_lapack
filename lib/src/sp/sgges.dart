      void sgges(JOBVSL, JOBVSR, SORT, SELCTG, N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, SDIM, ALPHAR, ALPHAI, BETA, final Matrix<double> VSL, final int LDVSL, final Matrix<double> VSR, final int LDVSR, WORK, LWORK, BWORK, Box<int> INFO ) {
