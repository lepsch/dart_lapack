      void sopmtr(final int SIDE, final int UPLO, final int TRANS, final int M, final int N, final int AP, final int TAU, final Matrix<double> C, final int LDC, final Array<double> _WORK, final Box<int> INFO ) {
