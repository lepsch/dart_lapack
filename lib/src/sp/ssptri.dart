      void ssptri(final int UPLO, final int N, final int AP, final Array<int> IPIV_, final Array<double> _WORK_, final Box<int> INFO,) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      if ( UPPER ) {
         ...
         if ( KP != K ) {
            ...
            if (KP < N) sswap( N-KP, AP( KC+KP-K+1 ), 1, AP( KPC+1 ), 1 );
            KX = KC + KP - K;
