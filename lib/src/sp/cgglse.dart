      void cgglse(M, N, P, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, C, D, X, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
