...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void sgelsd(final int M, final int N, final int NRHS, final Matrix<double> A_, final int LDA, final Matrix<double> B_, final int LDB, final int S, final int RCOND, final int RANK, final Array<double> WORK_, final int LWORK, final Array<int> IWORK_, final Box<int> INFO,) {
  final A = A_.dim();
  final B = B_.dim();
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      if (M < N) slaset( 'F', N-M, NRHS, ZERO, ZERO, B( M+1, 1 ), LDB );
