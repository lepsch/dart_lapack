      void sstevx(JOBZ, RANGE, N, D, E, VL, VU, IL, IU, ABSTOL, M, W, final Matrix<double> Z, final int LDZ, final Array<double> _WORK, final Array<int> IWORK, IFAIL, final Box<int> INFO ) {
