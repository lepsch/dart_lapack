      void cheevd_2stage(JOBZ, UPLO, N, final Matrix<double> A, final int LDA, W, final Array<double> WORK, final int LWORK, final Array<int> RWORK, final int LRWORK, final Array<int> IWORK, final int LIWORK, final Box<int> INFO ) {
