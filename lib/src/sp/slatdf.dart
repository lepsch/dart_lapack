      void slatdf(final int IJOB, final int N, final Matrix<double> Z, final int LDZ, final int RHS, final int RDSUM, final int RDSCAL, final Array<int> IPIV, final int JPIV) {
