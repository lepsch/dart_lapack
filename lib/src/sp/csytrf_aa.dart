      void csytrf_aa(final int UPLO, final int N, final Matrix<double> A_, final int LDA, final Array<int> IPIV_, final Array<double> WORK_, final int LWORK, final Box<int> INFO,) {
  final A = A_.dim();
         ...
         if ( J < N ) {
            ...
            if ( J1 > 1 || JB > 1 ) {
               ...
               for (J2 = J+1; NB < 0 ? J2 >= N : J2 <= N; J2 += NB) {
                  ...
                  cgemm('Transpose', 'Transpose', NJ, N-J3+1, JB+1, -ONE, A( J1-K2, J2 ), LDA, WORK( J3-J1+1+K1*N ), N, ONE, A( J2, J3 ), LDA );
               }
         ...
         if ( J < N ) {
            ...
            if ( J1 > 1 || JB > 1 ) {
               ...
               for (J2 = J+1; NB < 0 ? J2 >= N : J2 <= N; J2 += NB) {
                  ...
                  cgemm('No transpose', 'Transpose', N-J3+1, NJ, JB+1, -ONE, WORK( J3-J1+1+K1*N ), N, A( J2, J1-K2 ), LDA, ONE, A( J3, J2 ), LDA );
               }
