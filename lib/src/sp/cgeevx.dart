      void cgeevx(BALANC, JOBVL, JOBVR, SENSE, N, final Matrix<double> A, final int LDA, W, final Matrix<double> VL, final int LDVL, final Matrix<double> VR, final int LDVR, ILO, IHI, SCALE, ABNRM, RCONDE, RCONDV, final Array<double> WORK, final int LWORK, RWORK, final Box<int> INFO ) {
