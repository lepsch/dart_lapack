      void ssytrf_aa_2stage(UPLO, N, final Matrix<double> A, final int LDA, TB, LTB, final Array<int> IPIV, IPIV2, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
