      void sla_syamv(final int UPLO, final int N, final int ALPHA, final Matrix<double> A_, final int LDA, final int X, final int INCX, final int BETA, final int Y, final int INCY,) {
  final A = A_.dim();
