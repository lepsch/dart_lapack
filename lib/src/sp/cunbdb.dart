...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void cunbdb(final int TRANS, final int SIGNS, final int M, final int P, final int Q, final Matrix<double> X11_, final int LDX11, final Matrix<double> X12_, final int LDX12, final Matrix<double> X21_, final int LDX21, final Matrix<double> X22_, final int LDX22, final int THETA, final int PHI, final int TAUP1, final int TAUP2, final int TAUQ1, final int TAUQ2, final Array<double> WORK_, final int LWORK, final Box<int> INFO,) {
  final X11 = X11_.dim();
  final X12 = X12_.dim();
  final X21 = X21_.dim();
  final X22 = X22_.dim();
...
// ====================================================================
      ...
      if ( COLMAJOR ) {
         ...
         for (I = 1; I <= Q; I++) {
            ...
            if (I < Q) clacgv( Q-I, X11(I,I+1), LDX11 );
            clacgv(M-Q-I+1, X12(I,I), LDX12 );
         ...
         for (I = Q + 1; I <= P; I++) {
            ...
            if (M-P-Q >= 1) clarf( 'R', M-P-Q, M-Q-I+1, X12(I,I), LDX12, TAUQ2(I), X22(Q+1,I), LDX22, WORK );
         ...
         for (I = Q + 1; I <= P; I++) {
            ...
            if (M-P-Q >= 1) clarf( 'L', M-Q-I+1, M-P-Q, X12(I,I), 1, CONJG(TAUQ2(I)), X22(I,Q+1), LDX22, WORK );
