      void cgsvj1(JOBV, M, N, N1, final Matrix<double> A, final int LDA, D, SVA, MV, final Matrix<double> V, final int LDV, EPS, SFMIN, TOL, NSWEEP, final Array<double> WORK, final int LWORK, Box<int> INFO ) {
