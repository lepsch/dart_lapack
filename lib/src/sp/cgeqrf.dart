      void cgeqrf(final int M, final int N, final Matrix<double> A_, final int LDA, final int TAU, final Array<double> WORK_, final int LWORK, final Box<int> INFO,) {
  final A = A_.dim();
...
// =====================================================================
      ...
      if ( NB >= NBMIN && NB < K && NX < K ) {
         ...
         for (I = 1; NB < 0 ? I >= K - NX : I <= K - NX; I += NB) { // 10
            ...
            cgeqr2(M-I+1, IB, A( I, I ), LDA, TAU( I ), WORK, IINFO );
            if ( I+IB <= N ) {
