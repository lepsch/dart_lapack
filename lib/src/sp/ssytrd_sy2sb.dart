      void ssytrd_sy2sb(UPLO, N, KD, final Matrix<double> A, final int LDA, final Matrix<double> AB, final int LDAB, TAU, final Array<double> WORK, final int LWORK, Box<int> INFO ) {
