      void strsyl3(TRANA, TRANB, ISGN, M, N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> C, final int LDC, SCALE, final Array<int> IWORK, final int LIWORK, final Matrix<double> SWORK, final int LDSWORK, Box<int> INFO ) {
      String             TRANA, TRANB;
