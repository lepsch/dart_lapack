...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void ctrcon(final int NORM, final int UPLO, final int DIAG, final int N, final Matrix<double> A_, final int LDA, final int RCOND, final Array<double> _WORK_, final Array<double> RWORK_, final Box<int> INFO,) {
  final A = A_.dim();
      ...
      if ( ANORM > ZERO ) {
         ...
         if ( KASE != 0 ) {
            if ( KASE == KASE1 ) {
               ...
               clatrs(UPLO, 'No transpose', DIAG, NORMIN, N, A, LDA, WORK, SCALE, RWORK, INFO );
            } else {

               // Multiply by inv(A**H).

               clatrs(UPLO, 'Conjugate transpose', DIAG, NORMIN, N, A, LDA, WORK, SCALE, RWORK, INFO );
            }
            NORMIN = 'Y';
