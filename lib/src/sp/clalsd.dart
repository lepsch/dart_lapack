      void clalsd(UPLO, SMLSIZ, N, NRHS, D, E, final Matrix<double> B, final int LDB, RCOND, RANK, final Array<double> _WORK, final Array<double> RWORK, final Array<int> IWORK, final Box<int> INFO ) {
