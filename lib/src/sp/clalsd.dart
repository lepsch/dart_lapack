...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void clalsd(final int UPLO, final int SMLSIZ, final int N, final int NRHS, final int D, final int E, final Matrix<double> B_, final int LDB, final int RCOND, final int RANK, final Array<double> _WORK_, final Array<double> RWORK_, final Array<int> IWORK_, final Box<int> INFO,) {
  final B = B_.dim();
