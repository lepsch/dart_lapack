      void sporfsx(UPLO, EQUED, N, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, S, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, RCOND, BERR, N_ERR_BNDS, ERR_BNDS_NORM, ERR_BNDS_COMP, NPARAMS, PARAMS, WORK, final Array<int> IWORK, final Box<int> INFO ) {
...
// ==================================================================
      ...
      double               SLAMCH, SLANSY, SLA_PORCOND;
      bool               lsame;
      int                ILAPREC;
      ...
      // cwise error is at least CWISE_WRONG.
         ...
         for (J = 1; J <= NRHS; J++) {
            if (ERR_BNDS_COMP( J, LA_LINRX_ERR_I ) < CWISE_WRONG ) {
               RCOND_TMP = SLA_PORCOND( UPLO, N, A, LDA, AF, LDAF, 1, X( 1, J ), INFO, WORK, IWORK );
            } else {
               RCOND_TMP = 0.0;
            }
