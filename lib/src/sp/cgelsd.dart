      void cgelsd(final int M, final int N, final int NRHS, final Matrix<double> A_, final int LDA, final Matrix<double> B_, final int LDB, final int S, final int RCOND, final int RANK, final Array<double> WORK_, final int LWORK, final Array<double> RWORK_, final Array<int> IWORK_, final Box<int> INFO,) {
  final A = A_.dim();
  final B = B_.dim();
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      if (M < N) claset( 'F', N-M, NRHS, CZERO, CZERO, B( M+1, 1 ), LDB );
