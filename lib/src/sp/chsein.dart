      void chsein(SIDE, EIGSRC, INITV, SELECT, N, final Matrix<double> H, final int LDH, W, final Matrix<double> VL, final int LDVL, final Matrix<double> VR, final int LDVR, MM, M, WORK, RWORK, IFAILL, IFAILR, Box<int> INFO ) {
