      void cggglm(N, M, P, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, D, X, Y, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
