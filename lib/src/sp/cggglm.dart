      void cggglm(final int N, final int M, final int P, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final int D, final int X, final int Y, final Array<double> WORK, final int LWORK, final Box<int> INFO,) {
