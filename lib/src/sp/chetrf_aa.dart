      void chetrf_aa(final int UPLO, final int N, final Matrix<double> A_, final int LDA, final Array<int> IPIV_, final Array<double> WORK_, final int LWORK, final Box<int> INFO,) {
  final A = A_.dim();
...
// =====================================================================
      ...
      if ( UPPER ) {
         ...
         clahef_aa(UPLO, 2-K1, N-J, JB, A( max(1, J), J+1 ), LDA, IPIV( J+1 ), WORK, N, WORK( N*NB+1 ) );
         ...
         clahef_aa(UPLO, 2-K1, N-J, JB, A( J+1, max(1, J) ), LDA, IPIV( J+1 ), WORK, N, WORK( N*NB+1 ) );
