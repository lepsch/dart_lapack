      void sorhr_col(final int M, final int N, final int NB, final Matrix<double> A, final int LDA, final Matrix<double> T, final int LDT, final int D, final Box<int> INFO,) {
