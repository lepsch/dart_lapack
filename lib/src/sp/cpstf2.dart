...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void cpstf2(final int UPLO, final int N, final Matrix<double> A_, final int LDA, final int PIV, final int RANK, final int TOL, final Array<double> _WORK_, final Box<int> INFO,) {
  final A = A_.dim();
