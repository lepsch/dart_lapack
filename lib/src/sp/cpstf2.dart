      void cpstf2(final int UPLO, final int N, final Matrix<double> A, final int LDA, final int PIV, final int RANK, final int TOL, final Array<double> _WORK, final Box<int> INFO ) {
