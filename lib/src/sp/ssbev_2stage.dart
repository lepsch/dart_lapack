      void ssbev_2stage(JOBZ, UPLO, N, KD, final Matrix<double> AB, final int LDAB, W, final Matrix<double> Z, final int LDZ, final Array<double> WORK, final int LWORK, Box<int> INFO ) {
