      void strrfs(final int UPLO, final int TRANS, final int DIAG, final int N, final int NRHS, final Matrix<double> A_, final int LDA, final Matrix<double> B_, final int LDB, final Matrix<double> X_, final int LDX, final int FERR, final int BERR, final Array<double> _WORK_, final Array<int> IWORK_, final Box<int> INFO,) {
  final A = A_.dim();
  final B = B_.dim();
  final X = X_.dim();
      ...
      for (J = 1; J <= NRHS; J++) { // 250
         ...
         if ( KASE != 0 ) {
            if ( KASE == 1 ) {
               ...
               strsv(UPLO, TRANST, DIAG, N, A, LDA, WORK( N+1 ), 1 );
               for (I = 1; I <= N; I++) { // 220
               ...
               strsv(UPLO, TRANS, DIAG, N, A, LDA, WORK( N+1 ), 1 );
            }
            GO TO 210;
         }
