...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void cgecon(final int NORM, final int N, final Matrix<double> A_, final int LDA, final int ANORM, final int RCOND, final Array<double> _WORK_, final Array<double> RWORK_, final Box<int> INFO,) {
  final A = A_.dim();
