      void slaqr4(WANTT, WANTZ, N, ILO, IHI, final Matrix<double> H, final int LDH, WR, WI, ILOZ, IHIZ, final Matrix<double> Z, final int LDZ, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
