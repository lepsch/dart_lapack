      void cla_porfsx_extended(final int PREC_TYPE, final int UPLO, final int N, final int NRHS, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, final int COLEQU, final int C, final Matrix<double> B, final int LDB, final Matrix<double> Y, final int LDY, final int BERR_OUT, final int N_NORMS, final int ERR_BNDS_NORM, final int ERR_BNDS_COMP, final int RES, final int AYB, final int DY, final int Y_TAIL, final int RCOND, final int ITHRESH, final int RTHRESH, final int DZ_UB, final int IGNORE_CWISE, final Box<int> INFO,) {
