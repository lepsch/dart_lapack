      void csytri2x(final int UPLO, final int N, final Matrix<double> A, final int LDA, final Array<int> IPIV, final Array<double> _WORK, final int NB, final Box<int> INFO,) {
