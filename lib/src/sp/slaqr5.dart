...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void slaqr5(final int WANTT, final int WANTZ, final int KACC22, final int N, final int KTOP, final int KBOT, final int NSHFTS, final int SR, final int SI, final Matrix<double> H_, final int LDH, final int ILOZ, final int IHIZ, final Matrix<double> Z_, final int LDZ, final Matrix<double> V_, final int LDV, final Matrix<double> U_, final int LDU, final int NV, final Matrix<double> WV_, final int LDWV, final int NH, final int WH, final int LDWH,) {
...
// ================================================================
      ...
      for (I = 1; 2 < 0 ? I >= NSHFTS - 2 : I <= NSHFTS - 2; I += 2) { // 10
         if ( SI( I ) != -SI( I+1 ) ) {
