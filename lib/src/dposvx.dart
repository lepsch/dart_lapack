...
import 'package:lapack/src/xerbla.dart';
      ...
      void dposvx(FACT, UPLO, N, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, EQUED, S, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, RCOND, FERR, BERR, WORK, final Array<int> IWORK, final Box<int> INFO ) {
