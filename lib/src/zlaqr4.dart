...
import 'package:dart_lapack/src/zlaqr2.dart';
...
void zlaqr4(
  ...
  if (N <= NTINY) {
    ...
    zlaqr2(WANTT, WANTZ, N, ILO, IHI, NWR + 1, H, LDH, ILOZ, IHIZ, Z, LDZ, LS,
      ...
      if ((LD.value == 0) ||
        ...
        if ((NDFL % KEXSH) == 0) {
          ...
          if (KBOT - KS + 1 <= NS ~/ 2) {
            ...
            zlahqr(false, false, NS, 1, NS, H(KT, 1), LDH, W(KS), 1, 1, ZDUM, 1,
                INF);
            KS += INF.value;
