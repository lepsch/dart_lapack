      double zla_porcond_x(UPLO, N, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, X, INFO, final Array<double> _WORK, final Array<double> RWORK) {
