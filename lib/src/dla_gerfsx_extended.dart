...
import 'package:lapack/src/xerbla.dart';
      ...
      void dla_gerfsx_extended(PREC_TYPE, TRANS_TYPE, N, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, final Array<int> IPIV, COLEQU, C, final Matrix<double> B, final int LDB, final Matrix<double> Y, final int LDY, BERR_OUT, N_NORMS, ERRS_N, ERRS_C, RES, AYB, DY, Y_TAIL, RCOND, ITHRESH, RTHRESH, DZ_UB, IGNORE_CWISE, final Box<int> INFO ) {
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      int                IPIV( * );
      double             A( LDA, * ), AF( LDAF, * ), B( LDB, * ), Y( LDY, * ), RES( * ), DY( * ), Y_TAIL( * );;
...
// =====================================================================
      ...
      // EXTERNAL DAXPY, DCOPY, DGETRS, DGEMV, BLAS_DGEMV_X, BLAS_DGEMV2_X, DLA_GEAMV, DLA_WWADDW, DLAMCH, CHLA_TRANSTYPE, DLA_LIN_BERR
      double             DLAMCH;
         ...
         for (CNT = 1; CNT <= ITHRESH; CNT++) {
          ...
          //     op(A) = A, A**T, or A**H depending on TRANS (and type).
            ...
            if ( Y_PREC_STATE == BASE_RESIDUAL ) {
               dgemv(TRANS, N, N, -1.0, A, LDA, Y( 1, J ), 1, 1.0, RES, 1 );
            } else if ( Y_PREC_STATE == EXTRA_RESIDUAL ) {
               blas_dgemv_x(TRANS_TYPE, N, N, -1.0, A, LDA, Y( 1, J ), 1, 1.0, RES, 1, PREC_TYPE );
            } else {
               blas_dgemv2_x(TRANS_TYPE, N, N, -1.0, A, LDA, Y( 1, J ), Y_TAIL, 1, 1.0, RES, 1, PREC_TYPE );
            }

         // XXX: RES is no longer needed.
            dcopy(N, RES, 1, DY, 1 );
            dgetrs(TRANS, N, 1, AF, LDAF, IPIV, DY, N, INFO );
      ...
      // Compute abs(op(A_s))*abs(Y) + abs(B_s).
         ...
         dla_geamv(TRANS_TYPE, N, N, 1.0, A, LDA, Y(1, J), 1, 1.0, AYB, 1 );
