      void zlals0(ICOMPQ, NL, NR, SQRE, NRHS, final Matrix<double> B, final int LDB, final Matrix<double> BX, final int LDBX, PERM, GIVPTR, GIVCOL, LDGCOL, GIVNUM, LDGNUM, POLES, DIFL, DIFR, Z, K, C, S, final Array<double> RWORK, final Box<int> INFO ) {
