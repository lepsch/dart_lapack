      void zgbbrd(final int VECT, final int M, final int N, final int NCC, final int KL, final int KU, final Matrix<double> AB_, final int LDAB, final int D, final int E, final Matrix<double> Q_, final int LDQ, final Matrix<double> PT_, final int LDPT, final Matrix<double> C_, final int LDC, final Array<double> _WORK_, final Array<double> RWORK_, final Box<int> INFO,) {
  final AB = AB_.dim();
  final Q = Q_.dim();
  final PT = PT_.dim();
  final C = C_.dim();
