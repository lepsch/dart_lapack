...
import 'package:lapack/src/xerbla.dart';
      ...
      void dgetsqrhrt(M, N, MB1, NB1, NB2, final Matrix<double> A, final int LDA, final Matrix<double> T, final int LDT, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
