      void zhetrs2(final int UPLO, final int N, final int NRHS, final Matrix<double> A_, final int LDA, final Array<int> IPIV_, final Matrix<double> B_, final int LDB, final Array<double> _WORK_, final Box<int> INFO,) {
  final A = A_.dim();
