      void zsyequb(final int UPLO, final int N, final Matrix<double> A, final int LDA, final int S, final int SCOND, final int AMAX, final Array<double> _WORK, final Box<int> INFO,) {
