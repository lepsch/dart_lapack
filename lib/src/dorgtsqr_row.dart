...
import 'package:lapack/src/xerbla.dart';
      ...
      void dorgtsqr_row(M, N, MB, NB, final Matrix<double> A, final int LDA, final Matrix<double> T, final int LDT, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
