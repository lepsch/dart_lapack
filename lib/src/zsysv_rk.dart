      void zsysv_rk(final int UPLO, final int N, final int NRHS, final Matrix<double> A_, final int LDA, final int E, final Array<int> IPIV_, final Matrix<double> B_, final int LDB, final Array<double> WORK_, final int LWORK, final Box<int> INFO,) {
  final A = A_.dim();
