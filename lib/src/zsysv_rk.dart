      void zsysv_rk(final int UPLO, final int N, final int NRHS, final Matrix<double> A, final int LDA, final int E, final Array<int> IPIV, final Matrix<double> B, final int LDB, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
