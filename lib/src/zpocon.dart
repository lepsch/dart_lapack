      void zpocon(final int UPLO, final int N, final Matrix<double> A_, final int LDA, final int ANORM, final int RCOND, final Array<double> _WORK_, final Array<double> RWORK_, final Box<int> INFO,) {
  final A = A_.dim();
