      void zgeesx(JOBVS, SORT, SELECT, SENSE, N, final Matrix<double> A, final int LDA, SDIM, W, final Matrix<double> VS, final int LDVS, RCONDE, RCONDV, final Array<double> WORK, final int LWORK, RWORK, BWORK, final Box<int> INFO ) {
