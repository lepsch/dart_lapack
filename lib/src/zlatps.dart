      void zlatps(final int UPLO, final int TRANS, final int DIAG, final int NORMIN, final int N, final int AP, final int X, final int SCALE, final int CNORM, final Box<int> INFO,) {
