...
import 'package:lapack/src/xerbla.dart';
      ...
      void dlasyf_aa(final int UPLO, final int J1, final int M, final int NB, final Matrix<double> A_, final int LDA, final Array<int> IPIV_, final Matrix<double> H_, final int LDH, final Array<double> WORK_,) {
  final A = A_.dim();
        ...
        //  } // 10
         ...
         if ( J < M ) {
            ...
            if ( (I2 != 2) && (PIV != 0) ) {
               ...
               if (I2 < M) dswap( M-I2, A( J1+I1-1, I2+1 ), LDA, A( J1+I2-1, I2+1 ), LDA );
        ...
        //  } // 30
         ...
         if ( J < M ) {
            ...
            if ( (I2 != 2) && (PIV != 0) ) {
               ...
               if (I2 < M) dswap( M-I2, A( I2+1, J1+I1-1 ), 1, A( I2+1, J1+I2-1 ), 1 );
