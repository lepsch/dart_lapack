...
import 'package:lapack/src/xerbla.dart';
      ...
      void dgeequb(final int M, final int N, final Matrix<double> A_, final int LDA, final int R, final int C, final int ROWCND, final int COLCND, final int AMAX, final Box<int> INFO,) {
  final A = A_.dim();
