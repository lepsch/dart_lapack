      double zla_syrcond_c(final int UPLO, final int N, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, final Array<int> IPIV, final int C, final int CAPPLY, final int INFO, final Array<double> _WORK, final Array<double> RWORK) {
