...
import 'package:lapack/src/xerbla.dart';
      ...
      void dgeqrt(final int M, final int N, final int NB, final Matrix<double> A, final int LDA, final Matrix<double> T, final int LDT, final Array<double> _WORK, final Box<int> INFO ) {
