      void ztrcon(final int NORM, final int UPLO, final int DIAG, final int N, final Matrix<double> A, final int LDA, final int RCOND, final Array<double> _WORK, final Array<double> RWORK, final Box<int> INFO ) {
