      void zstemr(final int JOBZ, final int RANGE, final int N, final int D, final int E, final int VL, final int VU, final int IL, final int IU, final int M, final int W, final Matrix<double> Z_, final int LDZ, final int NZC, final int ISUPPZ, final int TRYRAC, final Array<double> WORK_, final int LWORK, final Array<int> IWORK_, final int LIWORK, final Box<int> INFO,) {
  final Z = Z_.dim();
