      void zstemr(JOBZ, RANGE, N, D, E, VL, VU, IL, IU, M, W, final Matrix<double> Z, final int LDZ, NZC, ISUPPZ, TRYRAC, final Array<double> WORK, final int LWORK, final Array<int> IWORK, final int LIWORK, Box<int> INFO ) {
