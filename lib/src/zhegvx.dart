      void zhegvx(ITYPE, JOBZ, RANGE, UPLO, N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, VL, VU, IL, IU, ABSTOL, M, W, final Matrix<double> Z, final int LDZ, WORK, LWORK, RWORK, IWORK, IFAIL, Box<int> INFO ) {
