...
import 'package:lapack/src/xerbla.dart';
      ...
      void dgttrs(final int TRANS, final int N, final int NRHS, final int DL, final int D, final int DU, final int DU2, final Array<int> IPIV, final Matrix<double> B, final int LDB, final Box<int> INFO ) {
