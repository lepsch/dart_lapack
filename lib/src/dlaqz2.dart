...
void dlaqz2(
  ...
  if (K + 2 == IHI) {
    ...
    drot(
      IHI - ISTARTM + 1,
      B(ISTARTM, IHI).asArray(),
      1,
      B(ISTARTM, IHI - 1).asArray(),
      1,
      C1.value,
      S1.value,
    );
    ...
    drot(
      IHI - ISTARTM + 1,
      A(ISTARTM, IHI).asArray(),
      1,
      A(ISTARTM, IHI - 1).asArray(),
      1,
      C1.value,
      S1.value,
    );
    ...
    if (ILZ) {
      drot(
        NZ,
        Z(1, IHI - ZSTART + 1).asArray(),
        1,
        Z(1, IHI - 1 - ZSTART + 1).asArray(),
        1,
        C1.value,
        S1.value,
      );
    ...
    if (ILQ) {
      drot(
        NQ,
        Q(1, IHI - 1 - QSTART + 1).asArray(),
        1,
        Q(1, IHI - QSTART + 1).asArray(),
        1,
        C1.value,
        S1.value,
      );
    ...
    drot(
      K + 3 - ISTARTM + 1,
      A(ISTARTM, K + 2).asArray(),
      1,
      A(ISTARTM, K + 1).asArray(),
      1,
      C1.value,
      S1.value,
    );
    ...
    drot(
      K + 2 - ISTARTM + 1,
      B(ISTARTM, K + 2).asArray(),
      1,
      B(ISTARTM, K + 1).asArray(),
      1,
      C1.value,
      S1.value,
    );
    ...
    if (ILZ) {
      drot(
        NZ,
        Z(1, K + 2 - ZSTART + 1).asArray(),
        1,
        Z(1, K + 1 - ZSTART + 1).asArray(),
        1,
        C1.value,
        S1.value,
      );
    ...
    if (ILQ) {
      drot(
        NQ,
        Q(1, K + 2 - QSTART + 1).asArray(),
        1,
        Q(1, K + 3 - QSTART + 1).asArray(),
        1,
        C1.value,
        S1.value,
      );
