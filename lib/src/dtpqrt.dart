...
import 'package:lapack/src/xerbla.dart';
      ...
      void dtpqrt(M, N, L, NB, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> T, final int LDT, WORK, final Box<int> INFO ) {
