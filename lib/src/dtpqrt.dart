...
import 'package:lapack/src/xerbla.dart';
      ...
      void dtpqrt(final int M, final int N, final int L, final int NB, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final Matrix<double> T, final int LDT, final Array<double> _WORK, final Box<int> INFO ) {
