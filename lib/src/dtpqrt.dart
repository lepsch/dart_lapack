...
import 'package:lapack/src/xerbla.dart';
      ...
      void dtpqrt(final int M, final int N, final int L, final int NB, final Matrix<double> A_, final int LDA, final Matrix<double> B_, final int LDB, final Matrix<double> T_, final int LDT, final Array<double> _WORK_, final Box<int> INFO,) {
  final A = A_.dim();
  final B = B_.dim();
  final T = T_.dim();
