...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsyevd_2stage(JOBZ, UPLO, N, final Matrix<double> A, final int LDA, W, final Array<double> WORK, final int LWORK, final Array<int> IWORK, final int LIWORK, final Box<int> INFO ) {
