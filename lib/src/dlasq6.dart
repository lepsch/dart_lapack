...
import 'package:lapack/src/xerbla.dart';
      ...
      void dlasq6(final int I0, final int N0, final int Z, final int PP, final int DMIN, final int DMIN1, final int DMIN2, final int DN, final int DNM1, final int DNM2) {
