...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsytrd_sy2sb(final int UPLO, final int N, final int KD, final Matrix<double> A, final int LDA, final Matrix<double> AB, final int LDAB, final int TAU, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
