...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsyconvf_rook(final int UPLO, final int WAY, final int N, final Matrix<double> A_, final int LDA, final int E, final Array<int> IPIV_, final Box<int> INFO,) {
  final A = A_.dim();
         ...
         if ( CONVERT ) {
            ...
            while (I >= 1) {
               if ( IPIV( I ) > 0 ) {
                  ...
                  if ( I < N ) {
                     ...
                     if ( IP2 != (I-1) ) {
                        dswap(N-I, A( I-1, I+1 ), LDA, A( IP2, I+1 ), LDA );
                     }
                  }
                  I = I - 1;
            ...
            while (I <= N) {
               if ( IPIV( I ) > 0 ) {
                  ...
                  if ( I < N ) {
                     if ( IP2 != (I-1) ) {
                        dswap(N-I, A( IP2, I+1 ), LDA, A( I-1, I+1 ), LDA );
                     }
                     if ( IP != I ) {
                        dswap(N-I, A( IP, I+1 ), LDA, A( I, I+1 ), LDA );
                     }
         ...
         if ( CONVERT ) {
            ...
            while (I <= N) {
               if ( IPIV( I ) > 0 ) {
                  ...
                  if ( I > 1 ) {
                     ...
                     if ( IP2 != (I+1) ) {
                        dswap(I-1, A( I+1, 1 ), LDA, A( IP2, 1 ), LDA );
                     }
                  }
                  I = I + 1;
            ...
            while (I >= 1) {
               if ( IPIV( I ) > 0 ) {
                  ...
                  if ( I > 1 ) {
                     if ( IP2 != (I+1) ) {
                        dswap(I-1, A( IP2, 1 ), LDA, A( I+1, 1 ), LDA );
                     }
                     if ( IP != I ) {
                        dswap(I-1, A( IP, 1 ), LDA, A( I, 1 ), LDA );
                     }
