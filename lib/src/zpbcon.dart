      void zpbcon(final int UPLO, final int N, final int KD, final Matrix<double> AB_, final int LDAB, final int ANORM, final int RCOND, final Array<double> _WORK_, final Array<double> RWORK_, final Box<int> INFO,) {
  final AB = AB_.dim();
