      void zhseqr(JOB, COMPZ, N, ILO, IHI, final Matrix<double> H, final int LDH, W, final Matrix<double> Z, final int LDZ, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
