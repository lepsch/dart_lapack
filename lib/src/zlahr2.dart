      void zlahr2(final int N, final int K, final int NB, final Matrix<double> A, final int LDA, final int TAU, final Matrix<double> T, final int LDT, final int Y, final int LDY) {
