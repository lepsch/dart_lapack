      ...
      if ( UPPER ) {
         ...
         if ( ( CSL ).abs() >= ( SNL ).abs() || ( CSR ).abs() >= ( SNR ).abs() ) {
            ...
            if ( ( ( UA11R ).abs()+( UA12 ).abs() ) != ZERO ) {
               if ( AUA12 / ( ( UA11R ).abs()+( UA12 ).abs() ) <= AVB12 / ( ( VB11R ).abs()+( VB12 ).abs() ) ) {
            ...
            if ( ( ( UA21 ).abs()+( UA22 ).abs() ) != ZERO ) {
               if ( AUA22 / ( ( UA21 ).abs()+( UA22 ).abs() ) <= AVB22 / ( ( VB21 ).abs()+( VB22 ).abs() ) ) {
         ...
         if ( ( CSR ).abs() >= ( SNR ).abs() || ( CSL ).abs() >= ( SNL ).abs() ) {
            ...
            if ( ( ( UA21 ).abs()+( UA22R ).abs() ) != ZERO ) {
               if ( AUA21 / ( ( UA21 ).abs()+( UA22R ).abs() ) <= AVB21 / ( ( VB21 ).abs()+( VB22R ).abs() ) ) {
            ...
            if ( ( ( UA11 ).abs()+( UA12 ).abs() ) != ZERO ) {
               if ( AUA11 / ( ( UA11 ).abs()+( UA12 ).abs() ) <= AVB11 / ( ( VB11 ).abs()+( VB12 ).abs() ) ) {
