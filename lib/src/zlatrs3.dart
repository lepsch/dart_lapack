      void zlatrs3(final int UPLO, final int TRANS, final int DIAG, final int NORMIN, final int N, final int NRHS, final Matrix<double> A, final int LDA, final Matrix<double> X, final int LDX, final int SCALE, final int CNORM, final Array<double> WORK, final int LWORK, final Box<int> INFO,) {
