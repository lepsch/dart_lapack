...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsyev(final int JOBZ, final int UPLO, final int N, final Matrix<double> A, final int LDA, final int W, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
