      void zgees(JOBVS, SORT, SELECT, N, final Matrix<double> A, final int LDA, SDIM, W, final Matrix<double> VS, final int LDVS, final Array<double> WORK, final int LWORK, RWORK, BWORK, Box<int> INFO ) {
