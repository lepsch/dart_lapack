      void zhbgst(VECT, UPLO, N, KA, KB, final Matrix<double> AB, final int LDAB, final Matrix<double> BB, final int LDBB, final Matrix<double> X, final int LDX, final Array<double> _WORK, final Array<double> RWORK, final Box<int> INFO ) {
