...
// [LICENSE file](https://github.com/lepsch/dart_lapack/blob/main/LICENSE).
      ...
      void dlahrd(final int N, final int K, final int NB, final Matrix<double> A_, final int LDA, final int TAU, final Matrix<double> T_, final int LDT, final int Y, final int LDY,) {
  final A = A_.having();
  final T = T_.having();
