...
import 'package:lapack/src/xerbla.dart';
      ...
      void dgesvx(FACT, TRANS, N, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, IPIV, EQUED, R, C, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, RCOND, FERR, BERR, WORK, IWORK, Box<int> INFO ) {
