...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsytrf_aa_2stage(final int UPLO, final int N, final Matrix<double> A_, final int LDA, final int TB, final int LTB, final Array<int> IPIV_, final int IPIV2, final Array<double> WORK_, final int LWORK, final Box<int> INFO,) {
  final A = A_.dim();
            ...
            if ( J < NT-1 ) {
               ...
               for (K = 1; K <= KB; K++) {
                  ...
                  if ( I1 != I2 ) {
                     ...
                     if( I2 > (I1+1) ) dswap( I2-I1-1, A( I1, I1+1 ), LDA, A( I1+1, I2 ), 1 );
            ...
            if ( J < NT-1 ) {
               ...
               for (K = 1; K <= KB; K++) {
                  ...
                  if ( I1 != I2 ) {
                     ...
                     // > Swap A(I1+1:M, I1) with A(I2, I1+1:M)
                     if( I2 > (I1+1) ) dswap( I2-I1-1, A( I1+1, I1 ), 1, A( I2, I1+1 ), LDA );
                     // > Swap A(I2+1:M, I1) with A(I2+1:M, I2)
