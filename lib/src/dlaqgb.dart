...
import 'package:lapack/src/xerbla.dart';
      ...
      void dlaqgb(final int M, final int N, final int KL, final int KU, final Matrix<double> AB_, final int LDAB, final int R, final int C, final int ROWCND, final int COLCND, final int AMAX, final int EQUED,) {
  final AB = AB_.dim();
