...
import 'package:lapack/src/xerbla.dart';
      ...
      void dlasd1(NL, NR, SQRE, D, ALPHA, BETA, final Matrix<double> U, final int LDU, final Matrix<double> VT, final int LDVT, IDXQ, final Array<int> IWORK, WORK, final Box<int> INFO ) {
