...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  for (J = 1; J <= NRHS; J++) {
    ...
    while (true) {
      ...
      zhpmv(UPLO, N, -Complex.one, AP, X(1, J).asArray(), 1, Complex.one, WORK,
          1);
      ...
      if (BERR[J] > EPS && TWO * BERR[J] <= LSTRES && COUNT <= ITMAX) {
        ...
        zpptrs(UPLO, N, 1, AFP, WORK.asMatrix(), N, INFO);
