...
import 'package:dart_lapack/src/xblas/blas_zsymv2_x.dart';
import 'package:dart_lapack/src/xblas/blas_zsymv_x.dart';
import 'package:dart_lapack/src/xerbla.dart';
import 'package:dart_lapack/src/zla_lin_berr.dart';
import 'package:dart_lapack/src/zla_syamv.dart';
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  for (J = 1; J <= NRHS; J++) {
    ...
    for (CNT = 1; CNT <= ITHRESH; CNT++) {
      ...
      zcopy(N, RES, 1, DY, 1);
      zsytrs(UPLO, N, 1, AF, LDAF, IPIV, DY.asMatrix(N), N, INFO);
    ...
    zcopy(N, B(1, J).asArray(), 1, RES, 1);
    zsymv(UPLO, N, -Complex.one, A, LDA, Y(1, J).asArray(), 1, Complex.one, RES,
        1);
    ...
    zla_syamv(UPLO2, N, 1.0, A, LDA, Y(1, J).asArray(), 1, 1.0, AYB, 1);
