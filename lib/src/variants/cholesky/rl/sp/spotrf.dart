    ...
    if (UPPER) {
      ...
      for (J = 1; NB < 0 ? J >= N : J <= N; J += NB) {
        ...
        if (J + JB <= N) {
          ...
          strsm('Left', 'Upper', 'Transpose', 'Non-unit', JB, N - J - JB + 1,
              ONE, A(J, J), LDA, A(J, J + JB), LDA);
          ssyrk('Upper', 'Transpose', N - J - JB + 1, JB, -ONE, A(J, J + JB),
      ...
      for (J = 1; NB < 0 ? J >= N : J <= N; J += NB) {
        ...
        if (J + JB <= N) {
          ...
          strsm('Right', 'Lower', 'Transpose', 'Non-unit', N - J - JB + 1, JB,
              ONE, A(J, J), LDA, A(J + JB, J), LDA);
          ssyrk('Lower', 'No Transpose', N - J - JB + 1, JB, -ONE, A(J + JB, J),
              LDA, ONE, A(J + JB, J + JB), LDA);
        }
      } // 20
    }
