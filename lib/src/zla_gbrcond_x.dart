      double zla_gbrcond_x(TRANS, N, KL, KU, final Matrix<double> AB, final int LDAB, final Matrix<double> AFB, final int LDAFB, final Array<int> IPIV, X, INFO, final Array<double> _WORK, final Array<double> RWORK) {
