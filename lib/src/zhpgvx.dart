      void zhpgvx(ITYPE, JOBZ, RANGE, UPLO, N, AP, BP, VL, VU, IL, IU, ABSTOL, M, W, final Matrix<double> Z, final int LDZ, WORK, RWORK, final Array<int> IWORK, IFAIL, final Box<int> INFO ) {
