...
import 'package:lapack/src/xerbla.dart';
      ...
      void dla_syrfsx_extended(PREC_TYPE, UPLO, N, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, IPIV, COLEQU, C, final Matrix<double> B, final int LDB, final Matrix<double> Y, final int LDY, BERR_OUT, N_NORMS, ERR_BNDS_NORM, ERR_BNDS_COMP, RES, AYB, DY, Y_TAIL, RCOND, ITHRESH, RTHRESH, DZ_UB, IGNORE_CWISE, final Box<int> INFO ) {
...
// =====================================================================
      ...
      if ( INFO != 0 ) {
         xerbla('DLA_SYRFSX_EXTENDED', -INFO );
         return;
      }
      EPS = dlamch( 'Epsilon' );
      ...
      for (J = 1; J <= NRHS; J++) {
         ...
         //     op(A) = A, A**T, or A**H depending on TRANS (and type).
          ...
          // XXX: RES is no longer needed.
            dcopy(N, RES, 1, DY, 1 );
            dsytrs(UPLO, N, 1, AF, LDAF, IPIV, DY, N, INFO );
