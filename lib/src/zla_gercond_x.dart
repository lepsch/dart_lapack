      double zla_gercond_x(TRANS, N, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, final Array<int> IPIV, X, INFO, final Array<double> _WORK, RWORK ) {
