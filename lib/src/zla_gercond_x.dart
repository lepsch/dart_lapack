      double zla_gercond_x(final int TRANS, final int N, final Matrix<double> A_, final int LDA, final Matrix<double> AF_, final int LDAF, final Array<int> IPIV_, final int X, final int INFO, final Array<double> _WORK_, final Array<double> RWORK_,) {
  final A = A_.dim();
  final AF = AF_.dim();
