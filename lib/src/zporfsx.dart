      void zporfsx(UPLO, EQUED, N, NRHS, final Matrix<double> A, final int LDA, final Matrix<double> AF, final int LDAF, S, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, RCOND, BERR, N_ERR_BNDS, ERR_BNDS_NORM, ERR_BNDS_COMP, NPARAMS, PARAMS, final Array<double> _WORK, final Array<double> RWORK, final Box<int> INFO ) {
...
// ==================================================================
      ...
      // Compute scaled normwise condition number cond(A*C).
         ...
         if ( RCEQU ) {
            RCOND_TMP = ZLA_PORCOND_C( UPLO, N, A, LDA, AF, LDAF, S, true , INFO, WORK, RWORK );
         } else {
            RCOND_TMP = ZLA_PORCOND_C( UPLO, N, A, LDA, AF, LDAF, S, false , INFO, WORK, RWORK );
         }
         for (J = 1; J <= NRHS; J++) {
