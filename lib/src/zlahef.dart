...
void zlahef(final int UPLO, final int N, final int NB, final int KB, final Matrix<double> A_, final int LDA, final Array<int> IPIV_, final Matrix<double> W_, final int LDW, final Box<int> INFO,) {
  final A = A_.dim();
      ...
      if ( lsame( UPLO, 'U' ) ) {
         ...
         if ( max( ABSAKK, COLMAX ) == ZERO ) {
            ...
            if ( ABSAKK >= ALPHA*COLMAX ) {
               ...
               // Case(3)
               } else if ( ABS( (W( IMAX, KW-1 )).toDouble() ) >= ALPHA*ROWMAX ) {
         ...
         if ( max( ABSAKK, COLMAX ) == ZERO ) {
            ...
            if ( ABSAKK >= ALPHA*COLMAX ) {
               ...
               // Case(3)
               } else if ( ABS( (W( IMAX, K+1 )).toDouble() ) >= ALPHA*ROWMAX ) {
