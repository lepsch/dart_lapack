...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  dsyconv(UPLO, 'C', N, A, LDA, IPIV, WORK.asArray(), IINFO);
  ...
  if (UPPER) {
    ...
    while (CUT > 0) {
      ...
      dtrmm('L', 'U', 'T', 'U', NNB, NNB, ONE, A(CUT + 1, CUT + 1), LDA,
          WORK(U11 + 1, 1), N + NB + 1);
      ...
      dgemm('T', 'N', NNB, NNB, CUT, ONE, A(1, CUT + 1), LDA, WORK, N + NB + 1,
    ...
    while (CUT < N) {
      ...
      dtrmm('L', UPLO, 'T', 'U', NNB, NNB, ONE, A(CUT + 1, CUT + 1), LDA,
          WORK(U11 + 1, 1), N + NB + 1);
      ...
      if ((CUT + NNB) < N) {
        ...
        dgemm('T', 'N', NNB, NNB, N - NNB - CUT, ONE, A(CUT + NNB + 1, CUT + 1),
        ...
        dtrmm('L', UPLO, 'T', 'U', N - NNB - CUT, NNB, ONE,
