...
import 'package:lapack/src/xerbla.dart';
      ...
      void dpbtrs(final int UPLO, final int N, final int KD, final int NRHS, final Matrix<double> AB_, final int LDAB, final Matrix<double> B_, final int LDB, final Box<int> INFO,) {
  final AB = AB_.dim();
  final B = B_.dim();
