...
import 'package:lapack/src/xerbla.dart';
      ...
      void dtprfs(UPLO, TRANS, DIAG, N, NRHS, AP, final Matrix<double> B, final int LDB, final Matrix<double> X, final int LDX, FERR, BERR, WORK, final Array<int> IWORK, final Box<int> INFO ) {
