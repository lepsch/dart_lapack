...
import 'package:lapack/src/xerbla.dart';
      ...
      void dtprfs(final int UPLO, final int TRANS, final int DIAG, final int N, final int NRHS, final int AP, final Matrix<double> B_, final int LDB, final Matrix<double> X_, final int LDX, final int FERR, final int BERR, final Array<double> _WORK_, final Array<int> IWORK_, final Box<int> INFO,) {
  final B = B_.dim();
  final X = X_.dim();
