      void zsptri(final int UPLO, final int N, final int AP, final Array<int> IPIV_, final Array<double> _WORK_, final Box<int> INFO,) {
      ...
      if ( UPPER ) {
         ...
         if ( IPIV( K ) > 0 ) {
            ...
            if ( K > 1 ) {
               ...
               zspmv[UPLO, K-1, -ONE, AP, WORK, 1, ZERO, AP( KCNEXT ), 1 )                AP( KCNEXT+K] = AP( KCNEXT+K ) - ZDOTU( K-1, WORK, 1, AP( KCNEXT ), 1 );
            }
            KSTEP = 2;
            KCNEXT = KCNEXT + K + 1;
         }
         ...
         if ( IPIV( K ) > 0 ) {
            ...
            if ( K < N ) {
               ...
               zspmv[UPLO, N-K, -ONE, AP( KC+( N-K+1 ) ), WORK, 1, ZERO, AP( KCNEXT+2 ), 1 )                AP( KCNEXT] = AP( KCNEXT ) - ZDOTU( N-K, WORK, 1, AP( KCNEXT+2 ), 1 );
            }
            KSTEP = 2;
            KCNEXT = KCNEXT - ( N-K+3 );
         }
