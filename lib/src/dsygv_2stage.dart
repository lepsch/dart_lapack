...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsygv_2stage(final int ITYPE, final int JOBZ, final int UPLO, final int N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, final int W, final Array<double> WORK, final int LWORK, final Box<int> INFO ) {
