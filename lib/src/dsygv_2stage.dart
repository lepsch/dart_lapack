...
import 'package:lapack/src/xerbla.dart';
      ...
      void dsygv_2stage(ITYPE, JOBZ, UPLO, N, final Matrix<double> A, final int LDA, final Matrix<double> B, final int LDB, W, final Array<double> WORK, final int LWORK, Box<int> INFO ) {
