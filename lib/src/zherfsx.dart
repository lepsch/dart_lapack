...
// ==================================================================
      ...
      double             DLAMCH, ZLANHE, ZLA_HERCOND_X, ZLA_HERCOND_C;
      bool               lsame;
      int                ILAPREC;
      ...
      // cwise error is at least CWISE_WRONG.
         ...
         for (J = 1; J <= NRHS; J++) {
            if ( ERR_BNDS_COMP( J, LA_LINRX_ERR_I ) < CWISE_WRONG ) {
               RCOND_TMP = ZLA_HERCOND_X( UPLO, N, A, LDA, AF, LDAF, IPIV, X( 1, J ), INFO, WORK, RWORK );
            } else {
               RCOND_TMP = 0.0;
            }
