...
import 'package:dart_lapack/src/dla_gercond.dart';
import 'package:dart_lapack/src/dla_gerfsx_extended.dart';
...
// -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
  ...
  if (N_ERR_BNDS >= 1 && N_NORMS >= 1) {
    ...
    if (COLEQU && NOTRAN) {
      RCOND_TMP = dla_gercond(
          TRANS, N, A, LDA, AF, LDAF, IPIV, -1, C, INFO, WORK, IWORK);
    } else if (ROWEQU && !NOTRAN) {
      RCOND_TMP = dla_gercond(
          TRANS, N, A, LDA, AF, LDAF, IPIV, -1, R, INFO, WORK, IWORK);
    } else {
      RCOND_TMP = dla_gercond(
          TRANS, N, A, LDA, AF, LDAF, IPIV, 0, R, INFO, WORK, IWORK);
    }
    for (J = 1; J <= NRHS; J++) {
