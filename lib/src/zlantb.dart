      double zlantb(final int NORM, final int UPLO, final int DIAG, final int N, final int K, final Matrix<double> AB_, final int LDAB, final Array<double> WORK_,) {
  final AB = AB_.dim();
      ...
      if ( N == 0 ) {
         ...
         if ( lsame( UPLO, 'U' ) ) {
            if ( lsame( DIAG, 'U' ) ) {
               ...
               SUM = ONE;
               for (J = 1; J <= N; J++) { // 290
                  zlassq(min( J, K+1 ), AB( max( K+2-J, 1 ), J ), 1, SCALE, SUM );
               } // 290
            }
         } else {
            if ( lsame( DIAG, 'U' ) ) {
               ...
               SUM = ONE;
               for (J = 1; J <= N; J++) { // 310
                  zlassq(min( N-J+1, K+1 ), AB( 1, J ), 1, SCALE, SUM );
               } // 310
            }
         }
