      void zsytf2_rk(final int UPLO, final int N, final Matrix<double> A_, final int LDA, final int E, final Array<int> IPIV_, final Box<int> INFO,) {
  final A = A_.dim();
