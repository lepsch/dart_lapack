      void dlatmr(M, N, DIST, ISEED, SYM, D, MODE, COND, DMAX, RSIGN, GRADE, DL, MODEL, CONDL, DR, MODER, CONDR, PIVTNG, IPIVOT, KL, KU, SPARSE, ANORM, PACK, A, LDA, IWORK, INFO ) {
...
// =====================================================================
      ...
      if ( FULBND ) {
         ...
         if ( IPACK == 0 ) {
            ...
            for (J = 1; J <= N; J++) { // 340
               for (I = 1; I <= J; I++) { // 330
                  A( I, J ) = DLATM2( M, N, I, J, KL, KU, IDIST, ISEED, D, IGRADE, DL, DR, IPVTNG, IWORK, SPARSE )                   IF( I != J ) A( J, I ) = ZERO;
               } // 330
            } // 340
            ...
            for (J = 1; J <= N; J++) { // 360
               for (I = 1; I <= J; I++) { // 350
                  A( J, I ) = DLATM2( M, N, I, J, KL, KU, IDIST, ISEED, D, IGRADE, DL, DR, IPVTNG, IWORK, SPARSE )                   IF( I != J ) A( I, J ) = ZERO;
               } // 350
            } // 360
