            ...
            for (IWK = 1; IWK <= 2; IWK++) { // 250
               ...
               for (J = 1; J <= N; J++) { // 120
                  ...
                  for (JJ = 1; JJ <= N; JJ++) { // 110
                     VTST = ABS( VR( JJ, J ) )
                     if (VTST > VMX) VMX = VTST                      IF( DIMAG( VR( JJ, J ) ) == ZERO && ABS( DBLE( VR( JJ, J ) ) ) > VRMX ) VRMX = ABS( DBLE( VR( JJ, J ) ) );
                  } // 110
               ...
               for (J = 1; J <= N; J++) { // 140
                  ...
                  for (JJ = 1; JJ <= N; JJ++) { // 130
                     VTST = ABS( VL( JJ, J ) )
                     if (VTST > VMX) VMX = VTST                      IF( DIMAG( VL( JJ, J ) ) == ZERO && ABS( DBLE( VL( JJ, J ) ) ) > VRMX ) VRMX = ABS( DBLE( VL( JJ, J ) ) );
                  } // 130
