...
*  -- Univ. of California Berkeley, Univ. of Colorado Denver and NAG Ltd..--
      ...
      REAL               A( LDA, * ), H( LDA, * ), HT( LDA, * ), RESULT( 13 ), VS( LDVS, * ), WI( * ), WIT( * ), WORK( * ), WR( * ), WRT( * )
      // ..
...
*  =====================================================================
      ...
      REAL               ANORM, COND, CONDS, OVFL, RTULP, RTULPI, TMP, ULP, ULPINV, UNFL
      // ..
      // .. Local Arrays ..
      String             ADUMMA( 1 );
  ...
  100          CONTINUE
               ...
               DO 210 ISORT = 0, 1
                  ...
                  CALL SGEES( 'V', SORT, SSLECT, N, H, LDA, SDIM, WR, WI, VS, LDVS, WORK, NNWORK, BWORK, IINFO )
  ...
  140             CONTINUE
                  ...
                  LWORK = MAX( 1, 2*N*N )
                  CALL SHST01( N, 1, N, A, LDA, H, LDA, VS, LDVS, WORK, LWORK, RES )
                  RESULT( 2+RSUB ) = RES( 1 )
                  RESULT( 3+RSUB ) = RES( 2 )
  ...
  160             CONTINUE
                  ...
                  CALL SGEES( 'N', SORT, SSLECT, N, HT, LDA, SDIM, WRT, WIT, VS, LDVS, WORK, NNWORK, BWORK, IINFO )
                  if ( IINFO.NE.0 .AND. IINFO.NE.N+2 ) {
 ...
 9999 FORMAT( / 1X, A3, ' -- Real Schur Form Decomposition Driver', / ' Matrix types (see SDRVES for details): ' )
 ...
 9992 FORMAT( ' SDRVES: ', A, ' returned INFO=', I6, '.', / 9X, 'N=', I6, ', JTYPE=', I6, ', ISEED=(', 3( I5, ',' ), I5, ')' )
