...
*     .. Array Arguments ..
      LOGICAL            DOTYPE( * )
      int                ISEED( 4 ), KK( * ), NN( * )
      DOUBLE PRECISION   RESULT( * ), RWORK( * ), SD( * ), SE( * ), D1( * ), D2( * ), D3( * )
...
*
               ...
               LH = MAX(1, 4*N)
               LW = LWORK - LH
               CALL ZHETRD_HB2ST( 'N', 'N', "U", N, K, U, LDU, SD, SE, WORK, LH, WORK( LH+1 ), LW, IINFO )
*
...
*
               ...
               LH = MAX(1, 4*N)
               LW = LWORK - LH
               CALL ZHETRD_HB2ST( 'N', 'N', "L", N, K, U, LDU, SD, SE, WORK, LH, WORK( LH+1 ), LW, IINFO )
*
