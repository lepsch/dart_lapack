...
*  =====================================================================
  ...
  110       CONTINUE
            ...
            CALL SGGEV( 'V', 'V', N, S, LDA, T, LDA, ALPHAR, ALPHAI, BETA, Q, LDQ, Z, LDQ, WORK, LWORK, IERR )
            ...
            CALL SLACPY( ' ', N, N, A, LDA, S, LDA )
            CALL SLACPY( ' ', N, N, B, LDA, T, LDA )
            CALL SGGEV( 'N', 'N', N, S, LDA, T, LDA, ALPHR1, ALPHI1, BETA1, Q, LDQ, Z, LDQ, WORK, LWORK, IERR )
            if ( IERR.NE.0 .AND. IERR.NE.N+1 ) {
               RESULT( 1 ) = ULPINV
  ...
  120       CONTINUE
            ...
            CALL SLACPY( ' ', N, N, A, LDA, S, LDA )
            CALL SLACPY( ' ', N, N, B, LDA, T, LDA )
            CALL SGGEV( 'V', 'N', N, S, LDA, T, LDA, ALPHR1, ALPHI1, BETA1, QE, LDQE, Z, LDQ, WORK, LWORK, IERR )
            if ( IERR.NE.0 .AND. IERR.NE.N+1 ) {
               RESULT( 1 ) = ULPINV
  ...
  150       CONTINUE
            ...
            CALL SLACPY( ' ', N, N, A, LDA, S, LDA )
            CALL SLACPY( ' ', N, N, B, LDA, T, LDA )
            CALL SGGEV( 'N', 'V', N, S, LDA, T, LDA, ALPHR1, ALPHI1, BETA1, Q, LDQ, QE, LDQE, WORK, LWORK, IERR )
            if ( IERR.NE.0 .AND. IERR.NE.N+1 ) {
               RESULT( 1 ) = ULPINV
