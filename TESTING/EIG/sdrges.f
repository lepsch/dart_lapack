            ...
            for (ISORT = 0; ISORT <= 1; ISORT++) { // 150
               ...
               if ( ISORT.GE.1 ) {
                  ...
                  for (I = 1; I <= N; I++) { // 140
                     ...
                     if ( I.LT.N ) {
                        if ( ( SLCTES( ALPHAR( I+1 ), ALPHAI( I+1 ), BETA( I+1 ) ) .OR. SLCTES( ALPHAR( I+1 ), -ALPHAI( I+1 ), BETA( I+1 ) ) ) .AND. ( .NOT.( SLCTES( ALPHAR( I ), ALPHAI( I ), BETA( I ) ) .OR. SLCTES( ALPHAR( I ), -ALPHAI( I ), BETA( I ) ) ) ) .AND. IINFO != N+2 ) {
                           RESULT( 12 ) = ULPINV
                        }
                     }
                  } // 140
