...
*  =====================================================================
  ...
  120       CONTINUE
            ...
            DO 150 ISORT = 0, 1
               ...
               CALL SGGES( 'V', 'V', SORT, SLCTES, N, S, LDA, T, LDA, SDIM, ALPHAR, ALPHAI, BETA, Q, LDQ, Z, LDQ, WORK, LWORK, BWORK, IINFO )
               ...
               DO 130 J = 1, N
                  ...
                  if ( ALPHAI( J ).EQ.ZERO ) {
                     ...
                     if ( .NOT.ILABAD ) {
                        CALL SGET53( S( I1, I1 ), LDA, T( I1, I1 ), LDA, BETA( J ), ALPHAR( J ), ALPHAI( J ), TEMP2, IERR )
                        if ( IERR.GE.3 ) {
