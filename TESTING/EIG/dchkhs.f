      void dchkhs(NSIZES, NN, NTYPES, DOTYPE, ISEED, THRESH, NOUNIT, A, LDA, H, T1, T2, U, LDU, Z, UZ, WR1, WI1, WR2, WI2, WR3, WI3, EVECTL, EVECTR, EVECTY, EVECTX, UU, TAU, WORK, NWORK, IWORK, SELECT, RESULT, INFO ) {
...
// =====================================================================
      ...
      for (JSIZE = 1; JSIZE <= NSIZES; JSIZE++) { // 270
        ...
        // =10                             random triangular
            ...
            if ( !MATCH) WRITE( NOUNIT, FMT = 9997 )'Right', 'DTREVC', N, JTYPE, IOLDSD;
            ...
            if ( !MATCH) WRITE( NOUNIT, FMT = 9997 )'Left', 'DTREVC', N, JTYPE, IOLDSD;
