...
*  =====================================================================
 ...
 9999 FORMAT( / 1X, A3, ' -- Real Schur Form Decomposition Expert ', 'Driver', / ' Matrix types (see SDRVSX for details):' )
 ...
 9991 FORMAT( ' SDRVSX: ', A, ' returned INFO=', I6, '.', / 9X, 'N=', I6, ', JTYPE=', I6, ', ISEED=(', 3( I5, ',' ), I5, ')' )
