      void zchklq(DOTYPE, NM, MVAL, NN, NVAL, NNB, NBVAL, NXVAL, NRHS, THRESH, TSTERR, NMAX, A, AF, AQ, AL, AC, B, X, XACT, TAU, WORK, RWORK, NOUT ) {
                  ...
                  for (INB = 1; INB <= NNB; INB++) { // 30
                     ...
                     if ( M >= K ) {
                        ...
                        if ( K == M && INB == 1 ) {
                           ...
                           if (INFO != 0) CALL ALAERH( PATH, 'ZGELS', INFO, 0, 'N', M, N, NRHS, -1, NB, IMAT, NFAIL, NERRS, NOUT );
