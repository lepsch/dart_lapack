      void zchksy_rook(DOTYPE, NN, NVAL, NNB, NBVAL, NNS, NSVAL, THRESH, TSTERR, NMAX, A, AFAC, AINV, B, X, XACT, WORK, RWORK, IWORK, NOUT ) {
         ...
         for (IMAT = 1; IMAT <= NIMAT; IMAT++) { // 260
            ...
            for (IUPLO = 1; IUPLO <= 2; IUPLO++) { // 250
               ...
               for (INB = 1; INB <= NNB; INB++) { // 240
                  ...
                  if (INFO != K) CALL ALAERH( PATH, 'ZSYTRF_ROOK', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 2
                  ...
                  if ( INB == 1 && !TRFCON ) {
                     ...
                     if (INFO != 0) CALL ALAERH( PATH, 'ZSYTRI_ROOK', INFO, -1, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 5 ( Using TRS_ROOK)
                  // Solve and compute residual for  A * X = B.
                     ...
                     if (INFO != 0) CALL ALAERH( PATH, 'ZSYTRS_ROOK', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
// +    TEST 7
                  ...
                  if (INFO != 0) CALL ALAERH( PATH, 'ZSYCON_ROOK', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
