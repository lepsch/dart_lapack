...
*  =====================================================================
   ...
   90                      CONTINUE
               ...
               DO 240 INB = 1, NNB
                 ...
                 t // he block structure of D. AINV is a work array for
                  ...
                  LWORK = MAX( 2, NB )*LDA
                  SRNAMT = 'ZSYTRF_ROOK'
                  CALL ZSYTRF_ROOK( UPLO, N, AFAC, LDA, IWORK, AINV, LWORK, INFO )
  ...
  100                CONTINUE
                  ...
                  IF( INFO.NE.K) CALL ALAERH( PATH, 'ZSYTRF_ROOK', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT )
...
*+    TEST 1
                  ...
                  CALL ZSYT01_ROOK( UPLO, N, A, LDA, AFAC, LDA, IWORK, AINV, LDA, RWORK, RESULT( 1 ) )
                  NT = 1
...
*+    TEST 2
                  ...
                  IF( INB.EQ.1 .AND. .NOT.TRFCON ) THEN
                     ...
                     SRNAMT = 'ZSYTRI_ROOK'
                     CALL ZSYTRI_ROOK( UPLO, N, AINV, LDA, IWORK, WORK, INFO )

                     // Check error code from ZSYTRI_ROOK and handle error.

                     IF( INFO.NE.0 ) CALL ALAERH( PATH, 'ZSYTRI_ROOK', INFO, -1, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT )
...
*+    TEST 5 ( Using TRS_ROOK)
                  // Solve and compute residual for  A * X = B.
                     ...
                     SRNAMT = 'ZSYTRS_ROOK'
                     CALL ZSYTRS_ROOK( UPLO, N, NRHS, AFAC, LDA, IWORK, X, LDA, INFO )

                     // Check error code from ZSYTRS_ROOK and handle error.

                     IF( INFO.NE.0 ) CALL ALAERH( PATH, 'ZSYTRS_ROOK', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT )
...
*+    TEST 7
  ...
  230             CONTINUE
                  ...
                  SRNAMT = 'ZSYCON_ROOK'
                  CALL ZSYCON_ROOK( UPLO, N, AFAC, LDA, IWORK, ANORM, RCOND, WORK, INFO )

                  // Check error code from ZSYCON_ROOK and handle error.

                  IF( INFO.NE.0 ) CALL ALAERH( PATH, 'ZSYCON_ROOK', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT )
