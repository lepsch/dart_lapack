...
*  =====================================================================
   ...
   90                      CONTINUE
               ...
               DO 240 INB = 1, NNB
                  ...
                  LWORK = MAX( 2, NB )*LDA
                  SRNAMT = 'ZHETRF_RK'
                  CALL ZHETRF_RK( UPLO, N, AFAC, LDA, E, IWORK, AINV, LWORK, INFO )
  ...
  100                CONTINUE
                  ...
                  IF( INFO.NE.K) CALL ALAERH( PATH, 'ZHETRF_RK', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT )
...
*+    TEST 1
                  ...
                  CALL ZHET01_3( UPLO, N, A, LDA, AFAC, LDA, E, IWORK, AINV, LDA, RWORK, RESULT( 1 ) )
                  NT = 1
...
*+    TEST 2
                  ...
                  if ( INB.EQ.1 .AND. .NOT.TRFCON ) {
                     ...
                     LWORK = (N+NB+1)*(NB+3)
                     CALL ZHETRI_3( UPLO, N, AINV, LDA, E, IWORK, WORK, LWORK, INFO )

                     // Check error code from ZHETRI_3 and handle error.

                     IF( INFO.NE.0 ) CALL ALAERH( PATH, 'ZHETRI_3', INFO, -1, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT )
...
*+    TEST 5 ( Using TRS_3)
                  // Solve and compute residual for  A * X = B.
                     ...
                     SRNAMT = 'ZHETRS_3'
                     CALL ZHETRS_3( UPLO, N, NRHS, AFAC, LDA, E, IWORK, X, LDA, INFO )

                     // Check error code from ZHETRS_3 and handle error.

                     IF( INFO.NE.0 ) CALL ALAERH( PATH, 'ZHETRS_3', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT )

                     CALL ZLACPY( 'Full', N, NRHS, B, LDA, WORK, LDA )

                     // Compute the residual for the solution

                     CALL ZPOT02( UPLO, N, NRHS, A, LDA, X, LDA, WORK, LDA, RWORK, RESULT( 5 ) )
...
*+    TEST 7
  ...
  230             CONTINUE
                  ...
                  SRNAMT = 'ZHECON_3'
                  CALL ZHECON_3( UPLO, N, AFAC, LDA, E, IWORK, ANORM, RCOND, WORK, INFO )

                  // Check error code from ZHECON_3 and handle error.

                  IF( INFO.NE.0 ) CALL ALAERH( PATH, 'ZHECON_3', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT )
