...
*  =====================================================================
 ...
 8020 FORMAT(3X,I2, ': norm( Q''*C - Q''*C ) / ( (M+N) * norm(C) * EPS )')
 8021 FORMAT(3X,I2,': norm( C*Q - C*Q ) / ( (M+N) * norm(C) * EPS )' )
 8022 FORMAT(3X,I2, ': norm( C*Q'' - C*Q'' ) / ( (M+N) * norm(C) * EPS )')
 ...
 8026 FORMAT(3X,I2, ': norm( Q''*C - Q''*C ) / ( (M+N) * norm(C) * EPS )')
 8027 FORMAT(3X,I2,': norm( C*Q - C*Q ) / ( (M+N) * norm(C) * EPS )' )
 8028 FORMAT(3X,I2, ': norm( C*Q'' - C*Q'' ) / ( (M+N) * norm(C) * EPS )')
 ...
 8032 FORMAT(3X,I2, ': norm( Q''*C - Q''*C ) / ( (M+N) * norm(C) * EPS )')
 8033 FORMAT(3X,I2,': norm( C*Q - C*Q ) / ( (M+N) * norm(C) * EPS )' )
 8034 FORMAT(3X,I2, ': norm( C*Q'' - C*Q'' ) / ( (M+N) * norm(C) * EPS )')
 ...
 8038 FORMAT(3X,I2, ': norm( Q''*C - Q''*C ) / ( (M+N) * norm(C) * EPS )')
 8039 FORMAT(3X,I2,': norm( C*Q - C*Q ) / ( (M+N) * norm(C) * EPS )' )
 8040 FORMAT(3X,I2, ': norm( C*Q'' - C*Q'' ) / ( (M+N) * norm(C) * EPS )')
 ...
 8063 FORMAT( 3X, I2, ': Returns 1.0D+100, if abs(R(K+1,K+1))', ' > abs(R(K,K)), where K=1:KFACT-1' )
