...
*  =====================================================================
   ...
   90                   CONTINUE
               ...
               DO 150 INB = 1, NNB
                 ...
                 t // he block structure of D. AINV is a work array for
                  ...
                  CALL DSYTRF_AA_2STAGE( UPLO, N, AFAC, LDA,  AINV, MAX( 1, (3*NB+1)*N ), IWORK, IWORK( 1+N ), WORK, LWORK, INFO )
  ...
  100                CONTINUE
                  ...
                  if ( INFO.NE.K ) {
                     CALL ALAERH( PATH, 'DSYTRF_AA_2STAGE', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT )
                  }
...
*+    TEST 2 (Using TRS)
                  // Solve and compute residual for  A * X = B.
                     ...
                     CALL DSYTRS_AA_2STAGE( UPLO, N, NRHS, AFAC, LDA, AINV, (3*NB+1)*N, IWORK, IWORK( 1+N ), X, LDA, INFO )
