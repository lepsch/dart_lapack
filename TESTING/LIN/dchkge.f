         ...
         for (IN = 1; IN <= NN; IN++) { // 110
            ...
            for (IMAT = 1; IMAT <= NIMAT; IMAT++) { // 100
               ...
               for (INB = 1; INB <= NNB; INB++) { // 90
                  ...
                  if (INFO != IZERO) CALL ALAERH( PATH, 'DGETRF', INFO, IZERO, ' ', M, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT );
                  TRFCON = false;
...
*+    TEST 2
                  ...
                  if ( M == N && INFO == 0 ) {
                     ...
                     if (INFO != 0) CALL ALAERH( PATH, 'DGETRI', INFO, 0, ' ', N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT );
...
*+    TEST 3
                        ...
                        if (INFO != 0) CALL ALAERH( PATH, 'DGETRS', INFO, 0, TRANS, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
*+    TESTS 5, 6, and 7
                        ...
                        if (INFO != 0) CALL ALAERH( PATH, 'DGERFS', INFO, 0, TRANS, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT );
...
*+    TEST 8
                  ...
                  for (ITRAN = 1; ITRAN <= 2; ITRAN++) { // 80
                     ...
                     if (INFO != 0) CALL ALAERH( PATH, 'DGECON', INFO, 0, NORM, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT );
