...
*  =====================================================================
   ...
   90                   CONTINUE
               ...
               DO 150 IFACT = 1, NFACT
                  ...
                  if ( ZEROT ) {
                     ...
                     CALL DSYTRF_ROOK( UPLO, N, AFAC, LDA, IWORK, WORK, LWORK, INFO )
                  ...
                  if ( IFACT.EQ.2 ) {
                     ...
                     SRNAMT = 'DSYSV_ROOK'
                     CALL DSYSV_ROOK( UPLO, N, NRHS, AFAC, LDA, IWORK, X, LDA, WORK, LWORK, INFO )
  ...
  100                   CONTINUE
                     ...
                     if ( INFO.NE.K ) {
                        CALL ALAERH( PATH, 'DSYSV_ROOK', INFO, K, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT )
                        GO TO 120
                     } else if ( INFO.NE.0 ) {
                        GO TO 120
                     }
