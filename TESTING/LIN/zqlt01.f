...
*  =====================================================================
      ...
      if ( M.GE.N ) {
         if (N.LT.M && N.GT.0) CALL ZLACPY( 'Full', M-N, N, AF, LDA, Q( 1, M-N+1 ), LDA )          IF( N.GT.1 ) CALL ZLACPY( 'Upper', N-1, N-1, AF( M-N+1, 2 ), LDA, Q( M-N+1, M-N+2 ), LDA );
      } else {
      ...
      if ( M.GE.N ) {
         ...
         if (N.GT.M && M.GT.0) CALL ZLACPY( 'Full', M, N-M, AF, LDA, L, LDA )          IF( M.GT.0 ) CALL ZLACPY( 'Lower', M, M, AF( 1, N-M+1 ), LDA, L( 1, N-M+1 ), LDA );
      }
