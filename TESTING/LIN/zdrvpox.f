               ...
               for (IEQUED = 1; IEQUED <= 2; IEQUED++) { // 100
                  ...
                  for (IFACT = 1; IFACT <= NFACT; IFACT++) { // 90
                     ...
                     if ( NOFACT ) {
                        ...
                        zlacpy('Full', N, NRHS, B, LDA, WORK, LDA )                         CALL ZPOT02( UPLO, N, NRHS, A, LDA, X, LDA, WORK, LDA, RWORK, RESULT( 2 ) );
                     ...
                     if ( INFO.EQ.0 ) {
                        ...
                        zlacpy('Full', N, NRHS, BSAV, LDA, WORK, LDA )                         CALL ZPOT02( UPLO, N, NRHS, ASAV, LDA, X, LDA, WORK, LDA, RWORK( 2*NRHS+1 ), RESULT( 2 ) );
