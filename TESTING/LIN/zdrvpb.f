                  ...
                  for (IEQUED = 1; IEQUED <= 2; IEQUED++) { // 70
                     ...
                     for (IFACT = 1; IFACT <= NFACT; IFACT++) { // 60
                        ...
                        if ( NOFACT ) {
                           ...
                           zlacpy('Full', KD+1, N, A, LDAB, AFAC, LDAB )                            CALL ZLACPY( 'Full', N, NRHS, B, LDA, X, LDA );
                        ...
                        if ( INFO.EQ.0 ) {
                           ...
                           zlacpy('Full', N, NRHS, BSAV, LDA, WORK, LDA )                            CALL ZPBT02( UPLO, N, KD, NRHS, ASAV, LDAB, X, LDA, WORK, LDA, RWORK( 2*NRHS+1 ), RESULT( 2 ) );
