      void ddrvpp(DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX, A, AFAC, ASAV, B, BSAV, X, XACT, S, WORK, RWORK, IWORK, NOUT ) {
            ...
            for (IUPLO = 1; IUPLO <= 2; IUPLO++) { // 120
               ...
               for (IEQUED = 1; IEQUED <= 2; IEQUED++) { // 110
                  ...
                  for (IFACT = 1; IFACT <= NFACT; IFACT++) { // 100
                     ...
                     if ( !PREFAC && NPP > 0) CALL DLASET( 'Full', NPP, 1, ZERO, ZERO, AFAC, NPP );
