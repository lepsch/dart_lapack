...
*
                  LWORK = MAX( 2, NB )*LDA
                  SRNAMT = 'CSYTRF_ROOK'
                  CALL CSYTRF_ROOK( UPLO, N, AFAC, LDA, IWORK, AINV, LWORK, INFO )
*
...
*
                  IF( INFO.NE.K) CALL ALAERH( PATH, 'CSYTRF_ROOK', INFO, K, UPLO, N, N, -1, -1, NB, IMAT, NFAIL, NERRS, NOUT )
*
...
*
                  CALL CSYT01_ROOK( UPLO, N, A, LDA, AFAC, LDA, IWORK, AINV, LDA, RWORK, RESULT( 1 ) )
                  NT = 1
*
*+    TEST 2
...
*
                  IF( INB.EQ.1 .AND. .NOT.TRFCON ) THEN
                     ...
                     SRNAMT = 'CSYTRI_ROOK'
                     CALL CSYTRI_ROOK( UPLO, N, AINV, LDA, IWORK, WORK, INFO )
*
*                    Check error code from CSYTRI_ROOK and handle error.
*
                     IF( INFO.NE.0 ) CALL ALAERH( PATH, 'CSYTRI_ROOK', INFO, -1, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
...
*
                     SRNAMT = 'CSYTRS_ROOK'
                     CALL CSYTRS_ROOK( UPLO, N, NRHS, AFAC, LDA, IWORK, X, LDA, INFO )
*
*                    Check error code from CSYTRS_ROOK and handle error.
*
                     IF( INFO.NE.0 ) CALL ALAERH( PATH, 'CSYTRS_ROOK', INFO, 0, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT )
*
                     CALL CLACPY( 'Full', N, NRHS, B, LDA, WORK, LDA )
*
*                    Compute the residual for the solution
*
                     CALL CSYT02( UPLO, N, NRHS, A, LDA, X, LDA, WORK, LDA, RWORK, RESULT( 5 ) )
*
*+    TEST 6
...
*
  230             CONTINUE
                  ...
                  SRNAMT = 'CSYCON_ROOK'
                  CALL CSYCON_ROOK( UPLO, N, AFAC, LDA, IWORK, ANORM, RCOND, WORK, INFO )
*
*                 Check error code from CSYCON_ROOK and handle error.
*
                  IF( INFO.NE.0 ) CALL ALAERH( PATH, 'CSYCON_ROOK', INFO, 0, UPLO, N, N, -1, -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
