...
// =====================================================================
      ...
      if ( LSAME( UPLO, 'U' ) ) {
         DO 30 K = N, 1, -1;
            ...
            if (KLEN > 0) CALL ZTRMV( 'Upper', 'Conjugate', 'Non-unit', KLEN, AFAC( KD+1, K-KLEN ), LDAFAC-1, AFAC( KC, K ), 1 );
      ...
      // UPLO = 'L':  Compute the product L*L', overwriting L.
         ...
         DO 40 K = N, 1, -1;
            ...
            if (KLEN > 0) CALL ZHER( 'Lower', KLEN, ONE, AFAC( 2, K ), 1, AFAC( 1, K+1 ), LDAFAC-1 );
