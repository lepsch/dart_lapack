...
*  =====================================================================
   ...
   90                      CONTINUE
               ...
               DO 150 IFACT = 1, NFACT
                  ...
                  if ( IFACT.EQ.2 ) {
                     ...
                     CALL CSYSV_AA_2STAGE( UPLO, N, NRHS, AFAC, LDA, AINV, (3*NB+1)*N, IWORK, IWORK( 1+N ), X, LDA, WORK, LWORK, INFO )
  ...
  100                   CONTINUE
                     ...
                     CALL CSYT02( UPLO, N, NRHS, A, LDA, X, LDA, WORK, LDA, RWORK, RESULT( 1 ) )
