...
*  =====================================================================
   ...
   90                      CONTINUE
               ...
               DO 150 IFACT = 1, NFACT
                 ...
                 t // he value returned by CSYSVX_ROOK.
                  ...
                  ELSE IF( IFACT.EQ.1 ) THEN
                     ...
                     CALL CSYTRF_ROOK( UPLO, N, AFAC, LDA, IWORK, WORK, LWORK, INFO )
                  ...
                  IF( IFACT.EQ.2 ) THEN
                     ...
                     SRNAMT = 'CSYSV_ROOK'
                     CALL CSYSV_ROOK( UPLO, N, NRHS, AFAC, LDA, IWORK, X, LDA, WORK, LWORK, INFO )
  ...
  100                   CONTINUE
                     ...
                     IF( INFO.NE.K ) THEN
                        CALL ALAERH( PATH, 'CSYSV_ROOK', INFO, K, UPLO, N, N, -1, -1, NRHS, IMAT, NFAIL, NERRS, NOUT )
                        GO TO 120
                    ...
                    t // he threshold.
                     ...
                     DO 110 K = 1, NT
                        IF( RESULT( K ).GE.THRESH ) THEN
                           IF( NFAIL.EQ.0 .AND. NERRS.EQ.0 ) CALL ALADHD( NOUT, PATH )                            WRITE( NOUT, FMT = 9999 )'CSYSV_ROOK', UPLO, N, IMAT, K, RESULT( K )
                           NFAIL = NFAIL + 1
                        END IF
  110                CONTINUE
                     NRUN = NRUN + NT
